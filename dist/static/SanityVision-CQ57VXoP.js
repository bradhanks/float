...
var Wp = (n, e, t) =>
  e in n
    ? Np(n, e, { enumerable: !0, configurable: !0, writable: !0, value: t })
    : (n[e] = t)
var Hs = (n, e, t) => Wp(n, typeof e != 'symbol' ? e + '' : e, t)
import {
  r as M,
  j as b,
  _ as Gp,
...
var EO = Object.defineProperty,
  ...
  Fa = (n, e, t) =>
    e in n
      ? EO(n, e, { enumerable: !0, configurable: !0, writable: !0, value: t })
      : (n[e] = t),
  Xa = (n, e) => {
    for (var t in e || (e = {})) TO.call(e, t) && Fa(n, t, e[t])
    if (Ba) for (var t of Ba(e)) RO.call(e, t) && Fa(n, t, e[t])
    return n
  }
const _a = function (n) {
    const {
...
var ZO = Object.defineProperty,
  ...
  Lo = (n, e, t) =>
    e in n
      ? ZO(n, e, { enumerable: !0, configurable: !0, writable: !0, value: t })
      : (n[e] = t),
  Ot = (n, e) => {
    for (var t in e || (e = {})) XO.call(e, t) && Lo(n, t, e[t])
    if (ja) for (var t of ja(e)) _O.call(e, t) && Lo(n, t, e[t])
    return n
  },
  Hr = (n, e) => BO(n, FO(e)),
  Fr = (n, e, t) => Lo(n, typeof e != 'symbol' ? e + '' : e, t)
const hc = {
    display: 'flex',
    flex: 1,
    height: '100%',
  ...
  jO = Hr(Ot({}, hc), { flexDirection: 'row', left: 0, right: 0 }),
  LO = Hr(Ot({}, hc), {
    bottom: 0,
  ...
  Js = {},
  cc = class wn extends M.Component {
    constructor(e) {
      super(e),
        Fr(this, 'pane1', null),
        Fr(this, 'pane2', null),
        Fr(this, 'splitPane', null),
    ...
    componentDidMount() {
      document.addEventListener('mouseup', this.onMouseUp),
        ...
        this.setState(wn.getSizeUpdate(this.props, this.state))
    }
    static getDerivedStateFromProps(e, t) {
      return wn.getSizeUpdate(e, t)
    }
    ...
    onTouchMove(e) {
      ...
      const { position: t = 0 } = this.state,
        {
          maxSize: i,
          minSize: r = wn.defaultProps.minSize,
          onChange: s,
          split: o = wn.defaultProps.split,
          step: l,
        } = this.props
      La(document, window)
      ...
      const c = u,
        ...
        p = o === 'vertical' ? e.touches[0].clientX : e.touches[0].clientY,
        g = o === 'vertical' ? d : O
      let m = t - p
      if (l) {
      ...
      let x = a ? m : -m
      const k = parseInt(window.getComputedStyle(c).order),
        Q = parseInt(window.getComputedStyle(f).order)
      k > Q && (x = -x)
      let S = i
      this.splitPane &&
        i !== void 0 &&
        i <= 0 &&
        (o === 'vertical'
          ? (S = this.splitPane.getBoundingClientRect().width + i)
          : (S = this.splitPane.getBoundingClientRect().height + i))
      let C = g - x
      const E = t - m
      r && C < r
        ? (C = r)
      ...
      this.setState(Ot({ draggedSize: C }, B))
    }
    onMouseUp() {
      if (!this.state.active || !this.props.allowResize) return
    ...
    static getSizeUpdate(e, t) {
      ...
      const r =
          e.size !== void 0
            ? e.size
            : qa(e.defaultSize, e.minSize, e.maxSize, t.draggedSize),
        s =
          e.primary === 'first'
            ? { pane1Size: r, pane2Size: void 0 }
            : { pane2Size: r, pane1Size: void 0 }
      return Hr(Ot(Ot({}, s), typeof e.size > 'u' ? {} : { draggedSize: r }), {
    ...
    render() {
      const {
          ...
          pane1Style: h,
          pane2Style: c,
          resizerClassName: f = jo,
          resizerStyle: d,
          split: O,
          style: p,
        } = this.props,
        { pane1Size: g, pane2Size: m } = this.state,
        x = e ? '' : 'disabled',
        k = f && `${f} ${jo}`,
        Q = qO(t),
        S = O === 'vertical' ? jO : LO,
        C = p ? Ot(Ot({}, S), p) : S,
        E = ['SplitPane', i, O, x].filter(Boolean).join(' '),
        B = Va(Ot(Ot({}, u), h), Js),
        v = Va(Ot(Ot({}, u), c), Js),
        D = ['Pane1', o, l].join(' '),
        $ = ['Pane2', o, a].join(' ')
...
function qO(n) {
  return M.Children.toArray(n).filter((e) => e)
}
function VO(n) {
...
function YO(n, e, t = !0, i = !0) {
  return (t ? dc : IO)(n, e, i)
}
function dc(n, e, t) {
  if (e == n.length) return e
  e && pc(n.charCodeAt(e)) && Oc(n.charCodeAt(e - 1)) && e--
  let i = to(n, e)
  for (e += Ia(i); e < n.length; ) {
    let r = to(n, e)
    if (i == Ya || r == Ya || (t && zO(r))) (e += Ia(r)), (i = r)
    else if (za(r)) {
      let s = 0,
        o = e - 2
      for (; o >= 0 && za(to(n, o)); ) s++, (o -= 2)
      if (s % 2 == 0) break
      e += 2
    } else break
  }
...
function to(n, e) {
  ...
  return pc(i) ? ((t - 55296) << 10) + (i - 56320) + 65536 : t
}
function pc(n) {
...
class pe {
  ...
  replace(e, t, i) {
    ...
    return (
      ...
      _t.from(r, this.length - (t - e) + i.length)
    )
  }
  append(e) {
  ...
  slice(e, t = this.length) {
    ;[e, t] = on(this, e, t)
    let i = []
    return this.decompose(e, t, i, 0), _t.from(i, t - e)
  }
  eq(e) {
    if (e == this) return !0
...
class ke extends pe {
  ...
  lineInner(e, t, i, r) {
    for (let s = 0; ; s++) {
      let o = this.text[s],
        l = r + o.length
      if ((t ? i : l) >= e) return new WO(r, l, i, o)
      ;(r = l + 1), i++
    }
  }
  decompose(e, t, i, r) {
    let s =
      e <= 0 && t >= this.length
        ? this
        : new ke(Na(this.text, e, t), Math.min(t, this.length) - Math.max(0, e))
    if (r & 1) {
      let o = i.pop(),
        l = Xr(s.text, o.text.slice(), 0, s.length)
      if (l.length <= 32) i.push(new ke(l, o.length + s.length))
      else {
        let a = l.length >> 1
        i.push(new ke(l.slice(0, a)), new ke(l.slice(a)))
      }
    } else i.push(s)
  }
  replace(e, t, i) {
    ...
    ;[e, t] = on(this, e, t)
    let r = Xr(this.text, Xr(i.text, Na(this.text, 0, e)), t),
      s = this.length + i.length - (t - e)
    return r.length <= 32 ? new ke(r, s) : _t.from(ke.split(r, []), s)
  }
  sliceString(
    e,
    t = this.length,
...
`,
  ...
  static split(e, t) {
    ...
    for (let s of e)
      i.push(s),
        (r += s.length + 1),
        i.length == 32 && (t.push(new ke(i, r)), (i = []), (r = -1))
    return r > -1 && t.push(new ke(i, r)), t
  }
}
class _t extends pe {
  constructor(e, t) {
  ...
  replace(e, t, i) {
    if ((([e, t] = on(this, e, t)), i.lines < this.lines))
      for (let r = 0, s = 0; r < this.children.length; r++) {
        ...
        if (e >= s && t <= l) {
          ...
          if (a.lines < u >> 4 && a.lines > u >> 6) {
            ...
            return (h[r] = a), new _t(h, this.length - (t - e) + i.length)
          }
...
`,
  ...
  static from(e, t = e.reduce((i, r) => i + r.length + 1, -1)) {
    ...
    function c(d) {
      let O
      if (d.lines > s && d instanceof _t) for (let p of d.children) c(p)
      else
        d.lines > o && (a > o || !a)
          ? (f(), l.push(d))
          : d instanceof ke &&
              a &&
              (O = h[h.length - 1]) instanceof ke &&
              d.lines + O.lines <= 32
            ? ((a += d.lines),
              (u += d.length + 1),
              (h[h.length - 1] = new ke(
    ...
    function f() {
      a != 0 &&
        (l.push(h.length == 1 ? h[0] : _t.from(h, u)),
        (u = -1),
        (a = h.length = 0))
    }
    for (let d of e) c(d)
...
class Rn {
  constructor(e, t = 1) {
    ;(this.dir = t),
      ...
      (this.nodes = [e]),
      (this.offsets = [
        t > 0 ? 1 : (e instanceof ke ? e.text.length : e.children.length) << 1,
      ])
  }
  nextInner(e, t) {
    for (this.done = this.lineBreak = !1; ; ) {
      let i = this.nodes.length - 1,
        ...
        s = this.offsets[i],
        o = s >> 1,
        l = r instanceof ke ? r.text.length : r.children.length
      if (o == (t > 0 ? l : 0)) {
        ...
        e > a.length
          ...
          : (t < 0 && this.offsets[i]--,
            ...
            this.offsets.push(
              t > 0
                ? 1
                : (a instanceof ke ? a.text.length : a.children.length) << 1,
            ))
      }
    }
  }
...
typeof Symbol < 'u' &&
  ...
  (Rn.prototype[Symbol.iterator] =
    mc.prototype[Symbol.iterator] =
    gc.prototype[Symbol.iterator] =
      function () {
        return this
      }))
class WO {
...
function et(n, e) {
  let t = n.charCodeAt(e)
  if (!UO(t) || e + 1 == n.length) return t
  let i = n.charCodeAt(e + 1)
  return GO(i) ? ((t - 55296) << 10) + (i - 56320) + 65536 : t
}
function Yl(n) {
  return n <= 65535
    ...
    for (let o = 0; o < this.sections.length; ) {
      ...
      if (a < 0) {
        ...
        if (
          i != Ge.Simple &&
          u >= e &&
          ((i == Ge.TrackDel && r < e && u > e) ||
            (i == Ge.TrackBefore && r < e) ||
            (i == Ge.TrackAfter && u > e))
        )
          return null
...
class Me extends zt {
  ...
  apply(e) {
    ...
    return (
      zo(this, (t, i, r, s, o) => (e = e.replace(r, r + (i - t), o)), !1), e
    )
  }
  mapDesc(e, t = !1) {
  ...
  invert(e) {
    ...
    for (let r = 0, s = 0; r < t.length; r += 2) {
      ...
      if (l >= 0) {
        ;(t[r] = l), (t[r + 1] = o)
        let a = r >> 1
        for (; i.length < a; ) i.push(pe.empty)
        i.push(o ? e.slice(s, s + o) : pe.empty)
      }
      s += o
    }
    return new Me(t, i)
  ...
  filter(e) {
    ...
    e: for (let o = 0, l = 0; ; ) {
      ...
      for (; l < a || (l == a && s.len == 0); ) {
        ...
        ze(t, h, c), c > 0 && mi(i, t, s.text), s.forward(h), (l += h)
      }
      let u = e[o++]
      for (; l < u; ) {
        if (s.done) break e
        ...
        ze(t, h, -1),
          ze(r, h, s.ins == -1 ? -1 : s.off == 0 ? s.ins : 0),
          s.forward(h),
          (l += h)
      }
    }
    return { changes: new Me(t, i), filtered: zt.create(r) }
  }
  toJSON() {
    let e = []
    for (let t = 0; t < this.sections.length; t += 2) {
  ...
  static of(e, t, i) {
    ...
    function u(h) {
      if (Array.isArray(h)) for (let c of h) u(c)
        ...
        if (h.length != t)
          throw new RangeError(
            `Mismatched change set length (got ${h.length}, expected ${t})`,
          )
        ...
        if (c > f || c < 0 || f > t)
          throw new RangeError(
            `Invalid change range ${c} to ${f} (in doc of length ${t})`,
          )
        let O = d
            ? typeof d == 'string'
              ? pe.of(d.split(i || Vo))
    ...
    for (let r = 0; r < e.length; r++) {
      ...
      if (typeof s == 'number') t.push(s, -1)
        ...
        if (s.length == 1) t.push(s[0], 0)
          ...
          for (; i.length < r; ) i.push(pe.empty)
...
function mi(n, e, t) {
  ...
  if (i < n.length) n[n.length - 1] = n[n.length - 1].append(t)
    ...
    for (; n.length < i; ) n.push(pe.empty)
    n.push(t)
  }
}
function zo(n, e, t) {
...
function Yo(n, e, t, i = !1) {
  ...
  for (let a = -1; ; ) {
    ...
    if (o.ins == -1 && l.ins == -1) {
      ...
      ze(r, u, -1), o.forward(u), l.forward(u)
    } else if (
      l.ins >= 0 &&
      (o.ins < 0 ||
        a == o.i ||
      ...
      for (ze(r, l.ins, -1); u; ) {
        ...
        o.ins >= 0 &&
          a < o.i &&
          o.len <= h &&
          (ze(r, 0, o.ins), s && mi(s, r, o.text), (a = o.i)),
          o.forward(h),
          (u -= h)
      }
      l.next()
      ...
      ze(r, u, a < o.i ? o.ins : 0),
        s && a < o.i && mi(s, r, o.text),
        (a = o.i),
        o.forward(o.len - h)
    } else {
      if (o.done && l.done) return s ? Me.createSet(r, s) : zt.create(r)
      throw new Error('Mismatched change set lengths')
    }
  }
}
function yc(n, e, t = !1) {
  let i = [],
    ...
    o = new qn(e)
  for (let l = !1; ; ) {
    if (s.done && o.done) return r ? Me.createSet(i, r) : zt.create(i)
    if (s.ins == 0) ze(i, s.len, 0, l), s.next()
    else if (o.len == 0 && !o.done)
      ze(i, 0, o.ins, l), r && mi(r, i, o.text), o.next()
    else {
      if (s.done || o.done) throw new Error('Mismatched change set lengths')
      {
        ...
        if (s.ins == -1) {
          ...
          ze(i, a, h, l), r && h && mi(r, i, o.text)
        } else
          o.ins == -1
            ? (ze(i, s.off ? 0 : s.len, a, l), r && mi(r, i, s.textBit(a)))
            : (ze(i, s.off ? 0 : s.len, o.off ? 0 : o.ins, l),
              r && !o.off && mi(r, i, o.text))
...
class Zi {
  ...
  extend(e, t = e) {
    if (e <= this.anchor && t >= this.anchor) return T.range(e, t)
...
class z {
  ...
  static define(e = {}) {
    return new z(
      ...
      e.compare || (e.combine ? (t, i) => t === i : Nl),
      !!e.static,
      e.enables,
    )
  }
  ...
  dynamicSlot(e) {
    ...
    for (let c of this.dependencies)
      c == 'doc'
        ...
        : c == 'selection'
          ? (u = !0)
          : (((t = e[c.id]) !== null && t !== void 0 ? t : 1) & 1) == 0 &&
            h.push(e[c.id])
    return {
      create(c) {
      ...
      update(c, f) {
        if (
          ...
          let d = i(c)
          if (l ? !Wa(d, c.values[o], r) : !r(d, c.values[o]))
  ...
  return {
    ...
    reconfigure(a, u) {
      let h = Io(a, i),
        ...
        f = u.facet(e)
      if (c && !h && Nl(t, c)) return (a.values[o] = f), 0
      let d = l(a)
      return e.compare(d, f) ? ((a.values[o] = f), 0) : ((a.values[o] = d), 1)
    },
  }
}
const fr = z.define({ static: !0 })
class Ve {
  constructor(e, t, i, r, s) {
    ;(this.id = e),
      (this.createF = t),
  ...
  create(e) {
    let t = e.facet(fr).find((i) => i.field == this)
  ...
  init(e) {
    return [this, fr.of({ field: this, create: e })]
  }
  get extension() {
    return this
  }
}
const Ri = { lowest: 4, low: 3, default: 2, high: 1, highest: 0 }
function bn(n) {
  return (e) => new bc(e, n)
}
const zi = {
  highest: bn(Ri.highest),
  high: bn(Ri.high),
  default: bn(Ri.default),
  low: bn(Ri.low),
  lowest: bn(Ri.lowest),
}
class bc {
...
class As {
  ...
  reconfigure(e) {
    return As.reconfigure.of({ compartment: this, extension: e })
  }
  get(e) {
  ...
  static resolve(e, t, i) {
    ...
    for (let f in s) {
      ...
      if (d.every((g) => g.type == 0))
        if (((l[O.id] = (a.length << 1) | 1), Nl(p, d))) a.push(i.facet(O))
        else {
          let g = O.combine(d.map((m) => m.value))
        ...
        for (let g of d)
          g.type == 0
            ...
            : ((l[g.id] = u.length << 1), u.push((m) => g.dynamicSlot(m)))
        ;(l[O.id] = u.length << 1), u.push((g) => HO(g, O, d))
      }
    }
    let c = u.map((f) => f(l))
...
function KO(n, e, t) {
  ...
  function s(o, l) {
    ...
    if (a != null) {
      if (a <= l) return
      let u = i[a].indexOf(o)
      u > -1 && i[a].splice(u, 1), o instanceof No && t.delete(o.compartment)
    }
    ...
    } else if (o instanceof bc) s(o.inner, o.prec)
    else if (o instanceof Ve) i[l].push(o), o.provides && s(o.provides, l)
    else if (o instanceof _r)
      i[l].push(o), o.facet.extensions && s(o.facet.extensions, Ri.default)
    else {
      let u = o.extension
      if (!u)
        throw new Error(
  ...
  return s(n, Ri.default), i.reduce((o, l) => o.concat(l))
}
function Mn(n, e) {
  if (e & 1) return 2
  let t = e >> 1,
...
const Sc = z.define(),
  Wo = z.define({ combine: (n) => n.some((e) => e), static: !0 }),
  Dc = z.define({ combine: (n) => (n.length ? n[0] : void 0), static: !0 }),
  vc = z.define(),
  Qc = z.define(),
  kc = z.define(),
  wc = z.define({ combine: (n) => (n.length ? n[0] : !1) })
class Nt {
  constructor(e, t) {
...
ie.reconfigure = ie.define()
ie.appendConfig = ie.define()
class Ze {
  constructor(e, t, i, r, s, o) {
    ;(this.startState = e),
      (this.changes = t),
      ...
      (this._state = null),
      i && xc(i, t.newLength),
      s.some((l) => l.type == Ze.time) ||
        (this.annotations = s.concat(Ze.time.of(Date.now())))
  }
  static create(e, t, i, r, s, o) {
    return new Ze(e, t, i, r, s, o)
  }
  get newDoc() {
...
Ze.time = Nt.define()
Ze.userEvent = Nt.define()
Ze.addToHistory = Nt.define()
Ze.remote = Nt.define()
function tm(n, e) {
  let t = []
  for (let i = 0, r = 0; ; ) {
...
function Go(n, e, t) {
  let i = e.selection,
    r = Ji(e.annotations)
  return (
    e.userEvent && (r = r.concat(Ze.userEvent.of(e.userEvent))),
    {
      changes:
        e.changes instanceof Me
          ? e.changes
          : Me.of(e.changes || [], t, n.facet(Dc)),
...
function Pc(n, e, t) {
  ...
  for (let s = 1; s < e.length; s++) {
    ...
    i = Cc(i, Go(n, e[s], o ? i.changes.newLength : n.doc.length), o)
  }
  let r = Ze.create(
    n,
    i.changes,
...
function im(n) {
  let e = n.startState,
    t = !0
  for (let r of e.facet(vc)) {
    let s = r(n)
    if (s === !1) {
      t = !1
      break
    }
    Array.isArray(s) && (t = t === !0 ? s : tm(t, s))
  }
  if (t !== !0) {
    let r, s
    if (t === !1) (s = n.changes.invertedDesc), (r = Me.empty(e.doc.length))
    else {
  ...
  for (let r = i.length - 1; r >= 0; r--) {
    ...
    s instanceof Ze
      ? (n = s)
      : Array.isArray(s) && s.length == 1 && s[0] instanceof Ze
        ? (n = s[0])
        : (n = Pc(e, Ji(s), !1))
  }
  return n
...
function nm(n) {
  ...
  for (let r = t.length - 1; r >= 0; r--) {
    let s = t[r](n)
    s && Object.keys(s).length && (i = Cc(i, Go(e, s, n.changes.newLength), !0))
  }
  return i == n
    ? n
    : Ze.create(
...
const rm = []
function Ji(n) {
  return n == null ? rm : Array.isArray(n) ? n : [n]
}
var ve = (function (n) {
  return (
    (n[(n.Word = 0)] = 'Word'),
...
let Uo
try {
  Uo = new RegExp('[\\p{Alphabetic}\\p{Number}_]', 'u')
} catch {}
function om(n) {
  if (Uo) return Uo.test(n)
  for (let e = 0; e < n.length; e++) {
    let t = n[e]
    if (
      /\w/.test(t) ||
      (t > '' && (t.toUpperCase() != t.toLowerCase() || sm.test(t)))
    )
      return !0
  }
  return !1
...
class he {
  ...
  applyTransaction(e) {
    ...
    for (let l of e.effects)
      l.is(As.reconfigure)
        ...
        : l.is(ie.reconfigure)
          ? ((t = null), (i = l.value))
          : l.is(ie.appendConfig) && ((t = null), (i = Ji(i).concat(l.value)))
    let s
    t
      ? (s = e.startState.values.slice())
      : ((t = Kr.resolve(i, r, this)),
        (s = new he(
          t,
          this.doc,
          this.selection,
    ...
    let o = e.startState.facet(Wo) ? e.newSelection : e.newSelection.asSingle()
    new he(t, e.newDoc, o, s, (l, a) => a.update(l, e), e)
  }
  replaceSelection(e) {
    return (
  ...
  changeByRange(e) {
    ...
    for (let l = 1; l < t.ranges.length; l++) {
      ...
      s.push(a.range.map(c)),
        (r = r.compose(h)),
        (o = ie.mapEffects(o, h).concat(ie.mapEffects(Ji(a.effects), c)))
    }
  ...
  changes(e = []) {
    return e instanceof Me
      ? e
      : Me.of(e, this.doc.length, this.facet(he.lineSeparator))
  }
  toText(e) {
    return pe.of(e.split(this.facet(he.lineSeparator) || Vo))
  }
  ...
  facet(e) {
    ...
    return t == null ? e.default : (Mn(this, t), Jr(this, t))
  }
  toJSON(e) {
  ...
  static create(e = {}) {
    let t = Kr.resolve(e.extensions || [], new Map()),
      i =
        e.doc instanceof pe
          ? e.doc
          : pe.of((e.doc || '').split(t.staticFacet(he.lineSeparator) || Vo)),
      r = e.selection
  ...
  get tabSize() {
    return this.facet(he.tabSize)
  }
  get lineBreak() {
    return (
      this.facet(he.lineSeparator) ||
      `
`
    )
  }
  get readOnly() {
    return this.facet(wc)
  }
  phrase(e, ...t) {
    for (let i of this.facet(he.phrases))
  ...
  charCategorizer(e) {
    return lm(this.languageDataAt('wordChars', e).join(''))
  }
  wordAt(e) {
...
he.allowMultipleSelections = Wo
he.tabSize = z.define({ combine: (n) => (n.length ? n[0] : 4) })
he.lineSeparator = Dc
he.readOnly = wc
he.phrases = z.define({
  compare(n, e) {
...
he.languageData = Sc
he.changeFilter = vc
he.transactionFilter = Qc
he.transactionExtender = kc
As.reconfigure = ie.define()
function Wt(n, e, t = {}) {
  let i = {}
  for (let r of n)
  ...
  map(e, t) {
    ...
    for (let a = 0; a < this.value.length; a++) {
      let u = this.value[a],
        ...
        d
      if (h == c) {
        let O = t.mapPos(h, u.startSide, u.mapMode)
        if (
          O == null ||
          ((f = d = O),
          u.startSide != u.endSide && ((d = t.mapPos(h, u.endSide)), d < f))
        )
          continue
      } else if (
    ...
    return { mapped: i.length ? new Wl(r, s, i, l) : null, pos: o }
  }
}
class de {
  constructor(e, t, i, r) {
  ...
  update(e) {
    ...
    if ((i && (t = t.slice().sort(Ko)), this.isEmpty))
      return t.length ? de.of(t) : this
    let l = new $c(this, null, -1).goto(0),
      a = 0,
      u = [],
      h = new si()
      ...
      if (
        ...
        h.addChunk(this.chunkPos[l.chunkIndex], this.chunk[l.chunkIndex])
          ...
          : ((!o || r > l.to || s < l.from || o(l.from, l.to, l.value)) &&
              (h.addInner(l.from, l.to, l.value) ||
                u.push(Ho.create(l.from, l.to, l.value))),
            l.next())
  ...
  map(e) {
    ...
    return t.length == 0 ? s : new de(i, t, s || de.empty, r)
  }
  between(e, t, i) {
    if (!this.isEmpty) {
  ...
  static compare(e, t, i, r, s = -1) {
    let o = e.filter((c) => c.maxPoint > 0 || (!c.isEmpty && c.maxPoint >= s)),
      ...
      u = new Sn(o, a, s),
      h = new Sn(l, a, s)
    i.iterGaps((c, f, d) => Ua(u, c, h, f, d, r)),
      i.empty && i.length == 0 && Ua(u, 0, h, 0, 0, r)
  }
  static eq(e, t, i = 0, r) {
    r == null && (r = 999999999)
    ...
    let l = Ga(s, o),
      a = new Sn(s, l, 0).goto(i),
      u = new Sn(o, l, 0).goto(i)
    for (;;) {
      if (
        a.to != u.to ||
        !Jo(a.active, u.active) ||
          ...
          c =
            o.pointFrom < t
              ...
              : o.point.startSide < 0
                ? h.length
                : Math.min(h.length, a)
        r.point(l, u, o.point, h, c, o.pointRank),
          (a = Math.min(o.openEnd(u), h.length))
  ...
  static of(e, t = !1) {
    let i = new si()
    for (let r of e instanceof Ho ? [e] : t ? am(e) : e)
      i.add(r.from, r.to, r.value)
    return i.finish()
  }
  static join(e) {
    if (!e.length) return de.empty
    let t = e[e.length - 1]
    for (let i = e.length - 2; i >= 0; i--)
      for (let r = e[i]; r != de.empty; r = r.nextLayer)
        t = new de(r.chunkPos, r.chunk, t, Math.max(r.maxPoint, t.maxPoint))
    return t
  }
}
...
function am(n) {
  if (n.length > 1)
    for (let e = n[0], t = 1; t < n.length; t++) {
      let i = n[t]
      if (Ko(e, i) > 0) return n.slice().sort(Ko)
      e = i
    }
  return n
}
...
class si {
  finishChunk(e) {
    this.chunks.push(new Wl(this.from, this.to, this.value, this.maxPoint)),
  ...
  add(e, t, i) {
    this.addInner(e, t, i) ||
      (this.nextLayer || (this.nextLayer = new si())).add(e, t, i)
  }
  addInner(e, t, i) {
...
class Vn {
  ...
  static from(e, t = null, i = -1) {
    ...
    for (let s = 0; s < e.length; s++)
      for (let o = e[s]; !o.isEmpty; o = o.nextLayer)
        o.maxPoint >= i && r.push(new $c(o, t, i, s))
  ...
  goto(e, t = -1e9) {
    ...
    for (let i = this.heap.length >> 1; i >= 0; i--) io(this.heap, i)
...
class Sn {
  ...
  removeActive(e) {
    dr(this.active, e),
      dr(this.activeTo, e),
      dr(this.activeRank, e),
      (this.minActive = Ha(this.active, this.activeTo))
  }
  addActive(e) {
    let t = 0,
    ...
    for (
      ...
      t++
    pr(this.active, t, i),
      pr(this.activeTo, t, r),
      pr(this.activeRank, t, s),
      e && pr(e, t, this.cursor.from),
      (this.minActive = Ha(this.active, this.activeTo))
  }
  next() {
    let e = this.to,
    ...
    if (
      (n.point || t.point
        ? (n.point &&
            ...
            Jo(n.activeForPoint(n.to), t.activeForPoint(t.to))) ||
          s.comparePoint(l, f, n.point, t.point)
        : f > l &&
          !Jo(n.active, t.active) &&
          s.compareRange(l, f, n.active, t.active),
      c > o)
    )
      break
    ;(u || n.openEnd != t.openEnd) && s.boundChange && s.boundChange(c),
      (l = c),
      h <= 0 && n.next(),
      h >= 0 && t.next()
  }
...
function pn(n, e, t = n.length) {
  ...
  for (let r = 0; r < t && r < n.length; )
    n.charCodeAt(r) == 9 ? ((i += e - (i % e)), r++) : (i++, (r = qe(n, r)))
  return i
}
function el(n, e, t, i) {
  for (let r = 0, s = 0; ; ) {
    if (s >= e) return r
    if (r == n.length) break
    ;(s += n.charCodeAt(r) == 9 ? t - (s % t) : 1), (r = qe(n, r))
  }
  return i === !0 ? -1 : n.length
}
const tl = 'ͼ',
  Ka = typeof Symbol > 'u' ? '__' + tl : Symbol.for(tl),
  il =
    typeof Symbol > 'u'
...
`)
  ...
  static newName() {
    let e = Ja[Ka] || 1
    return (Ja[Ka] = e + 1), tl + e.toString(36)
  }
  static mount(e, t, i) {
    let r = e[il],
      s = i && i.nonce
    r ? s && r.setNonce(s) : (r = new um(e, s)),
...
class um {
  constructor(e, t) {
    ...
    if (!e.head && e.adoptedStyleSheets && r.CSSStyleSheet) {
      let s = eu.get(i)
      if (s) return (e[il] = s)
      ;(this.sheet = new r.CSSStyleSheet()), eu.set(i, this)
    } else
...
var Di = {
  ...
  hm = typeof navigator < 'u' && /Mac/.test(navigator.platform),
  cm =
    typeof navigator < 'u' &&
    /MSIE \d|Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(navigator.userAgent)
for (var Le = 0; Le < 10; Le++) Di[48 + Le] = Di[96 + Le] = String(Le)
for (var Le = 1; Le <= 24; Le++) Di[Le + 111] = 'F' + Le
for (var Le = 65; Le <= 90; Le++)
  (Di[Le] = String.fromCharCode(Le + 32)), (zn[Le] = String.fromCharCode(Le))
for (var no in Di) zn.hasOwnProperty(no) || (zn[no] = Di[no])
function fm(n) {
  var e =
      (hm && n.metaKey && n.shiftKey && !n.ctrlKey && !n.altKey) ||
      (cm && n.shiftKey && n.key && n.key.length == 1) ||
      n.key == 'Unidentified',
    t =
      (!e && n.key) ||
      (n.shiftKey ? zn : Di)[n.keyCode] ||
      n.key ||
      'Unidentified'
  return (
    t == 'Esc' && (t = 'Escape'),
...
function Ec(n, e) {
  if (typeof e == 'string') n.appendChild(document.createTextNode(e))
    ...
    else if (Array.isArray(e)) for (var t = 0; t < e.length; t++) Ec(n, e[t])
...
function ln(n) {
  return n.nodeType == 3
    ? Li(n, 0, n.nodeValue.length).getClientRects()
    : n.nodeType == 1
      ? n.getClientRects()
      : []
}
function Zn(n, e, t, i) {
  return t ? tu(n, e, t, i, -1) || tu(n, e, t, i, 1) : !1
}
function ji(n) {
  ...
  for (let h = n, c = !1; h && !c; )
    if (h.nodeType == 1) {
      ...
      if (d) f = dm(u)
        ...
        ;({ scaleX: O, scaleY: p } = Tc(h, x)),
          (f = {
            left: x.left,
            right: x.left + h.clientWidth * O,
            top: x.top,
            bottom: x.top + h.clientHeight * p,
          })
      }
      let g = 0,
        m = 0
      ...
      if (
        (i == 'nearest'
          ? e.left < f.left
            ? ((g = e.left - (f.left + s)),
              t > 0 && e.right > f.right + g && (g = e.right - f.right + s))
            : e.right > f.right &&
              ((g = e.right - f.right + s),
              t < 0 && e.left < f.left + g && (g = e.left - (f.left + s)))
          : (g =
              (i == 'center'
        ...
        if (d) u.scrollBy(g, m)
          ...
          if (m) {
            let Q = h.scrollTop
            ;(h.scrollTop += m / p), (k = (h.scrollTop - Q) * p)
          }
          if (g) {
            let Q = h.scrollLeft
            ;(h.scrollLeft += g / O), (x = (h.scrollLeft - Q) * O)
          }
          ;(e = {
            left: e.left - x,
            top: e.top - k,
...
class mm {
  ...
  setRange(e) {
    ...
    this.set(
      t,
      Math.min(e.anchorOffset, t ? It(t) : 0),
      i,
      Math.min(e.focusOffset, i ? It(i) : 0),
    )
  }
  set(e, t, i, r) {
    ;(this.anchorNode = e),
...
let iu
function Li(n, e, t = e) {
  let i = iu || (iu = document.createRange())
...
function Bc(n, e) {
  for (let t = n, i = e; ; ) {
    ...
    } else if (t.parentNode && !es(t)) (i = ji(t)), (t = t.parentNode)
    else return null
  }
}
function Fc(n, e) {
  for (let t = n, i = e; ; ) {
    ...
    } else if (t.parentNode && !es(t)) (i = ji(t) + 1), (t = t.parentNode)
    else return null
  }
}
class Ye {
  ...
  static before(e, t) {
    return new Ye(e.parentNode, ji(e), t)
  }
  static after(e, t) {
    return new Ye(e.parentNode, ji(e) + 1, t)
  }
}
const Gl = []
class ge {
  ...
  localPosFromDOM(e, t) {
    ...
    for (; i && !ge.get(i); ) i = i.nextSibling
  ...
  childCursor(e = this.length) {
    return new Xc(this.children, e, this.children.length)
  }
  childPos(e, t = 1) {
...
function _c(n, e, t, i, r, s, o, l, a) {
  ...
  if (
    !(
      ...
      !f &&
      s.length < 2 &&
      h.merge(t, r, s.length ? c : null, t == 0, l, a)
    )
  ) {
    if (i < u.length) {
      let d = u[i]
    ...
    for (
      ...
      t > 0 &&
        (!o && s.length && h.merge(t, h.length, s[0], !1, l, 0)
          ...
          : (t < h.length ||
              (h.children.length &&
                h.children[h.children.length - 1].length == 0)) &&
...
function jc(n, e, t, i, r, s) {
  ...
  ;(n.length += c), _c(n, u, h, l, a, i, 0, r, s)
}
let tt =
    typeof navigator < 'u'
      ? navigator
      : { userAgent: '', vendor: '', platform: '' },
  rl = typeof document < 'u' ? document : { documentElement: { style: {} } }
const sl = /Edge\/(\d+)/.exec(tt.userAgent),
  Lc = /MSIE \d/.test(tt.userAgent),
  ol = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(tt.userAgent),
  $s = !!(Lc || ol || sl),
  ru = !$s && /gecko\/(\d+)/i.test(tt.userAgent),
  ro = !$s && /Chrome\/(\d+)/.exec(tt.userAgent),
  xm = 'webkitFontSmoothing' in rl.documentElement.style,
  qc = !$s && /Apple Computer/.test(tt.vendor),
  su = qc && (/Mobile\/\w+/.test(tt.userAgent) || tt.maxTouchPoints > 2)
var Y = {
  mac: su || /Mac/.test(tt.platform),
  windows: /Win/.test(tt.platform),
  linux: /Linux|X11/.test(tt.platform),
  ie: $s,
  ie_version: Lc ? rl.documentMode || 6 : ol ? +ol[1] : sl ? +sl[1] : 0,
  gecko: ru,
  gecko_version: ru ? +(/Firefox\/(\d+)/.exec(tt.userAgent) || [0, 0])[1] : 0,
  chrome: !!ro,
  ...
  webkit_version: xm
    ...
    : 0,
  tabSize:
    rl.documentElement.style.tabSize != null ? 'tab-size' : '-moz-tab-size',
}
const bm = 256
class Et extends ge {
  constructor(e) {
  ...
  split(e) {
    let t = new Et(this.text.slice(e))
    return (
...
class oi extends ge {
  ...
  merge(e, t, i, r, s, o) {
    return i &&
      (!(i instanceof oi && i.mark.eq(this.mark)) ||
        (e && s <= 0) ||
        (t < this.length && o <= 0))
      ? !1
      : (jc(this, e, t, i ? i.children.slice() : [], s - 1, o - 1),
        this.markDirty(),
        !0)
  }
  split(e) {
...
function Sm(n, e, t) {
  ...
  let r = e,
    ...
    o = 0
  ;(e == 0 && t < 0) || (e == i && t >= 0)
    ? Y.chrome || Y.gecko || (e ? (r--, (o = 1)) : s < i && (s++, (o = -1)))
    : t < 0
      ? r--
      : s < i && s++
  let l = Li(n, r, s).getClientRects()
...
class gi extends ge {
  ...
  get overrideDOMText() {
    if (this.length == 0) return pe.empty
    let e = this
  ...
  domAtPos(e) {
    return (this.length ? e == 0 : this.side > 0)
      ? Ye.before(this.dom)
      : Ye.after(this.dom, e == this.length)
  }
  domBoundsAround() {
    return null
  }
...
Et.prototype.children = gi.prototype.children = an.prototype.children = Gl
function Vc(n, e) {
  let t = n.dom,
    { children: i } = n,
    r = 0
...
function zc(n, e, t) {
  ...
  e instanceof oi &&
  r.length &&
  (i = r[r.length - 1]) instanceof oi &&
  i.mark.eq(e.mark)
    ? zc(i, e.children[0], t - 1)
...
function Yc(n, e, t) {
  ...
  function l(u, h) {
    for (let c = 0, f = 0; c < u.children.length && f <= h; c++) {
      ...
      O >= h &&
        (d.children.length
          ? l(d, h - f)
          : (!s || (s.isHidden && (t > 0 || vm(s, d)))) &&
              (O > h || (f == O && d.getSide() > 0))
            ? ((s = d), (o = h - f))
            : (f < h || (f == O && d.getSide() < 0 && !d.isHidden)) &&
              ((i = d), (r = h - f))),
        (f = O)
    }
  }
  l(n, e)
  let a = (t < 0 ? i : s) || i || s
  return a ? a.coordsAt(Math.max(0, a == i ? r : o), t) : Dm(n)
}
function Dm(n) {
...
class U extends _i {
  ...
  static widget(e) {
    ...
    return (
      ...
      new vi(e, t, t, i, e.widget || null, !1)
    )
  }
  static replace(e) {
    let t = !!e.block,
    ...
    return new vi(e, i, r, t, e.widget || null, !0)
  }
  static line(e) {
    return new sr(e)
  }
...
class sr extends U {
  ...
  eq(e) {
    return (
      ...
      ts(this.spec.attributes, e.spec.attributes)
    )
  }
  range(e, t = e) {
    if (t != e)
...
sr.prototype.mapMode = Ge.TrackBefore
...
class Pe extends ge {
  ...
  merge(e, t, i, r, s, o) {
    ...
    return (
      ...
      jc(this, e, t, i ? i.children.slice() : [], s, o),
      !0
    )
  }
  split(e) {
  ...
  addLineDeco(e) {
    let t = e.spec.attributes,
      i = e.spec.class
    t && (this.attrs = ll(t, this.attrs || {})),
      i && (this.attrs = ll({ class: i }, this.attrs || {}))
  }
  domAtPos(e) {
    return Vc(this, e)
  }
  ...
  sync(e, t) {
    ...
    this.dom
      ...
      : (this.setDOM(document.createElement('div')),
        ...
        (this.prevAttrs = this.attrs ? null : void 0)),
      this.prevAttrs !== void 0 &&
        (al(this.dom, this.prevAttrs, this.attrs),
        this.dom.classList.add('cm-line'),
        (this.prevAttrs = void 0)),
      super.sync(e, t)
    let r = this.dom.lastChild
    for (; r && ge.get(r) instanceof oi; ) r = r.lastChild
    if (
      !r ||
      !this.length ||
      (r.nodeName != 'BR' &&
        ((i = ge.get(r)) === null || i === void 0 ? void 0 : i.isEditable) ==
          !1 &&
        (!Y.ios || !this.children.some((s) => s instanceof Et)))
    ) {
  ...
  measureTextSize() {
    ...
    let e = 0,
      t
    for (let i of this.children) {
      if (!(i instanceof Et) || /[^ -~]/.test(i.text)) return null
      let r = ln(i.dom)
...
class ni extends ge {
  ...
  split(e) {
    let t = this.length - e
    this.length = e
    let i = new ni(this.widget, t, this.deco)
  ...
  become(e) {
    return e instanceof ni && e.widget.constructor == this.widget.constructor
  ...
  coordsAt(e, t) {
    ...
    return (
      i ||
      (this.widget instanceof ul
        ? null
        : nr(this.dom.getBoundingClientRect(), this.length ? e == 0 : t <= 0))
    )
  }
  destroy() {
    super.destroy(), this.dom && this.widget.destroy(this.dom)
...
class Bn {
  ...
  posCovered() {
    ...
    return !(e.breakAfter || (e instanceof ni && e.deco.endSide < 0))
  }
  getLine() {
    return (
      this.curLine ||
        (this.content.push((this.curLine = new Pe())), (this.atCursorPos = !0)),
      this.curLine
    )
  }
  flushBuffer(e = this.bufferMarks) {
    this.pendingBuffer &&
      (this.curLine.append(Or(new an(-1), e), e.length),
      (this.pendingBuffer = 0))
  }
  addBlockWidget(e) {
    ...
    this.pendingBuffer && e <= this.bufferMarks.length
      ...
      !this.posCovered() &&
        !(
          e &&
          this.content.length &&
          this.content[this.content.length - 1] instanceof ni
        ) &&
        this.getLine()
  }
  buildText(e, t, i) {
    for (; e > 0; ) {
      ...
      this.flushBuffer(t.slice(t.length - i)),
        this.getLine().append(
          Or(new Et(this.text.slice(this.textOff, this.textOff + r)), t),
          i,
        ),
        (this.atCursorPos = !0),
        (this.textOff += r),
  ...
  point(e, t, i, r, s, o) {
    if (this.disallowBlockEffectsFor[o] && i instanceof vi) {
      if (i.block)
        throw new RangeError(
    ...
    if (i instanceof vi)
      if (i.block)
        i.startSide > 0 && !this.posCovered() && this.getLine(),
          this.addBlockWidget(new ni(i.widget || un.block, l, i))
      else {
        let a = gi.create(i.widget || un.inline, l, l ? 0 : i.startSide),
          u =
            this.atCursorPos &&
            !a.isEditable &&
            s <= r.length &&
...
function Or(n, e) {
  for (let t of e) n = new oi(t, [n], n.length)
  return n
}
class un extends hi {
  constructor(e) {
...
function Am(n, e, t, i, r) {
  for (let s = 0; s <= i.length; s++) {
    ...
    for (let u = o, h = a, c = a; u < l; u++) {
      let f = me[u]
      if (f == 128)
        u < l - 1 && h == me[u + 1] && h & 24 ? (f = me[u] = h) : (me[u] = 256)
      else if (f == 64) {
        let d = u + 1
        for (; d < l && me[d] == 64; ) d++
        let O = (u && h == 8) || (d < t && me[d] == 8) ? (c == 1 ? 1 : 8) : 256
        for (let p = u; p < d; p++) me[p] = O
        u = d - 1
      } else f == 8 && c == 1 && (me[u] = 1)
      ;(h = f), f & 7 && (c = f)
    }
...
function $m(n, e, t, i, r) {
  ...
  for (let o = 0, l = 0, a = 0; o <= i.length; o++) {
    ...
    for (let c = u, f, d, O; c < h; c++)
      if ((d = hl[(f = n.charCodeAt(c))]))
        if (d < 0) {
          for (let p = l - 3; p >= 0; p -= 3)
            if (Zt[p + 1] == -d) {
              let g = Zt[p + 2],
                m = g & 2 ? r : g & 4 ? (g & 1 ? s : r) : 0
              m && (me[c] = me[Zt[p]] = m), (l = p)
              break
            }
        } else {
          if (Zt.length == 189) break
          ;(Zt[l++] = c), (Zt[l++] = f), (Zt[l++] = a)
        }
      else if ((O = me[c]) == 2 || O == 1) {
        let p = O == r
        a = p ? 0 : 1
    ...
    for (let a = o; a < l; ) {
      ...
      if (u == 256) {
        ...
        let c = s == 1,
          f = (h < e ? me[h] : i) == 1,
          d = c == f ? (c ? 1 : 2) : i
        for (let O = h, p = r, g = p ? t[p - 1].to : n; O > a; )
          O == g && ((O = t[--p].from), (g = p ? t[p - 1].to : n)),
            (me[--O] = d)
        a = h
      } else (s = u), a++
    }
    ...
    for (let a = e, u = 0; a < t; ) {
      ...
      e: for (;;)
        if (u < s.length && O == s[u].from) {
          ...
          let p = s[u]
          if (!h)
            for (let g = p.to, m = u + 1; ; ) {
              if (g == t) break e
              if (m < s.length && s[m].from == g) g = s[m++].to
              else {
                if (me[g] == l) break e
                break
              }
          ...
          if ((u++, f)) f.push(p)
            ...
            p.from > a && o.push(new yi(a, p.from, d))
            let g = (p.direction == qi) != !(d % 2)
            fl(n, g ? i + 1 : i, r, p.inner, p.from, p.to, o), (a = p.to)
          }
          O = p.to
        } else {
          if (O == t || (h ? me[O] != l : me[O] == l)) break
          O++
        }
      f ? cl(n, a, O, i + 1, r, f, o) : a < O && o.push(new yi(a, O, d)),
        (a = O)
    }
  else
    for (let a = t, u = s.length; a > e; ) {
      ...
      e: for (;;)
        if (u && O == s[u - 1].to) {
          ...
          let p = s[--u]
          if (!h)
            for (let g = p.from, m = u; ; ) {
              if (g == e) break e
              if (m && s[m - 1].to == g) g = s[--m].from
              else {
                if (me[g - 1] == l) break e
                break
              }
          ...
          if (f) f.push(p)
            ...
            p.to < a && o.push(new yi(p.to, a, d))
            let g = (p.direction == qi) != !(d % 2)
            fl(n, g ? i + 1 : i, r, p.inner, p.from, p.to, o), (a = p.from)
          }
          O = p.from
        } else {
          if (O == e || (h ? me[O - 1] != l : me[O - 1] == l)) break
          O--
        }
      f ? cl(n, O, a, i + 1, r, f, o) : O < a && o.push(new yi(O, a, d)),
        (a = O)
    }
}
function fl(n, e, t, i, r, s, o) {
  let l = e % 2 ? 2 : 1
  Am(n, r, s, i, l), $m(n, r, s, i, l), Em(r, s, i, l), cl(n, r, s, e, t, i, o)
}
function Tm(n, e, t) {
  if (!n) return [new yi(0, 0, e == Ul ? 1 : 0)]
  if (e == qi && !t.length && !Pm.test(n)) return Uc(n.length)
  if (t.length) for (; n.length > me.length; ) me[me.length] = 256
  let i = [],
    r = e == qi ? 0 : 1
  return fl(n, r, r, t, 0, n.length, i), i
}
function Uc(n) {
  return [new yi(0, n, 0)]
}
...
function Rm(n, e, t, i, r) {
  ...
  let h = qe(n.text, o, a.forward(r, t))
  ;(h < a.from || h > a.to) && (h = u),
    (Hc = n.text.slice(Math.min(o, h), Math.max(o, h)))
  let c = l == (r ? e.length - 1 : 0) ? null : e[l + (r ? 1 : -1)]
  return c && h == u && c.level + (r ? 0 : 1) < a.level
    ? T.cursor(c.side(!r, t) + n.from, c.forward(r, t) ? 1 : -1, c.level)
    : T.cursor(h + n.from, a.forward(r, t) ? -1 : 1, a.level)
}
function Mm(n, e, t) {
  for (let i = e; i < t; i++) {
    let r = Wc(n.charCodeAt(i))
    if (r == 1) return qi
    if (r == 2 || r == 4) return Ul
  }
  return qi
}
const Kc = z.define(),
  ...
  Hl = z.define(),
  Kl = z.define(),
  sf = z.define({ combine: (n) => n.some((e) => e) }),
  of = z.define({ combine: (n) => n.some((e) => e) }),
  lf = z.define()
class tn {
...
const mr = ie.define({ map: (n, e) => n.map(e) }),
  af = ie.define()
function nt(n, e, t) {
  let i = n.facet(tf)
  i.length
...
const ei = z.define({ combine: (n) => (n.length ? n[0] : !0) })
let Zm = 0
const Gi = z.define({
  combine(n) {
    return n.filter((e, t) => {
...
class we {
  ...
  static fromClass(e, t) {
    return we.define((i, r) => new e(i, r), t)
  }
}
class so {
  constructor(e) {
      ...
      if (this.mustUpdate) {
        ...
        if (((this.mustUpdate = null), this.value.update))
          try {
            ...
            if (
              (nt(t.state, i, 'CodeMirror plugin crashed'), this.value.destroy)
            )
              try {
                this.value.destroy()
              } catch {}
      ...
      span(s, o, l, a) {
        ...
        for (let f = l.length - 1; f >= 0; f--, a--) {
          ...
          if (
            ...
            let p = { from: u, to: h, direction: d, inner: [] }
            c.push(p), (c = p.inner)
          }
        }
      },
    ...
    for (let r = 0, s = 0, o = 0, l = 0; ; r++) {
      ...
      for (; s < t.length && t[s] < h; ) {
        let c = t[s],
          ...
          d = Math.max(l, c),
          O = Math.min(h, f)
        if ((d <= O && new xt(d + u, O + u, d, O).addToSet(i), f > h)) break
        s += 2
      }
      if (!a) return i
      new xt(a.fromA, a.toA, a.fromB, a.toB).addToSet(i),
        (o = a.toA),
        (l = a.toB)
    }
  }
...
class is {
  constructor(e, t, i) {
    ...
    let r = []
    this.changes.iterChangedRanges((s, o, l, a) => r.push(new xt(s, o, l, a))),
...
class au extends ge {
  ...
  constructor(e) {
    super(),
      ...
      this.updateDeco(),
      this.updateInner([new xt(0, 0, 0, e.state.doc.length)], 0, null)
  }
  update(e) {
    var t
    ...
    this.minWidth > 0 &&
      i.length &&
      (i.every(
        ({ fromA: u, toA: h }) => h < this.minWidthFrom || u > this.minWidthTo,
      )
    ...
    this.view.inputState.composing >= 0 &&
      ...
      (!((t = this.domChanged) === null || t === void 0) && t.newSel
        ...
        : !qm(e.changes, this.hasComposition) &&
          !e.selectionSet &&
          (r = e.state.selection.main.head))
    let s = r > -1 ? Fm(this.view, e.changes, r) : null
  ...
  updateInner(e, t, i) {
    ...
    if (
      ...
      for (let o of this.children)
        o instanceof ni && o.widget instanceof ul && s.push(o.dom)
    r.updateGaps(s)
  }
  updateChildren(e, t, i) {
    ...
    for (let o = r.length - 1; ; o--) {
      ...
      if (i && i.range.fromB < c && i.range.toB > h) {
        ...
        ;(d = Q.breakAtStart), (O = Q.openStart), (p = S.openEnd)
        ...
        S.breakAtStart
          ...
          Q.content.length &&
            ...
            Q.content.pop(),
          (f = Q.content.concat(C).concat(S.content))
      } else
        ({
          content: f,
          breakAtStart: d,
      ...
      let { i: g, off: m } = s.findPos(u, 1),
        { i: x, off: k } = s.findPos(a, -1)
      _c(this, x, k, g, m, f, d, O, p)
    }
  ...
  updateEditContextFormatting(e) {
    ...
    for (let t of e.transactions)
      for (let i of t.effects)
        i.is(af) && (this.editContextFormatting = i.value)
  }
  compositionView(e) {
    let t = new Et(e.text.nodeValue)
    t.flags |= 8
    for (let { deco: r } of e.marks) t = new oi(r, [t], t.length)
    let i = new Pe()
  ...
  updateSelection(e = !1, t = !1) {
    ...
    let i = this.view.root.activeElement,
      ...
      s =
        !r &&
        !(this.view.state.facet(ei) || this.dom.tabIndex > -1) &&
        jr(this.dom, this.view.observer.selectionRange) &&
    ...
    if (Y.gecko && l.empty && !this.hasComposition && Bm(a)) {
      let c = document.createTextNode('')
      this.view.observer.ignore(() =>
        a.node.insertBefore(c, a.node.childNodes[a.offset] || null),
      ),
        (a = u = new Ye(c, 0)),
        (o = !0)
    }
    ...
    ;(o ||
      !h.focusNode ||
      ((!Zn(a.node, a.offset, h.anchorNode, h.anchorOffset) ||
        !Zn(u.node, u.offset, h.focusNode, h.focusOffset)) &&
        !this.suppressWidgetCursorChange(h, l))) &&
      (this.view.observer.ignore(() => {
        Y.android &&
          Y.chrome &&
          this.dom.contains(h.focusNode) &&
          Lm(h.focusNode, this.dom) &&
          (this.dom.blur(), this.dom.focus({ preventScroll: !0 }))
        let c = Yn(this.view.root)
        if (c)
          if (l.empty) {
            if (Y.gecko) {
              let f = Xm(a.node, a.offset)
              if (f && f != 3) {
                let d = (f == 1 ? Bc : Fc)(a.node, a.offset)
      ...
      (this.impreciseAnchor = a.precise
        ? null
        : new Ye(h.anchorNode, h.anchorOffset)),
      (this.impreciseHead = u.precise
        ? null
        : new Ye(h.focusNode, h.focusOffset))
  }
  suppressWidgetCursorChange(e, t) {
    return (
      this.hasComposition &&
      t.empty &&
      Zn(e.focusNode, e.focusOffset, e.anchorNode, e.anchorOffset) &&
  ...
  moveToLine(e) {
    ...
    for (let r = e.offset; !i && r < t.childNodes.length; r++) {
      let s = ge.get(t.childNodes[r])
      s instanceof Pe && (i = s.domAtPos(0))
    }
    for (let r = e.offset - 1; !i && r >= 0; r--) {
      let s = ge.get(t.childNodes[r])
      s instanceof Pe && (i = s.domAtPos(s.length))
    }
  ...
  domAtPos(e) {
    ...
    for (; t < this.children.length - 1; ) {
      ...
      if (i < r.length || r instanceof Pe) break
      t++, (i = 0)
    }
  ...
  coordsAt(e, t) {
    ...
    for (let s = this.length, o = this.children.length - 1; o >= 0; o--) {
      ...
      if (
        ...
        (u < e || l.covers(-1)) &&
        (a > e || l.covers(1)) &&
        (!i || (l instanceof Pe && !(i instanceof Pe && t >= 0)))
      )
        (i = l), (r = u)
      else if (i && u == e && a == e && l instanceof ni && Math.abs(t) < 2) {
  ...
  coordsForChar(e) {
    let { i: t, off: i } = this.childPos(e, 1),
      r = this.children[t]
    if (!(r instanceof Pe)) return null
    ...
    if (!(r instanceof Et)) return null
    let s = qe(r.text, i)
    if (s == i) return null
    let o = Li(r.dom, i, s).getClientRects()
  ...
  measureVisibleLineHeights(e) {
    let t = [],
      ...
      l = -1,
      a = this.view.textDirection == De.LTR
    for (let u = 0, h = 0; h < this.children.length; h++) {
      ...
      if (u >= i) {
        ...
        if ((t.push(d.height), o)) {
          let O = c.dom.lastChild,
            p = O ? ln(O) : []
          if (p.length) {
            let g = p[p.length - 1],
              m = a ? g.right - d.left : d.right - g.left
            m > l &&
              ((l = m),
              (this.minWidth = s),
              (this.minWidthFrom = u),
  ...
  childCursor(e = this.length) {
    ...
    return t && (e -= this.children[--t].length), new Xc(this.children, e, t)
  }
  computeBlockGapDeco() {
    let e = [],
  ...
  updateDeco() {
    let e = 1,
      ...
      i = !1,
      r = this.view.state.facet(hf).map((s, o) => {
        let l = typeof s == 'function'
        return l && (i = !0), l ? s(this.view) : s
      })
    for (
      r.length && ((this.dynamicDecorationMap[e++] = i), t.push(de.join(r))),
        this.decorations = [
  ...
  scrollIntoView(e) {
    ...
    for (let u of this.view.state.facet(lf))
      try {
    ...
    pm(
      ...
      this.view.textDirection == De.LTR,
    )
  }
}
function Bm(n) {
...
function df(n, e) {
  ...
  let i = Bc(t.focusNode, t.focusOffset),
    r = Fc(t.focusNode, t.focusOffset),
    s = i || r
  if (r && i && r.node != i.node) {
    let l = ge.get(r.node)
    if (!l || (l instanceof Et && l.text != r.node.nodeValue)) s = r
    else if (n.docView.lastCompositionAfterCursor) {
      let a = ge.get(i.node)
      !a || (a instanceof Et && a.text != i.node.nodeValue) || (s = r)
    }
  }
...
function Fm(n, e, t) {
  ...
  let a = e.invertedDesc,
    u = new xt(a.mapPos(s), a.mapPos(o), s, o),
    h = []
  for (let c = r.parentNode; ; c = c.parentNode) {
    let f = ge.get(c)
    if (f instanceof oi) h.push({ node: c, deco: f.mark })
    else {
      if (
        f instanceof Pe ||
        (c.nodeName == 'DIV' && c.parentNode == n.contentDOM)
      )
...
function jm(n, e, t) {
  let i = new _m()
  return de.compare(n, e, t, i), i.changes
}
function Lm(n, e) {
...
function Vm(n, e, t = 1) {
  ...
  let o = s,
    l = s
  t < 0 ? (o = qe(r.text, s, !1)) : (l = qe(r.text, s))
...
function pl(n, e, t) {
  ...
  for (let O = n.firstChild; O; O = O.nextSibling) {
    ...
    for (let g = 0; g < p.length; g++) {
      let m = p[g]
      r && oo(r, m) && (m = uu(hu(m, r.bottom), r.top))
      let x = zm(e, m),
        k = Ym(t, m)
      if (x == 0 && k == 0) return O.nodeType == 3 ? cu(O, e, t) : pl(O, e, t)
      if (!i || o > k || (o == k && s > x)) {
        ;(i = O), (r = m), (s = x), (o = k)
        let Q = k ? (t < m.top ? -1 : 1) : x ? (e < m.left ? -1 : 1) : 0
        l = !Q || (Q > 0 ? g < p.length - 1 : g > 0)
      }
      x == 0
        ? t > m.bottom && (!h || h.bottom < m.bottom)
          ? ((a = O), (h = m))
          : t < m.top && (!c || c.top > m.top) && ((u = O), (c = m))
        : h && oo(h, m)
          ? (h = hu(h, m.bottom))
          : c && oo(c, m) && (c = uu(c, m.top))
    }
  }
  if (
    (h && h.bottom >= t
  ...
  if (i.nodeType == 3) return cu(i, f, t)
  if (l && i.contentEditable != 'false') return pl(i, f, t)
  let d =
  ...
  for (let l = 0; l < i; l++) {
    ...
    for (let u = 0; u < a.length; u++) {
      ...
      if (h.left - 1 <= e && h.right + 1 >= e && c < s) {
        ...
        if (
          ((Y.chrome || Y.gecko) &&
            Li(n, l).getBoundingClientRect().left == h.right &&
            (d = !f),
          c <= 0)
        )
...
function pf(n, e, t, i = -1) {
  ...
  for (
    let Q = n.viewState.heightOracle.textHeight / 2, S = !1;
    (a = n.elementAtHeight(f)), a.type != He.Text;

  )
    for (; (f = i > 0 ? a.bottom + Q : a.top - Q), !(f >= 0 && f <= u); ) {
  ...
  if (d < n.viewport.from)
    return n.viewport.from == 0 ? 0 : t ? null : fu(n, o, a, h, c)
  if (d > n.viewport.to)
  ...
  let O = n.dom.ownerDocument,
    p = n.root.elementFromPoint ? n.root : O,
    g = p.elementFromPoint(h, c)
  ...
  if (
    ...
    if (O.caretPositionFromPoint) {
      let Q = O.caretPositionFromPoint(h, c)
      Q && ({ offsetNode: m, offset: x } = Q)
    } else if (O.caretRangeFromPoint) {
      let Q = O.caretRangeFromPoint(h, c)
      Q &&
        (({ startContainer: m, startOffset: x } = Q),
  ...
  if (!m || !n.docView.dom.contains(m)) {
    let Q = Pe.find(n.docView, d)
    if (!Q) return f > a.top + a.height / 2 ? a.to : a.from
    ;({ node: m, offset: x } = pl(Q.dom, h, c))
  }
  let k = n.docView.nearest(m)
  if (!k) return null
  if (
    k.isWidget &&
    ((s = k.dom) === null || s === void 0 ? void 0 : s.nodeType) == 1
  ) {
    let Q = k.dom.getBoundingClientRect()
    return e.y < Q.top || (e.y <= Q.bottom && e.x <= (Q.left + Q.right) / 2)
      ? k.posAtStart
      : k.posAtEnd
  } else return k.localPosFromDOM(m, x) + k.posAtStart
}
function fu(n, e, t, i, r) {
  ...
  return t.from + el(o, s, n.state.tabSize)
}
function Im(n, e, t) {
  let i
...
function Nm(n, e, t) {
  ...
  let i =
    n.nodeType == 1
      ...
      : Li(n, 0, Math.max(n.nodeValue.length, 1)).getBoundingClientRect()
  return t - i.left > 5
}
function Ol(n, e, t) {
...
function Um(n, e, t, i) {
  ...
  if (u) o == null && (o = u.left - a.left), (l = s < 0 ? u.top : u.bottom)
    ...
    o == null &&
      (o = Math.min(a.right - a.left, n.defaultCharacterWidth * (r - d.from))),
  ...
  for (let d = 0; ; d += 10) {
    ...
    if (O < a.top || O > a.bottom || (s < 0 ? p < r : p > r)) {
      let g = n.docView.coordsForChar(p),
        m = !g || O < g.top ? -1 : 1
      return T.cursor(p, m, void 0, o)
    }
  }
}
function qr(n, e, t) {
...
class Hm {
  constructor(e, t) {
    ;(this.points = e),
      (this.text = ''),
      (this.lineSeparator = t.facet(he.lineSeparator))
  }
  append(e) {
    this.text += e
  }
  ...
  findPointInside(e, t) {
    for (let i of this.points)
      (e.nodeType == 3 ? i.node == e : e.contains(i.node)) &&
        (i.pos = this.text.length + (Km(e, i.node, i.offset) ? t : 0))
  }
}
function Km(n, e, t) {
  for (;;) {
    ...
    if (e.state.readOnly && t > -1) this.newSel = null
      ...
      if (
        ...
        let c = Math.min(a, u),
          ...
          O = h.to - f
        ;(d == 0 || d == 1 || c == 0) &&
          (O == 0 || O == -1 || f == e.state.doc.length) &&
          ((a = 0), (u = e.state.doc.length))
      }
      this.newSel = T.single(u, a)
    }
  }
}
function Of(n, e) {
  ...
  if (e.bounds) {
    let { from: o, to: l } = e.bounds,
      a = r.from,
      u = null
    ;(s === 8 || (Y.android && e.text.length < l - o)) &&
      ((a = r.to), (u = 'end'))
    let h = tg(n.state.doc.sliceString(o, l, Pn), e.text, a - o, u)
    h &&
      (Y.chrome &&
        s == 13 &&
        h.toB == h.from + 2 &&
        e.text.slice(h.from, h.toB) == Pn + Pn &&
        h.toB--,
      (t = {
        from: o + h.from,
        to: o + h.toA,
        insert: pe.of(e.text.slice(h.from, h.toB).split(Pn)),
      }))
  } else i && ((!n.hasFocus && n.state.facet(ei)) || i.main.eq(r)) && (i = null)
  if (!t && !i) return !1
  if (
      ...
      : (Y.mac || Y.android) &&
        ...
        ? (i &&
          ...
          (t = {
            from: t.from,
            to: t.to,
            insert: pe.of([t.insert.toString().replace('.', ' ')]),
          }))
        : t &&
            t.from >= r.from &&
            t.to <= r.to &&
 ...
 ` &&
            ...
            (t = { from: r.from, to: r.to, insert: pe.of([' ']) })),
    t)
  )
    return ia(n, t, i, s)
  if (i && !i.main.eq(r)) {
...
function ia(n, e, t, i = -1) {
  if (Y.ios && n.inputState.flushIOSKey(e)) return !0
  ...
  let o,
    l = () => o || (o = eg(n, e, t))
  return (
    n.state.facet(nf).some((a) => a(n, e.from, e.to, s, l)) || n.dispatch(l()),
    !0
  )
}
function eg(n, e, t) {
  ...
  if (
    ...
    if (
      ...
      let u = n.state.sliceDoc(e.from, e.to),
        h,
        c = t && df(n, t.main.head)
      if (c) {
        let O = e.insert.length - (e.to - e.from)
        h = { from: c.from, to: c.to - O }
      ...
      i = r.changeByRange((O) => {
        ...
        if (
          O.to - O.from != d ||
          n.state.sliceDoc(g, p) != u ||
          (O.to >= h.from && O.from <= h.to)
        )
          return { range: O }
        let m = r.changes({ from: g, to: p, insert: e.insert }),
          x = O.to - s.to
        return {
          changes: m,
          range: a
            ? T.range(Math.max(0, a.anchor + x), Math.max(0, a.head + x))
            : O.map(m),
        }
      })
...
function ig(n) {
  ...
  return (
    t && (e.push(new pu(t, i)), (r != t || s != i) && e.push(new pu(r, s))), e
  )
}
function ng(n, e) {
...
class rg {
  ...
  constructor(e) {
    ;(this.view = e),
      ...
      Y.gecko && bg(e.contentDOM.ownerDocument)
  }
  handleEvent(e) {
    !fg(this.view, e) ||
  ...
  keydown(e) {
    ...
    return Y.ios &&
      ...
      !e.altKey &&
      !e.metaKey &&
      (((t = mf.find((i) => i.keyCode == e.keyCode)) && !e.ctrlKey) ||
        (og.indexOf(e.key) > -1 && e.ctrlKey && !e.shiftKey))
...
function sg(n) {
  ...
  for (let i of n) {
    ...
    if (s)
      for (let l in s) {
        let a = s[l]
        a && t(l).handlers.push(Ou(i.value, a))
      }
    if (o)
      for (let l in o) {
        let a = o[l]
        a && t(l).observers.push(Ou(i.value, a))
      }
  }
  for (let i in Tt) t(i).handlers.push(Tt[i])
  for (let i in St) t(i).observers.push(St[i])
  return e
}
const mf = [
...
class ag {
  constructor(e, t, i, r) {
    ;(this.view = e),
      ...
      (this.scrolling = -1),
      (this.lastEvent = t),
      (this.scrollParents = Om(e.contentDOM)),
      (this.atoms = e.state.facet(ea).map((o) => o(e)))
    ...
    s.addEventListener('mousemove', (this.move = this.move.bind(this))),
      ...
      (this.multiple = e.state.facet(he.allowMultipleSelections) && ug(e, t)),
      (this.dragging = cg(e, t) && bf(t) == 1 ? null : !1)
  }
  start(e) {
  ...
  move(e) {
    ...
    if (this.dragging || (this.dragging == null && lg(this.startEvent, e) < 10))
      return
    ...
    let a = ta(this.view)
    e.clientX - a.left <= r + gr
      ? (t = -yr(r - e.clientX))
      : e.clientX + a.right >= o - gr && (t = yr(e.clientX - o)),
      e.clientY - a.top <= s + gr
        ? (i = -yr(s - e.clientY))
        : e.clientY + a.bottom >= l - gr && (i = yr(e.clientY - l)),
  ...
  skipAtoms(e) {
    ...
    for (let i = 0; i < e.ranges.length; i++) {
      let r = e.ranges[i],
        s = null
      if (r.empty) {
        let o = qr(this.atoms, r.from, 0)
        o != r.from && (s = T.cursor(o, -1))
      } else {
        let o = qr(this.atoms, r.from, -1),
          l = qr(this.atoms, r.to, 1)
        ;(o != r.from || l != r.to) &&
...
function fg(n, e) {
  ...
  for (let t = e.target, i; t != n.contentDOM; t = t.parentNode)
    if (!t || t.nodeType == 11 || ((i = ge.get(t)) && i.ignoreEvent(e)))
      return !1
  return !0
}
const Tt = Object.create(null),
  St = Object.create(null),
  yf = (Y.ie && Y.ie_version < 15) || (Y.ios && Y.webkit_version < 604)
function dg(n) {
  ...
  if (
    ...
    i = t.changeByRange((u) => {
      ...
      return {
        ...
        range: T.cursor(u.from + c.length),
      }
    })
  } else
    o
...
Tt.mousedown = (n, e) => {
  if ((n.observer.flush(), n.inputState.lastTouchTime > Date.now() - 2e3))
    return !1
  let t = null
  for (let i of n.state.facet(ef)) if (((t = i(n, e)), t)) break
  if ((!t && e.button == 0 && (t = mg(n, e)), t)) {
    let i = !n.hasFocus
    n.inputState.startMouseSelection(new ag(n, e, t, i)),
      i &&
        n.observer.ignore(() => {
          Rc(n.contentDOM)
...
function mu(n, e, t, i) {
  ...
  if (i == 2) return Vm(n.state, e, t)
  {
    let r = Pe.find(n.docView, e),
...
let gu = (n, e, t) => e >= t.top && e <= t.bottom && n >= t.left && n <= t.right
function pg(n, e, t, i) {
  let r = Pe.find(n.docView, e)
  if (!r) return 1
  ...
  if (o && gu(t, i, o)) return -1
  let l = r.coordsAt(s, 1)
  return l && gu(t, i, l) ? 1 : o && o.bottom >= i ? -1 : 1
}
function yu(n, e) {
  let t = n.posAtCoords({ x: e.clientX, y: e.clientY }, !1)
  return { pos: t, bias: pg(n, t, e.clientX, e.clientY) }
}
const Og = Y.ie && Y.ie_version <= 11
let xu = null,
  bu = 0,
  Su = 0
function bf(n) {
  if (!Og) return n.detail
  let e = xu,
    t = Su
  return (
    (xu = n),
...
function mg(n, e) {
  ...
  return {
    ...
    get(s, o, l) {
      let a = yu(n, s),
        u,
        h = mu(n, a.pos, a.bias, i)
      if (t.pos != a.pos && !o) {
        let c = mu(n, t.pos, t.bias, i),
          f = Math.min(c.from, h.from),
          d = Math.max(c.to, h.to)
        h = f < h.from ? T.range(f, d) : T.range(d, f)
      }
      return o
        ? r.replaceRange(r.main.extend(h.from, h.to))
        : l && i == 1 && r.ranges.length > 1 && (u = gg(r, a.pos))
          ? u
          : l
            ? r.addRange(h)
            : T.create([h])
  ...
  return (
    ...
    e.dataTransfer &&
      (e.dataTransfer.setData(
        'Text',
        Es(n.state, Kl, n.state.sliceDoc(t.from, t.to)),
      ),
      (e.dataTransfer.effectAllowed = 'copyMove')),
    !1
  )
}
Tt.dragend = (n) => ((n.inputState.draggedContent = null), !1)
function Du(n, e, t, i) {
  if (((t = Es(n.state, Hl, t)), !t)) return
  let r = n.posAtCoords({ x: e.clientX, y: e.clientY }, !1),
    { draggedContent: s } = n.inputState,
    o = i && s && hg(n, e) ? { from: s.from, to: s.to } : null,
    l = { from: r, insert: t },
...
Tt.drop = (n, e) => {
  ...
  if (t && t.length) {
    let i = Array(t.length),
      ...
      s = () => {
        ++r == t.length &&
          Du(n, e, i.filter((o) => o != null).join(n.state.lineBreak), !1)
      }
...
Tt.paste = (n, e) => {
  if (n.state.readOnly) return !0
  n.observer.flush()
  let t = yf ? null : e.clipboardData
  return t
    ? (xf(n, t.getData('text/plain') || t.getData('text/uri-list')), !0)
    : (dg(n), !1)
}
function yg(n, e) {
...
function xg(n) {
  ...
  return { text: Es(n, Kl, e.join(n.lineBreak)), ranges: t, linewise: i }
}
let ml = null
Tt.copy = Tt.cut = (n, e) => {
  let { text: t, ranges: i, linewise: r } = xg(n.state)
  if (!t && !r) return !1
  ;(ml = r ? t : null),
    e.type == 'cut' &&
      !n.state.readOnly &&
      n.dispatch({ changes: i, scrollIntoView: !0, userEvent: 'delete.cut' })
  let s = yf ? null : e.clipboardData
  return s ? (s.clearData(), s.setData('text/plain', t), !0) : (yg(n, t), !1)
}
const Sf = Nt.define()
function Df(n, e) {
  let t = []
  ...
  return t.length ? n.update({ effects: t, annotations: Sf.of(!0) }) : null
}
function vf(n) {
  setTimeout(() => {
    let e = n.hasFocus
...
St.blur = (n) => {
  n.observer.clearSelectionRange(), vf(n)
}
...
Tt.beforeinput = (n, e) => {
  ...
  if (e.inputType == 'insertReplacementText' && n.observer.editContext) {
    ...
    if (s && o.length) {
      ...
      return ia(n, { from: a, to: u, insert: n.state.toText(s) }, null), !0
    }
  }
  let r
  if (
    Y.chrome &&
    Y.android &&
    (r = mf.find((s) => s.inputType == e.inputType)) &&
  ...
  return (
    Y.ios && e.inputType == 'deleteContentForward' && n.observer.flushSoon(),
    Y.safari &&
      e.inputType == 'insertText' &&
      n.inputState.composing >= 0 &&
      setTimeout(() => St.compositionend(n, e), 20),
    !1
  )
}
const vu = new Set()
...
class Ke {
  ...
  setHeight(e) {
    this.height != e &&
      (Math.abs(this.height - e) > Vr && (hn = !0), (this.height = e))
  }
  replace(e, t, i) {
    return Ke.of(i)
  }
  ...
  applyChanges(e, t, i, r) {
    ...
    for (let l = r.length - 1; l >= 0; l--) {
      ...
      ;(h += f.from - a), (a = f.from)
      let O = na.build(i.setDoc(o), e, h, c)
      s = ns(s, s.replace(a, u, O))
    }
  ...
  static of(e) {
    ...
    return (
      ...
      new vg(Ke.of(e.slice(0, t)), o, Ke.of(e.slice(i)))
    )
  }
}
function ns(n, e) {
  return n == e ? n : (n.constructor != e.constructor && (hn = !0), e)
}
Ke.prototype.size = 1
class Qf extends Ke {
  constructor(e, t, i) {
  ...
  blockAt(e, t, i, r) {
    return new Lt(r, this.length, i, this.height, this.deco || 0)
  }
  lineAt(e, t, i, r, s) {
...
class ht extends Qf {
  ...
  blockAt(e, t, i, r) {
    return new Lt(r, this.length, i, this.height, this.breaks)
  }
  replace(e, t, i) {
    let r = i[0]
    return i.length == 1 &&
      (r instanceof ht || (r instanceof je && r.flags & 4)) &&
      Math.abs(this.length - r.length) < 10
      ? (r instanceof je
          ? (r = new ht(r.length, this.height))
...
class je extends Ke {
  ...
  lineAt(e, t, i, r, s) {
    ...
    return new Lt(
      u.from,
      u.length,
      Math.max(r, Math.min(f, r + this.height - h)),
      h,
      0,
    )
  }
  forEachLine(e, t, i, r, s, o) {
    ...
    for (let h = e, c = r; h <= t; ) {
      ...
      let d = a + u * f.length
      o(new Lt(f.from, f.length, c, d, 0)), (c += d), (h = f.to + 1)
    }
  }
  replace(e, t, i) {
    let r = this.length - t
  ...
  updateHeight(e, t = 0, i = !1, r) {
    ...
    if (r && r.from <= t + this.length && r.more) {
      ...
      return (
        (a < 0 ||
          Math.abs(u.height - this.height) >= Vr ||
...
class vg extends Ke {
  ...
  lineAt(e, t, i, r, s) {
    ...
    let h = t == Se.ByPosNoHeight ? Se.ByPosNoHeight : Se.ByPos
    return a
      ? u.join(this.right.lineAt(l, h, i, o, l))
      : this.left.lineAt(l, h, i, r, s).join(u)
  }
  forEachLine(e, t, i, r, s, o) {
  ...
  replace(e, t, i) {
    ...
    if ((e > 0 && wu(s, o - 1), t < this.length)) {
      let l = s.length
      this.decomposeRight(t, s), wu(s, l)
    }
    return Ke.of(s)
  }
  decomposeLeft(e, t) {
  ...
  balanced(e, t) {
    return e.size > 2 * t.size || t.size > 2 * e.size
      ...
      : ((this.left = ns(this.left, e)),
        (this.right = ns(this.right, t)),
...
class na {
    ...
    if (this.lineStart > -1) {
      ...
      r instanceof ht
        ...
        : (i > this.pos || !this.isCovered) &&
          this.nodes.push(new ht(i - this.pos, -1)),
        (this.writtenTo = i),
        t > i &&
  ...
  point(e, t, i) {
    if (e < t || i.heightRelevant) {
      ...
      let o = t - e
      i.block
        ? this.addBlock(new Qf(o, r, i))
        : (o || s || r >= Qg) && this.addLineDeco(r, s, o)
  ...
  enterLine() {
    ...
    ;(this.lineStart = e),
      ...
      this.pos > e && this.nodes.push(new ht(this.pos - e, -1)),
  ...
  finish(e) {
    ...
    this.lineStart > -1 && !(t instanceof ht) && !this.isCovered
      ? this.nodes.push(new ht(0, -1))
      : (this.writtenTo < this.pos || t == null) &&
        this.nodes.push(this.blankContent(this.writtenTo, this.pos))
    let i = e
    for (let r of this.nodes)
      r instanceof ht && r.updateHeight(this.oracle, i), (i += r ? r.length : 1)
    return this.nodes
  }
  static build(e, t, i, r) {
    let s = new na(i, e)
    return de.spans(t, i, r, s, 0), s.finish(i)
  }
}
function kg(n, e, t) {
  let i = new wg()
  return de.compare(n, e, t, i, 0), i.changes
}
class wg {
  constructor() {
    this.changes = []
...
class ao {
  ...
  draw(e, t) {
    return U.replace({
      widget: new $g(this.displaySize * (t ? e.scaleY : e.scaleX), t),
...
class Cu {
  constructor(e) {
    ;(this.state = e),
      ...
      (this.defaultTextDirection = De.LTR),
      (this.visibleRanges = []),
      (this.mustEnforceCursorAssoc = !1)
    let t = e
      .facet(Jl)
      .some((i) => typeof i != 'function' && i.class == 'cm-lineWrapping')
    ;(this.heightOracle = new Sg(t)),
      (this.stateDeco = e.facet(In).filter((i) => typeof i != 'function')),
      (this.heightMap = Ke.empty().applyChanges(
        this.stateDeco,
        pe.empty,
        this.heightOracle.setDoc(e.doc),
        [new xt(0, 0, 0, e.doc.length)],
      ))
    for (
      let i = 0;
      i < 2 &&
    ...
    this.updateViewportLines(),
      ...
      (this.lineGapDeco = U.set(this.lineGaps.map((i) => i.draw(this, !1)))),
  ...
  updateForViewport() {
    ...
    return (
      (this.viewports = e.sort((i, r) => i.from - r.from)), this.updateScaler()
    )
  }
  updateScaler() {
    let e = this.scaler
    return (
      (this.scaler =
        this.heightMap.height <= 7e6
          ? Pu
          : new ra(this.heightOracle, this.heightMap, this.viewports)),
  ...
  updateViewportLines() {
    ;(this.viewportLines = []),
      this.heightMap.forEachLine(
        ...
        0,
        (e) => {
          this.viewportLines.push(An(e, this.scaler))
        },
      )
  }
  update(e, t = null) {
    ...
    this.stateDeco = this.state.facet(In).filter((h) => typeof h != 'function')
    let r = e.changedRanges,
      s = xt.extendWithRanges(
        r,
        kg(i, this.stateDeco, e ? e.changes : Me.empty(this.state.doc.length)),
      ),
    ...
    ku(),
      ...
      (this.heightMap.height != o || hn) && (e.flags |= 2),
      l
  ...
  measure(e) {
    let t = e.contentDOM,
      ...
      r = this.heightOracle,
      s = i.whiteSpace
    this.defaultTextDirection = i.direction == 'rtl' ? De.RTL : De.LTR
    ...
    this.scrollTop != d &&
      ...
      (this.scrolledToBottom = Zc(e.scrollDOM))
    let O = (this.printing ? Ag : Cg)(t, this.paddingTop),
      p = O.top - this.pixelViewport.top,
    ...
    if (
      ...
      !this.inView && !this.scrollTarget && !Pg(e.dom))
    )
      return 0
    let x = l.width
    if (
      ...
      if (
        ...
        o ||
          (r.lineWrapping && Math.abs(x - this.contentDOMWidth) > r.charWidth))
      ) {
        let {
          lineHeight: S,
          charWidth: C,
        ...
        ;(o = S > 0 && r.refresh(s, S, C, E, x / C, Q)),
          o && ((e.docView.minWidth = 0), (u |= 16))
      }
      p > 0 && g > 0
        ? (h = Math.max(p, g))
        : p < 0 && g < 0 && (h = Math.min(p, g)),
        ku()
      for (let S of this.viewports) {
        ...
        this.heightMap = (
          o
            ? Ke.empty().applyChanges(
                this.stateDeco,
                pe.empty,
                this.heightOracle,
                [new xt(0, 0, 0, e.state.doc.length)],
              )
            : this.heightMap
        ).updateHeight(r, 0, o, new Dg(S.from, C))
      }
      hn && (u |= 2)
    }
    let k =
      ...
      if (u < a.from || u > a.to) {
        ...
        t.y == 'center'
          ...
          (a = new xr(
            ...
            r.lineAt(f + h + 1e3 / 2, Se.ByHeight, s, 0, 0).to,
          ))
      }
    }
    return a
  ...
  mapLineGaps(e, t) {
    ...
    for (let r of e)
      t.touchesRange(r.from, r.to) ||
        i.push(new ao(t.mapPos(r.from), t.mapPos(r.to), r.size, r.displaySize))
    return i
  }
  ensureLineGaps(e, t) {
    let i = this.heightOracle.lineWrapping,
      ...
      s = r >> 1,
      o = r << 1
    if (this.defaultTextDirection != De.LTR && !i) return []
    let l = [],
      a = (h, c, f, d) => {
        if (c - h < s) return
        ...
        if (!g) {
          if (
            ...
            t &&
            i &&
            t.visibleRanges.some((k) => k.from <= c && k.to >= c)
          ) {
            let k = t.moveToLineBoundary(T.cursor(c), !1, !0).head
            k > h && (c = k)
          }
          let m = this.gapSize(f, h, c, d),
            x = i || m < 2e6 ? m : 2e6
          g = new ao(h, c, m, x)
        }
        l.push(g)
      ...
      u = (h) => {
        if (h.length < o || h.type != He.Text) return
        let c = Eg(h.from, h.to, this.stateDeco)
        if (c.total < o) return
          ...
          if (p > 2e6)
            for (let C of e)
              C.from >= h.from &&
                ...
                C.from * this.heightOracle.charWidth + m <
                  this.pixelViewport.left &&
                (m = C.size - C.displaySize)
          let x = this.pixelViewport.left + m,
            k = this.pixelViewport.right + m,
            Q,
            S
          if (f != null) {
            let C = Sr(c, f),
              E = ((k - x) / 2 + g) / p
            ;(Q = C - E), (S = C + E)
          } else (Q = (x - g) / p), (S = (k + g) / p)
          ;(d = br(c, Q)), (O = br(c, S))
        }
        d > h.from && a(h.from, d, h, c), O < h.to && a(O, h.to, h, c)
      }
...
function br({ total: n, ranges: e }, t) {
  ...
  constructor(e, t, i) {
    ...
    ;(this.viewports = i.map(({ from: l, to: a }) => {
      let u = t.lineAt(l, Se.ByPos, e, 0, 0).top,
        h = t.lineAt(a, Se.ByPos, e, 0, 0).bottom
      return (
        (r += h - u),
        { from: l, to: a, top: u, bottom: h, domTop: 0, domBottom: 0 }
      )
    })),
...
function An(n, e) {
  ...
  return new Lt(
    ...
    t,
    i - t,
    Array.isArray(n._content) ? n._content.map((r) => An(r, e)) : n._content,
  )
}
const Dr = z.define({ combine: (n) => n.join(' ') }),
  gl = z.define({ combine: (n) => n.indexOf(!0) > -1 }),
  yl = Si.newName(),
  kf = Si.newName(),
  wf = Si.newName(),
  Cf = { '&light': '.' + kf, '&dark': '.' + wf }
...
const Rg = xl(
  ...
  uo = Y.ie && Y.ie_version <= 11
class Zg {
  constructor(e) {
    ;(this.view = e),
      (this.active = !1),
      (this.editContext = null),
      (this.selectionRange = new mm()),
      ...
      (this.observer = new MutationObserver((t) => {
        ...
        ;((Y.ie && Y.ie_version <= 11) || (Y.ios && e.composing)) &&
        t.some(
          (i) =>
      ...
      window.EditContext &&
        ...
        !(Y.chrome && Y.chrome_version < 126) &&
        ((this.editContext = new Fg(e)),
        e.state.facet(ei) &&
  ...
  onSelectionChange(e) {
    ...
    if (i.state.facet(ei) ? i.root.activeElement != this.dom : !jr(this.dom, r))
      return
    ...
    ;((Y.ie && Y.ie_version <= 11) || (Y.android && Y.chrome)) &&
    !i.state.selection.main.empty &&
    r.focusNode &&
    Zn(r.focusNode, r.focusOffset, r.anchorNode, r.anchorOffset)
      ? this.flushSoon()
      : this.flush(!1)
  }
  readSelectionRange() {
  ...
  start() {
    this.active ||
      (this.observer.observe(this.dom, Mg),
      uo &&
  ...
  readChange() {
    let { from: e, to: t, typeOver: i } = this.processRecords(),
      r = this.selectionChanged && jr(this.dom, this.selectionRange)
  ...
  readMutation(e) {
    ...
    if (
      ...
      let i = Au(t, e.previousSibling || e.target.previousSibling, -1),
        r = Au(t, e.nextSibling || e.target.nextSibling, 1)
      return {
  ...
  update(e) {
    this.editContext &&
      ...
      e.startState.facet(ei) != e.state.facet(ei) &&
        (e.view.contentDOM.editContext = e.state.facet(ei)
...
function $u(n, e) {
  ...
  return (
    Zn(o.node, o.offset, r, s) && ([t, i, r, s] = [r, s, t, i]),
...
`),
      ...
      if (
        (u.from == this.from && s < this.from
          ? (u.from = s)
          : u.to == this.to && s > this.to && (u.to = s),
        u.from == u.to && !u.insert.length)
      ) {
        let h = T.single(
      ...
      if (
        ((Y.mac || Y.android) &&
          ...
          (u = { from: l, to: a, insert: pe.of([i.text.replace('.', ' ')]) }),
        ...
        ia(
          ...
          u,
          T.single(
            this.toEditorPos(i.selectionStart, h),
            this.toEditorPos(i.selectionEnd, h),
          ),
        )
      }
        ...
        for (let s of i.getTextFormats()) {
          ...
          if (o != 'None' && l != 'None') {
            ...
            if (a < u) {
              ...
              r.push(U.mark({ attributes: { style: h } }).range(a, u))
            }
          }
        }
        e.dispatch({ effects: af.of(U.set(r)) })
      }),
...
class _ {
  ...
  constructor(e = {}) {
    ...
    ;(this.dispatchTransactions =
      ...
      (this._root = e.root || gm(e.parent) || document),
      (this.viewState = new Cu(e.state || he.create(e))),
      e.scrollTo &&
        e.scrollTo.is(mr) &&
        (this.viewState.scrollTarget = e.scrollTo.value.clip(
          this.viewState.state,
        )),
      (this.plugins = this.state.facet(Gi).map((r) => new so(r)))
    for (let r of this.plugins) r.update(this)
    ;(this.observer = new Zg(this)),
      (this.inputState = new rg(this)),
      this.inputState.ensureHandlers(this.plugins),
      (this.docView = new au(this)),
      this.mountStyles(),
      this.updateAttrs(),
      (this.updateState = 0),
      this.requestMeasure(),
  ...
  update(e) {
    ...
    let o = this.hasFocus,
      l = 0,
      a = null
    e.some((f) => f.annotation(Sf))
      ? ((this.inputState.notifiedFocused = o), (l = 1))
      : o != this.inputState.notifiedFocused &&
        ((this.inputState.notifiedFocused = o), (a = Df(s, o)), a || (l = 1))
      ...
      (u
        ? (this.observer.clearDelayedAndroidKey(),
          ...
          ((h && !this.state.doc.eq(s.doc)) ||
            ...
            (h = null))
        : this.observer.clear(),
      s.facet(he.phrases) != this.state.facet(he.phrases))
    )
      return this.setState(s)
    ;(r = is.create(this, s, e)), (r.flags |= l)
    ...
    try {
      ...
      for (let f of e) {
        if ((c && (c = c.map(f.changes)), f.scrollIntoView)) {
          ...
          c = new tn(d.empty ? d : T.cursor(d.head, d.head > d.anchor ? -1 : 1))
        }
        for (let d of f.effects) d.is(mr) && (c = d.value.clip(this.state))
      }
      this.viewState.update(r, c),
        (this.bidiCache = rs.update(this.bidiCache, r.changes)),
    ...
    if (
      (r.startState.facet(Dr) != r.state.facet(Dr) &&
    ...
    ;(a || h) &&
      Promise.resolve().then(() => {
        a && this.state == a.startState && this.dispatch(a),
          h && !Of(this, h) && u.force && en(this.contentDOM, u.key, u.keyCode)
      })
  }
  setState(e) {
    if (this.updateState != 0)
    ...
    try {
      ...
      ;(this.viewState = new Cu(e)),
        (this.plugins = e.facet(Gi).map((i) => new so(i))),
  ...
  updatePlugins(e) {
    let t = e.startState.facet(Gi),
      i = e.state.facet(Gi)
    if (t != i) {
      let r = []
      for (let s of i) {
        let o = t.indexOf(s)
        if (o < 0) r.push(new so(s))
        else {
  ...
  measure(e = !0) {
    ...
    try {
      for (let l = 0; ; l++) {
        if (o < 0)
          if (Zc(i)) (s = -1), (o = this.viewState.heightMap.height)
          else {
        ...
        let h = u.map((d) => {
            try {
              ...
              return nt(this.state, O), Eu
            }
          }),
          c = is.create(this, this.state, []),
          f = !1
        ;(c.flags |= a),
          t ? (t.flags |= a) : (t = c),
          (this.updateState = 2),
    ...
    if (t && !t.empty) for (let l of this.state.facet(dl)) l(t)
  }
  get themeClasses() {
    return (
      yl + ' ' + (this.state.facet(gl) ? wf : kf) + ' ' + this.state.facet(Dr)
    )
  }
  updateAttrs() {
    let e = Tu(this, uf, {
    ...
    this.state.readOnly && (t['aria-readonly'] = 'true'), Tu(this, Jl, t)
    let i = this.observer.ignore(() => {
      let r = al(this.contentDOM, this.contentAttrs, t),
        s = al(this.dom, this.editorAttrs, e)
      return r || s
    })
  ...
  mountStyles() {
    ...
    Si.mount(
      this.root,
      this.styleModules.concat(Rg).reverse(),
      e ? { nonce: e } : void 0,
    )
  }
  readMeasured() {
  ...
  moveByChar(e, t, i) {
    return lo(this, e, du(this, e, t, i))
  }
  moveByGroup(e, t) {
    return lo(
      this,
      e,
      du(this, e, t, (i) => Gm(this, e.head, i)),
    )
  }
  visualLineSide(e, t) {
  ...
  moveToLineBoundary(e, t, i = !0) {
    return Wm(this, e, t, i)
  }
  moveVertically(e, t, i) {
    return lo(this, e, Um(this, e, t, i))
  }
  domAtPos(e) {
  ...
  posAtCoords(e, t = !0) {
    return this.readMeasured(), pf(this, e, t)
  }
  coordsAtPos(e, t = 1) {
    this.readMeasured()
    ...
    let r = this.state.doc.lineAt(e),
      s = this.bidiSpans(r),
      o = s[yi.find(s, e - r.from, -1, t)]
    return nr(i, (o.dir == De.LTR) == t > 0)
  }
  coordsForChar(e) {
  ...
  bidiSpans(e) {
    if (e.length > Xg) return Uc(e.length)
    ...
    for (let s of this.bidiCache)
      if (
        s.from == e.from &&
        s.dir == t &&
        (s.fresh || Gc(s.isolates, (i = lu(this, e))))
      )
        return s.order
    i || (i = lu(this, e))
    let r = Tm(e.text, t, i)
    return this.bidiCache.push(new rs(e.from, e.to, t, i, !0, r)), r
  }
  get hasFocus() {
    var e
    return (
  ...
  scrollSnapshot() {
    ...
    return mr.of(new tn(T.cursor(i.from), 'start', 'start', i.top - e, t, !0))
  }
  setTabFocusMode(e) {
    e == null
  ...
  static theme(e, t) {
    let i = Si.newName(),
      r = [Dr.of(i), Cn.of(xl(`.${i}`, e))]
    return t && t.dark && r.push(gl.of(!0)), r
  }
  static baseTheme(e) {
    return zi.lowest(Cn.of(xl('.' + yl, e, Cf)))
  }
...
_.styleModule = Cn
_.inputHandler = nf
_.clipboardInputFilter = Hl
_.clipboardOutputFilter = Kl
_.scrollHandler = lf
_.focusChangeEffect = rf
_.perLineTextDirection = sf
_.exceptionSink = tf
_.updateListener = dl
_.editable = ei
_.mouseSelectionStyle = ef
_.dragMovesSelection = Jc
_.clickAddsSelectionRange = Kc
_.decorations = In
_.outerDecorations = hf
_.atomicRanges = ea
_.bidiIsolatedRanges = cf
_.scrollMargins = ff
_.darkTheme = gl
_.cspNonce = z.define({ combine: (n) => (n.length ? n[0] : '') })
_.contentAttributes = Jl
_.editorAttributes = uf
_.lineWrapping = _.contentAttributes.of({ class: 'cm-lineWrapping' })
_.announce = ie.define()
const Xg = 4096,
  Eu = {}
class rs {
  constructor(e, t, i, r, s, o) {
  ...
  static update(e, t) {
    ...
    let i = [],
      r = e.length ? e[e.length - 1].dir : De.LTR
...
const _g = Y.mac ? 'mac' : Y.windows ? 'win' : Y.linux ? 'linux' : 'key'
function jg(n, e) {
  const t = n.split(/-(?!$)/)
  let i = t[t.length - 1]
  i == 'Space' && (i = ' ')
...
const Lg = zi.default(
    _.domEventHandlers({
      keydown(n, e) {
        return Af(Pf(e.state), n, e, 'editor')
      },
    }),
  ),
  or = z.define({ enables: Lg }),
  Ru = new WeakMap()
function Pf(n) {
  let e = n.facet(or),
    t = Ru.get(e)
  return t || Ru.set(e, (t = zg(e.reduce((i, r) => i.concat(r), [])))), t
}
function qg(n, e, t) {
  return Af(Pf(n.state), e, n, t)
}
let Oi = null
const Vg = 4e3
function zg(n, e = _g) {
  let t = Object.create(null),
    ...
    s = (o, l, a, u, h) => {
      ...
      let d = t[o] || (t[o] = Object.create(null)),
        O = l.split(/ (?!$)/).map((m) => jg(m, e))
      for (let m = 1; m < O.length; m++) {
        let x = O.slice(0, m).join(' ')
        r(x, !0),
          d[x] ||
            (d[x] = {
              preventDefault: !0,
              ...
              run: [
                (k) => {
                  let Q = (Oi = { view: k, prefix: x, scope: o })
                  return (
                    setTimeout(() => {
                      Oi == Q && (Oi = null)
                    }, Vg),
      ...
      let g =
        ...
        (d[p] = {
          ...
          stopPropagation: !1,
          run:
            ((f = (c = d._any) === null || c === void 0 ? void 0 : c.run) ===
              null || f === void 0
              ? void 0
              : f.slice()) || [],
        })
      a && g.run.push(a),
        u && (g.preventDefault = !0),
        h && (g.stopPropagation = !0)
    }
  for (let o of n) {
    ...
    if (o.any)
      for (let u of l) {
        ...
        h._any ||
          (h._any = { preventDefault: !1, stopPropagation: !1, run: [] })
        let { any: c } = o
        for (let f in h) h[f].run.push((d) => c(d, bl))
      }
    let a = o[e] || o.key
    if (a)
      for (let u of l)
...
function Af(n, e, t, i) {
  ...
  Oi &&
    ...
    Oi.scope == i &&
    ((l = Oi.prefix + ' '),
    gf.indexOf(e.keyCode) < 0 && ((u = !0), (Oi = null)))
  let c = new Set(),
    f = (g) => {
      if (g) {
        for (let m of g.run)
          if (!c.has(m) && (c.add(m), m(t)))
            return g.stopPropagation && (h = !0), !0
        g.preventDefault && (g.stopPropagation && (h = !0), (u = !0))
      }
      return !1
    },
    d = n[i],
        ...
        : o &&
          ...
          ? (f(d[l + vr(O, e, !0)]) ||
              (e.shiftKey &&
                ...
                f(d[l + vr(p, e, !1)]))) &&
            (a = !0)
          : o && e.shiftKey && f(d[l + vr(r, e, !0)]) && (a = !0),
      !a && f(d._any) && (a = !0)),
    u && (a = !0),
...
function Yg(n, e, t) {
  ...
  let i = Math.max(t.from, n.viewport.from),
    ...
    c =
      l.left +
      (h ? parseInt(h.paddingLeft) + Math.min(0, parseInt(h.textIndent)) : 0),
    f = l.right - (h ? parseInt(h.paddingRight) : 0),
    d = Ol(n, i, 1),
    O = Ol(n, r, -1),
    p = d.type == He.Text ? d : null,
    g = O.type == He.Text ? O : null
  if (
    (p && (n.lineWrapping || d.widgetLineBreaks) && (p = Mu(n, i, 1, p)),
    g && (n.lineWrapping || O.widgetLineBreaks) && (g = Mu(n, r, -1, g)),
    p && g && p.from == g.from && p.to == g.to)
  )
    return x(k(t.from, t.to, p))
  {
    let S = p ? k(t.from, null, p) : Q(d, !1),
      C = g ? k(null, t.to, g) : Q(O, !0),
      E = []
    return (
      (p || d).to < (g || O).from - (p && g ? 1 : 0) ||
      (d.widgetLineBreaks > 1 && S.bottom + n.defaultLineHeight / 2 < C.top)
        ? E.push(m(c, S.bottom, f, C.top))
        : S.bottom < C.top &&
          n.elementAtHeight((S.bottom + C.top) / 2).type == He.Text &&
          (S.bottom = C.top = (S.bottom + C.top) / 2),
      x(S).concat(E).concat(x(C))
    )
  }
  function m(S, C, E, B) {
    return new lr(e, S - a.left, C - a.top, E - S, B - C)
  }
  function x({ top: S, bottom: C, horizontal: E }) {
    let B = []
    for (let v = 0; v < E.length; v += 2) B.push(m(E[v], S, E[v + 1], C))
    return B
  }
  function k(S, C, E) {
    let B = 1e9,
      ...
      D = []
    function $(Z, j, V, I, N) {
      let F = n.coordsAtPos(Z, Z == E.to ? -2 : 2),
        ne = n.coordsAtPos(V, V == E.from ? 2 : -2)
      !F ||
        !ne ||
        ((B = Math.min(F.top, ne.top, B)),
        (v = Math.max(F.bottom, ne.bottom, v)),
        N == De.LTR
          ? D.push(s && j ? c : F.left, s && I ? f : ne.right)
          : D.push(!s && I ? c : ne.left, !s && j ? f : F.right))
    }
    let A = S ?? E.from,
      w = C ?? E.to
    for (let Z of n.visibleRanges)
      if (Z.to > A && Z.from < w)
        for (let j = Math.max(Z.from, A), V = Math.min(Z.to, w); ; ) {
          let I = n.state.doc.lineAt(j)
          for (let N of n.bidiSpans(I)) {
            let F = N.from + I.from,
              ne = N.to + I.from
            if (F >= V) break
            ne > j &&
          ...
          if (((j = I.to + 1), j >= V)) break
        }
    return (
      D.length == 0 && $(A, S == null, w, C == null, n.textDirection),
...
class Ng {
  ...
  update(e) {
    e.startState.facet(zr) != e.state.facet(zr) && this.setOrder(e.state),
...
const zr = z.define()
function Ef(n) {
  return [we.define((e) => new Ng(e, n)), zr.of(n)]
}
const Nn = z.define({
  combine(n) {
    return Wt(
...
function Tf(n = {}) {
  return [Nn.of(n), Wg, Gg, Ug, of.of(!0)]
}
function Rf(n) {
  return n.startState.facet(Nn) != n.state.facet(Nn)
}
const Wg = Ef({
  above: !0,
  markers(n) {
    ...
    for (let r of e.selection.ranges) {
      ...
      if (r.empty || t.drawRangeCursor) {
        let o = s
          ...
          l = r.empty ? r : T.cursor(r.head, r.head > r.anchor ? -1 : 1)
        for (let a of lr.forRange(n, o, l)) i.push(a)
      }
    }
    return i
  },
  update(n, e) {
    ...
    let t = Rf(n)
    return t && Zu(n.state, e), n.docChanged || n.selectionSet || t
  },
  mount(n, e) {
    Zu(e.state, n)
  },
...
function Zu(n, e) {
  e.style.animationDuration = n.facet(Nn).cursorBlinkRate + 'ms'
}
const Gg = Ef({
    above: !1,
    markers(n) {
      return n.state.selection.ranges
        .map((e) =>
          e.empty ? [] : lr.forRange(n, 'cm-selectionBackground', e),
        )
        .reduce((e, t) => e.concat(t))
    },
    update(n, e) {
      return n.docChanged || n.selectionSet || n.viewportChanged || Rf(n)
    },
  ...
  $n = Ve.define({
    ...
    update(n, e) {
      return (
        ...
        e.effects.reduce((t, i) => (i.is(Mf) ? i.value : t), n)
      )
    },
  }),
  Hg = we.fromClass(
    class {
      ...
      setDropPos(n) {
        this.view.state.field($n) != n &&
          this.view.dispatch({ effects: Mf.of(n) })
      }
    },
    {
      eventObservers: {
...
class e0 {
  constructor(e) {
    ...
    if (((this.regexp = t), r))
      this.addMatch = (l, a, u, h) => r(h, u, u + l[0].length, l, a)
  ...
  createDeco(e) {
    let t = new si(),
      i = t.add.bind(t)
    for (let { from: r, to: s } of Jg(e, this.maxLength))
      Bu(e.state.doc, this.regexp, r, s, (o, l) => this.addMatch(l, e, o, i))
    return t.finish()
  }
  updateDeco(e, t) {
    let i = 1e9,
    ...
    for (let s of e.visibleRanges) {
      ...
      if (l >= o) {
        ...
        if (a == u)
          ...
          Bu(e.state.doc, this.regexp, h, c, (p, g) =>
            this.addMatch(g, e, p, O),
          )
        t = t.update({
          filterFrom: h,
          filterTo: c,
...
function n0() {
  var n
  if (ho == null && typeof document < 'u' && document.body) {
    let e = document.body.style
    ho = ((n = e.tabSize) !== null && n !== void 0 ? n : e.MozTabSize) != null
  }
  return ho || !1
}
const Yr = z.define({
  combine(n) {
    let e = Wt(n, { render: null, specialChars: t0, addSpecialChars: null })
    return (
      (e.replaceTabs = !n0()) &&
        (e.specialChars = new RegExp('	|' + e.specialChars.source, Sl)),
      e.addSpecialChars &&
      ...
      class {
        constructor(n) {
          ;(this.view = n),
            ...
            (this.decorator = this.makeDecorator(n.state.facet(Yr))),
          ...
          return new e0({
            ...
            decoration: (e, t, i) => {
              ...
              return (
                ...
                (this.decorationCache[s] = U.replace({ widget: new l0(n, s) }))
              )
            },
  ...
  toDOM(e) {
    let t = o0(this.code),
      i =
        ...
        ' ' +
        (i0[this.code] || '0x' + this.code.toString(16)),
...
const u0 = U.line({ class: 'cm-activeLine' }),
  h0 = we.fromClass(
    class {
      constructor(n) {
      ...
      getDeco(n) {
        ...
        for (let i of n.state.selection.ranges) {
          ...
          r.from > e && (t.push(u0.range(r.from)), (e = r.from))
        }
        return U.set(t)
      }
    },
...
function f0(n) {
  let e = we.fromClass(
    class {
      constructor(t) {
        ;(this.view = t),
          (this.placeholder = n
            ? U.set([U.widget({ widget: new c0(n), side: 1 }).range(0)])
            : U.none)
      }
      get decorations() {
  ...
  return typeof n == 'string'
    ? [e, _.contentAttributes.of({ 'aria-placeholder': n })]
    : e
}
const Dl = 2e3
function d0(n, e, t) {
  let i = Math.min(e.line, t.line),
    ...
    s = []
  if (e.off > Dl || t.off > Dl || e.col < 0 || t.col < 0) {
    ...
    for (let a = i; a <= r; a++) {
      let u = n.doc.line(a),
        h = el(u.text, o, n.tabSize, !0)
      if (h < 0) s.push(T.cursor(u.to))
      else {
        let c = el(u.text, l, n.tabSize)
        s.push(T.range(u.from + h, u.from + c))
      }
    }
  }
  return s
  ...
  let t = n.posAtCoords({ x: e.clientX, y: e.clientY }, !1),
    ...
    s =
      r > Dl
        ...
        : r == i.length
          ? p0(n, e.clientX)
          : pn(i.text, n.state.tabSize, t - i.from)
  ...
  return t
    ? {
        ...
        get(r, s, o) {
          let l = Xu(n, r)
          if (!l) return i
          let a = d0(n.state, t, l)
          return a.length ? (o ? T.create(a.concat(i.ranges)) : T.create(a)) : i
        },
      }
    : null
}
function m0(n) {
  ...
  return _.mouseSelectionStyle.of((t, i) => (e(i) ? O0(t, i) : null))
}
const g0 = {
    Alt: [18, (n) => !!n.altKey],
  ...
  y0 = { style: 'cursor: crosshair' }
function x0(n = {}) {
  let [e, t] = g0[n.key || 'Alt'],
    i = we.fromClass(
      class {
        constructor(r) {
    ...
    class {
      ...
      readMeasure() {
        ...
        if (this.position == 'fixed' && this.manager.tooltipViews.length) {
          ...
          if (Y.gecko) t = s.offsetParent != this.container.ownerDocument.body
          else if (s.style.top == Dn && s.style.left == '0px') {
      ...
      writeMeasure(n) {
        ...
        for (let l = 0; l < this.manager.tooltips.length; l++) {
          ...
          let d = a.arrow ? u.dom.querySelector('.cm-tooltip-arrow') : null,
            O = d ? 7 : 0,
            p = f.right - f.left,
            g = (e = _u.get(u)) !== null && e !== void 0 ? e : f.bottom - f.top,
            m = u.offset || D0,
            x = this.view.textDirection == De.LTR,
            k =
              f.width > i.right - i.left
                ...
                : x
                  ? Math.max(
                      i.left,
                      Math.min(c.left - (d ? 14 : 0) + m.x, i.right - p),
                    )
                  : Math.min(
                      Math.max(i.left, c.left - p + (d ? 14 : 0) - m.x),
                      i.right - p,
                    ),
            Q = this.above[l]
          !a.strictSide &&
            (Q
              ? c.top - g - O - m.y < i.top
              : c.bottom + g + O + m.y > i.bottom) &&
            Q == i.bottom - c.bottom > c.top - i.top &&
            (Q = this.above[l] = !Q)
          let S = (Q ? c.top - i.top : i.bottom - c.bottom) - O
          if (S < g && u.resize !== !1) {
            if (S < this.view.defaultLineHeight) {
              h.style.top = Dn
              continue
            }
            _u.set(u, g), (h.style.height = (g = S) / s + 'px')
          } else h.style.height && (h.style.height = '')
          let C = Q ? c.top - g - O - m.y : c.bottom + O + m.y,
            E = k + p
          if (u.overlap !== !0)
            for (let B of o)
              B.left < E &&
                ...
                B.top < C + g &&
                B.bottom > C &&
                (C = Q ? B.top - g - 2 - O : B.bottom + O + 2)
          if (
            (this.position == 'absolute'
              ? ((h.style.top = (C - n.parent.top) / s + 'px'),
                ju(h, (k - n.parent.left) / r))
              : ((h.style.top = C / s + 'px'), ju(h, k / r)),
            d)
          ) {
            let B = c.left + (x ? m.x : -m.x) - (k + 14 - 7)
            d.style.left = B / r + 'px'
          }
          u.overlap !== !0 &&
            o.push({ left: k, top: C, right: E, bottom: C + g }),
            h.classList.toggle('cm-tooltip-above', Q),
            h.classList.toggle('cm-tooltip-below', !Q),
...
const S0 = _.baseTheme({
  ...
  D0 = { x: 0, y: 0 },
  oa = z.define({ enables: [sa, S0] }),
  ss = z.define({ combine: (n) => n.reduce((e, t) => e.concat(t), []) })
class Ts {
  static create(e) {
    return new Ts(e)
  }
...
class Q0 {
  ...
  startHover() {
    ...
    let r,
      s = 1
    if (i instanceof gi) r = i.posAtStart
    else {
      ...
      let a = e
          ...
          .find((h) => h.from <= r && h.to >= r),
        u = a && a.dir == De.RTL ? -1 : 1
      s = t.x < l.left ? -u : u
    }
  ...
  get tooltip() {
    let e = this.view.plugin(sa),
      t = e ? e.manager.tooltips.findIndex((i) => i.create == Ts.create) : -1
  ...
  mousemove(e) {
    ...
    if ((r.length && s && !k0(s.dom, e)) || this.pending) {
      ...
      ;(o == l
        ...
        : !w0(this.view, o, l, e.clientX, e.clientY)) &&
...
function C0(n, e = {}) {
    ...
    i = Ve.define({
      ...
      update(r, s) {
        if (
          ...
          let o = []
          for (let l of r) {
            let a = s.changes.mapPos(l.pos, -1, Ge.TrackDel)
            if (a != null) {
        ...
        for (let o of s.effects) o.is(t) && (r = o.value), o.is(P0) && (r = [])
        return r
      },
      provide: (r) => ss.from(r),
    })
  return {
    ...
    extension: [
      i,
      we.define((r) => new Q0(r, n, i, t, e.hoverTime || 300)),
      v0,
    ],
  }
}
...
const _f = we.fromClass(
  class {
    constructor(n) {
      ;(this.input = n.state.facet(Gn)),
        (this.specs = this.input.filter((t) => t)),
        (this.panels = this.specs.map((t) => t(n)))
      let e = n.state.facet(Lu)
      ;(this.top = new kr(n, !0, e.topContainer)),
        (this.bottom = new kr(n, !1, e.bottomContainer)),
    ...
    update(n) {
      ...
      this.top.container != e.topContainer &&
        (this.top.sync([]), (this.top = new kr(n.view, !0, e.topContainer))),
        this.bottom.container != e.bottomContainer &&
          (this.bottom.sync([]),
          (this.bottom = new kr(n.view, !1, e.bottomContainer))),
        this.top.syncClasses(),
        this.bottom.syncClasses()
      let t = n.state.facet(Gn)
      if (t != this.input) {
        let i = t.filter((a) => a),
          r = [],
          s = [],
        ...
        for (let a of i) {
          ...
          u < 0
            ? ((h = a(n.view)), l.push(h))
            : ((h = this.panels[u]), h.update && h.update(n)),
            r.push(h),
            (h.top ? s : o).push(h)
        }
        ;(this.specs = i),
...
li.prototype.mapMode = Ge.TrackBefore
...
const Vu = z.define({ combine: (n) => n.some((e) => e) })
function jf(n) {
  return [T0]
}
const T0 = we.fromClass(
  class {
    constructor(n) {
      ;(this.view = n),
        ...
        (this.gutters = n.state.facet(Fn).map((e) => new Yu(n, e)))
      for (let e of this.gutters) this.dom.appendChild(e.dom)
      ;(this.fixed = !n.state.facet(Vu)),
    ...
    update(n) {
      ...
      n.geometryChanged &&
        (this.dom.style.minHeight =
          this.view.contentHeight / this.view.scaleY + 'px'),
        this.view.state.facet(Vu) != !this.fixed &&
    ...
    syncGutters(n) {
      ...
      n && this.dom.remove()
      let t = de.iter(this.view.state.facet(Ir), this.view.viewport.from),
        i = [],
        r = this.gutters.map(
          (s) => new R0(s, this.view.viewport, -this.view.documentPadding.top),
        )
...
class R0 {
  constructor(e, t, i) {
    ;(this.gutter = e),
      (this.height = i),
      (this.i = 0),
      (this.cursor = de.iter(e.markers, t.from))
  }
  addElement(e, t, i) {
    let { gutter: r } = this,
  ...
  line(e, t, i) {
    let r = []
    vl(this.cursor, r, t.from), i.length && (r = r.concat(i))
...
class Yu {
  constructor(e, t) {
    ...
    ;(this.markers = zu(t.markers(e))),
      t.initialSpacer &&
        ((this.spacer = new Lf(e, 0, 0, [t.initialSpacer(e)])),
  ...
  update(e) {
    let t = this.markers
    if (
      ((this.markers = zu(this.config.markers(e.view))),
    ...
    return (
      !de.eq(this.markers, t, i.from, i.to) ||
...
class Lf {
  ...
  update(e, t, i, r) {
    this.height != t && ((this.height = t), (this.dom.style.height = t + 'px')),
      ...
      M0(this.markers, r) || this.setMarkers(e, r)
  }
  setMarkers(e, t) {
...
const F0 = Fn.compute([Ui], (n) => ({
  class: 'cm-lineNumbers',
  renderEmptyElements: !1,
  markers(e) {
    return e.state.facet(Z0)
  },
  lineMarker(e, t, i) {
    return i.some((r) => r.toDOM)
      ? null
      : new fo(po(e, e.state.doc.lineAt(t.from).number))
  },
  widgetMarker: (e, t, i) => {
    for (let r of e.state.facet(B0)) {
      let s = r(e, t, i)
      if (s) return s
    }
    return null
  ...
  initialSpacer(e) {
    return new fo(po(e, Iu(e.state.doc.lines)))
  },
  updateSpacer(e, t) {
    let i = po(t.view, Iu(t.view.state.doc.lines))
    return i == e.number ? e : new fo(i)
  },
  domEventHandlers: n.facet(Ui).domEventHandlers,
}))
function qf(n = {}) {
  return [Ui.of(n), jf(), F0]
}
function Iu(n) {
  let e = 9
  for (; e < n; ) e = e * 10 + 9
...
const X0 = new (class extends li {
    constructor() {
      super(...arguments), (this.elementClass = 'cm-activeLineGutter')
    }
  })(),
  _0 = Ir.compute(['selection'], (n) => {
    let e = [],
      t = -1
    for (let i of n.selection.ranges) {
      let r = n.doc.lineAt(i.head).from
      r > t && ((t = r), e.push(X0.range(r)))
    }
    return de.of(e)
  })
function Vf() {
...
class le {
  ...
  add(e) {
    ...
    return (
      typeof e != 'function' && (e = st.match(e)),
      (t) => {
        let i = e(t)
...
le.closedBy = new le({ deserialize: (n) => n.split(' ') })
le.openedBy = new le({ deserialize: (n) => n.split(' ') })
le.group = new le({ deserialize: (n) => n.split(' ') })
le.isolate = new le({
  deserialize: (n) => {
...
const L0 = Object.create(null)
class st {
  constructor(e, t, i, r = 0) {
    ;(this.name = e), (this.props = t), (this.id = i), (this.flags = r)
  }
  static define(e) {
    let t = e.props && e.props.length ? Object.create(null) : L0,
      i =
        (e.top ? 1 : 0) |
        (e.skipped ? 2 : 0) |
        (e.error ? 4 : 0) |
        (e.name == null ? 8 : 0),
      r = new st(e.name || '', t, e.id, i)
    if (e.props) {
...
st.none = new st('', Object.create(null), 0, 8)
class la {
  constructor(e) {
    this.types = e
  ...
  extend(...e) {
    ...
    for (let i of this.types) {
      ...
      t.push(r ? new st(i.name, r, i.id, i.flags) : i)
    }
    return new la(t)
  }
}
...
class $e {
  ...
  cursorAt(e, t = 0, i = 0) {
    let r = wr.get(this) || this.topNode,
      s = new kl(r)
    return s.moveTo(e, t), wr.set(this, s._tree), s
  }
  get topNode() {
    return new bt(this, 0, 0, null)
  }
  resolve(e, t = 0) {
    let i = Un(wr.get(this) || this.topNode, e, t, !1)
    return wr.set(this, i), i
  }
  resolveInner(e, t = 0) {
    let i = Un(Nu.get(this) || this.topNode, e, t, !0)
    return Nu.set(this, i), i
  }
  resolveStack(e, t = 0) {
    return z0(this, e, t)
  }
  iterate(e) {
    let { enter: t, leave: i, from: r = 0, to: s = this.length } = e,
      o = e.mode || 0,
      l = (o & Fe.IncludeAnonymous) > 0
    for (let a = this.cursor(o | Fe.IncludeAnonymous); ; ) {
      let u = !1
      if (
        a.from <= s &&
        a.to >= r &&
  ...
  balance(e = {}) {
    return this.children.length <= 8
      ...
      : ha(
          ...
          0,
          this.length,
          (t, i, r) => new $e(this.type, t, i, r, this.propValues),
          e.makeTree || ((t, i, r) => new $e(st.none, t, i, r)),
        )
  }
  static build(e) {
    return Y0(e)
...
class aa {
  ...
  fork() {
    return new aa(this.buffer, this.index)
  }
}
class Qi {
  constructor(e, t, i) {
  ...
  findChild(e, t, i, r, s) {
    ...
    for (
      let a = e;
      a != t && !(Yf(s, r, o[a + 1], o[a + 2]) && ((l = a), i > 0));
      a = o[a + 3]
    );
    return l
  }
...
class bt extends If {
  ...
  nextChild(e, t, i, r, s = 0) {
    for (let o = this; ; ) {
      for (
        ...
        let h = l[e],
          c = a[e] + o.from
        if (Yf(r, i, c, c + h.length)) {
          if (h instanceof Qi) {
            if (s & Fe.ExcludeBuffers) continue
            let f = h.findChild(0, h.buffer.length, t, i - c, r)
            if (f > -1) return new xi(new q0(o, h, e, c), null, f)
          } else if (s & Fe.IncludeAnonymous || !h.type.isAnonymous || ua(h)) {
            let f
            if (!(s & Fe.IgnoreMounts) && (f = os.get(h)) && !f.overlay)
              return new bt(f.tree, c, e, o)
            let d = new bt(h, c, e, o)
            return s & Fe.IncludeAnonymous || !d.type.isAnonymous
              ? d
  ...
  enter(e, t, i = 0) {
    let r
    if (!(i & Fe.IgnoreOverlays) && (r = os.get(this._tree)) && r.overlay) {
      let s = e - this.from
      for (let { from: o, to: l } of r.overlay)
        if ((t > 0 ? o <= s : o < s) && (t < 0 ? l >= s : l > s))
          return new bt(r.tree, r.overlay[0].from + this.from, -1, this)
    }
...
class xi extends If {
  ...
  child(e, t, i) {
    ...
    return s < 0 ? null : new xi(this.context, this, s)
  }
  get firstChild() {
  ...
  enter(e, t, i = 0) {
    if (i & Fe.ExcludeBuffers) return null
    let { buffer: r } = this.context,
      s = r.findChild(
        this.index + 4,
        r.buffer[this.index + 3],
  ...
  get nextSibling() {
    ...
    return t <
      ...
      ? new xi(this.context, this._parent, t)
  ...
  get prevSibling() {
    ...
    return this.index == t
      ? this.externalSibling(-1)
      : new xi(this.context, this._parent, e.findChild(t, this.index, -1, 0, 4))
  }
  get tree() {
    return null
  }
...
function Nf(n) {
  ...
  let i = t instanceof bt && t.index < 0 ? null : t.parent,
    r = n.slice()
  return i ? (r[e] = i) : r.splice(e, 1), new V0(r, t)
}
class V0 {
  constructor(e, t) {
...
function z0(n, e, t) {
  let i = n.resolveInner(e, t),
    r = null
  for (let s = i instanceof bt ? i : i.context.parent; s; s = s.parent)
    if (s.index < 0) {
      let o = s.parent
      ...
      if (
        ...
        let l = new bt(o.tree, o.overlay[0].from + s.from, -1, s)
...
class kl {
  ...
  get node() {
    ...
    for (let r = i; r < this.stack.length; r++)
      t = new xi(this.buffer, t, this.stack[r])
  ...
  matchContext(e) {
    if (!this.buffer) return Ql(this.node.parent, e)
    let { buffer: t } = this.buffer,
      { types: i } = t.set
    for (let r = e.length - 1, s = this.stack.length - 1; r >= 0; s--) {
      if (s < 0) return Ql(this._tree, e, r)
...
function ua(n) {
  return n.children.some((e) => e instanceof Qi || !e.type.isAnonymous || ua(e))
}
function Y0(n) {
  var e
  let {
      buffer: t,
      nodeSet: i,
      maxBufferLength: r = zf,
      reused: s = [],
      minRepeatType: o = i.types.length,
    } = n,
    l = Array.isArray(t) ? new aa(t, t.length) : t,
    a = i.types,
    u = 0,
    h = 0
  function c(S, C, E, B, v, D) {
    let { id: $, start: A, end: w, size: Z } = l,
      j = h,
      V = u
    for (; Z < 0; )
      if ((l.next(), Z == -1)) {
        let ce = s[$]
        E.push(ce), B.push(A - S)
        return
      } else if (Z == -3) {
        u = $
        return
    ...
    let I = a[$],
      ...
      F,
      ne = A - S
    if (w - A <= r && (F = g(l.pos - C, v))) {
      let ce = new Uint16Array(F.size - F.skip),
        P = l.pos - F.size,
        q = ce.length
      for (; l.pos > P; ) q = m(F.start, ce, q)
      ;(N = new Qi(ce, w - F.start, i)), (ne = F.start - S)
    } else {
      let ce = l.pos - Z
      l.next()
      let P = [],
      ...
      for (; l.pos > ce; )
        W >= 0 && l.id == W && l.size >= 0
          ? (l.end <= H - r &&
              (O(P, q, A, K, l.end, H, W, j, V), (K = P.length), (H = l.end)),
            l.next())
          : D > 2500
            ? f(A, ce, P, q)
            : c(A, ce, P, q, W, D + 1)
      if (
        (W >= 0 && K > 0 && K < P.length && O(P, q, A, K, A, H, W, j, V),
        P.reverse(),
        q.reverse(),
        W > -1 && K > 0)
      ) {
        let se = d(I, V)
        N = ha(I, P, q, 0, P.length, 0, w - A, se, se)
      } else N = p(I, P, q, w - A, j - w, V)
    }
    E.push(N), B.push(ne)
  }
  function f(S, C, E, B) {
    let v = [],
      ...
      $ = -1
    for (; l.pos > C; ) {
      let { id: A, start: w, end: Z, size: j } = l
      if (j > 4) l.next()
      else {
        if ($ > -1 && w < $) break
        $ < 0 && ($ = Z - r), v.push(A, w, Z), D++, l.next()
      }
    }
    if (D) {
      let A = new Uint16Array(D * 4),
        w = v[v.length - 2]
      for (let Z = v.length - 3, j = 0; Z >= 0; Z -= 3)
        (A[j++] = v[Z]),
          (A[j++] = v[Z + 1] - w),
          (A[j++] = v[Z + 2] - w),
          (A[j++] = j)
      E.push(new Qi(A, v[2] - w, i)), B.push(w - S)
    }
  }
  function d(S, C) {
    return (E, B, v) => {
      let D = 0,
        ...
        A,
        w
      if ($ >= 0 && (A = E[$]) instanceof $e) {
        if (!$ && A.type == S && A.length == v) return A
        ;(w = A.prop(le.lookAhead)) && (D = B[$] + A.length + w)
      }
      return p(S, E, B, v, D, C)
    }
  }
  function O(S, C, E, B, v, D, $, A, w) {
    let Z = [],
      j = []
    for (; S.length > B; ) Z.push(S.pop()), j.push(C.pop() + E - v)
    S.push(p(i.types[$], Z, j, D - v, A - D, w)), C.push(v - E)
  }
  function p(S, C, E, B, v, D, $) {
    if (D) {
      let A = [le.contextHash, D]
      $ = $ ? [A].concat($) : [A]
    }
    if (v > 25) {
      let A = [le.lookAhead, v]
      $ = $ ? [A].concat($) : [A]
    }
    return new $e(S, C, E, B, $)
  }
  function g(S, C) {
    let E = l.fork(),
      B = 0,
    ...
    e: for (let w = E.pos - S; E.pos > w; ) {
      let Z = E.size
      if (E.id == C && Z >= 0) {
        ;(A.size = B), (A.start = v), (A.skip = D), (D += 4), (B += 4), E.next()
        continue
      }
      let j = E.pos - Z
      if (Z < 0 || j < w || E.start < $) break
      let V = E.id >= o ? 4 : 0,
        I = E.start
      for (E.next(); E.pos > j; ) {
        if (E.size < 0)
    ...
    return (
      (C < 0 || B == S) && ((A.size = B), (A.start = v), (A.skip = D)),
      A.size > 4 ? A : void 0
    )
  }
  function m(S, C, E) {
    let { id: B, start: v, end: D, size: $ } = l
    if ((l.next(), $ >= 0 && B < o)) {
      let A = E
      if ($ > 4) {
        let w = l.pos - ($ - 4)
        for (; l.pos > w; ) E = m(S, C, E)
      }
      ;(C[--E] = A), (C[--E] = D - S), (C[--E] = v - S), (C[--E] = B)
    } else $ == -3 ? (u = B) : $ == -4 && (h = B)
    return E
  }
  let x = [],
    k = []
  for (; l.pos > 0; ) c(n.start || 0, n.bufferStart || 0, x, k, -1, 0)
  let Q =
    (e = n.length) !== null && e !== void 0
      ...
      : x.length
        ? k[0] + x[0].length
        : 0
  return new $e(a[n.topID], x.reverse(), k.reverse(), Q)
}
const Gu = new WeakMap()
function Nr(n, e) {
  if (!n.isAnonymous || e instanceof Qi || e.type != n) return 1
  let t = Gu.get(e)
  if (t == null) {
    t = 1
...
function ha(n, e, t, i, r, s, o, l, a) {
  let u = 0
  for (let O = i; O < r; O++) u += Nr(n, e[O])
  let h = Math.ceil((u * 1.5) / 8),
    c = [],
    f = []
  function d(O, p, g, m, x) {
    for (let k = g; k < m; ) {
      let Q = k,
        S = p[k],
        C = Nr(n, O[k])
      ...
      if (k == Q + 1) {
        if (C > h) {
          let E = O[Q]
          d(E.children, E.positions, 0, E.children.length, p[Q] + x)
          continue
        }
        c.push(O[Q])
      } else {
        let E = p[k - 1] + O[k - 1].length - S
        c.push(ha(n, O, p, Q, k, S, E, null, a))
      }
      f.push(S + x - s)
    }
  }
...
class Fi {
  ...
  static addTree(e, t = [], i = !1) {
    let r = [new Fi(0, e.length, e, 0, !1, i)]
        ...
        for (; o && o.from < c; ) {
          ...
          if (a >= f.from || c <= f.to || u) {
            let d = Math.max(f.from, a) - u,
              O = Math.min(f.to, c) - u
            f = d >= O ? null : new Fi(d, O, f.tree, f.offset + u, l > 0, !!h)
          }
...
class Wf {
  startParse(e, t, i) {
    return (
      typeof e == 'string' && (e = new I0(e)),
      (i = i
        ? i.length
          ? i.map((r) => new Oo(r.from, r.to))
          : [new Oo(0, 0)]
        : [new Oo(0, e.length)]),
...
class ls {
  constructor(e) {
    ;(this.name = e), (this.instances = []), (this.id = W0++)
  }
  static get(e, t) {
    if (!t.length) return e
    let i = t[0].instances.find((l) => l.base == e && G0(t, l.modified))
    if (i) return i
    let r = [],
      s = new mt(e.name, r, e, t)
    for (let l of t) l.instances.push(s)
    let o = U0(t)
    for (let l of e.set)
      if (!l.modified.length) for (let a of o) r.push(ls.get(l, a))
    return s
  }
}
function G0(n, e) {
  ...
  for (let t in n) {
    ...
    for (let r of t.split(' '))
      if (r) {
        ...
        let h = new as(i, o, a > 0 ? s.slice(0, a) : null)
        e[u] = h.sort(e[u])
      }
  }
  return Uf.add(e)
...
function K0(n, e, t, i = 0, r = n.length) {
  let s = new J0(i, Array.isArray(e) ? e : [e], t)
...
class J0 {
  ...
  highlightRange(e, t, i, r, s) {
    ...
    if (
      (c &&
        (u && (u += ' '), (u += c), h.mode == 1 && (r += (r ? ' ' : '') + c)),
      this.startSpan(Math.max(t, l), u),
      h.opaque)
    )
      return
    let f = e.tree && e.tree.prop(le.mounted)
    if (f && f.overlay) {
      let d = e.node.enter(f.overlay[0].from + l, 1),
        O = this.highlighters.filter((g) => !g.scope || g.scope(f.tree.type)),
        p = e.firstChild()
      for (let g = 0, m = l; ; g++) {
        let x = g < f.overlay.length ? f.overlay[g] : null,
          k = x ? x.from + l : a,
          Q = Math.max(t, m),
          S = Math.min(i, k)
        if (Q < S && p)
          for (
            ;
            e.from < S &&
            (this.highlightRange(e, Q, S, r, s),
            this.startSpan(Math.min(S, e.to), u),
            !(e.to >= k || !e.nextSibling()));
...
const X = mt.define,
  ...
  y = {
    ...
    unit: X(Bt),
    modifier: X(Bt),
    operatorKeyword: X(Bt),
    controlKeyword: X(Bt),
    definitionKeyword: X(Bt),
    moduleKeyword: X(Bt),
    operator: Ft,
    derefOperator: X(Ft),
    arithmeticOperator: X(Ft),
    logicOperator: X(Ft),
    bitwiseOperator: X(Ft),
    compareOperator: X(Ft),
    updateOperator: X(Ft),
    definitionOperator: X(Ft),
    typeOperator: X(Ft),
    controlOperator: X(Ft),
    punctuation: wl,
    separator: X(wl),
    bracket: vn,
    angleBracket: X(vn),
...
const Hi = new le()
function t1(n) {
  return z.define({ combine: n ? (e) => e.concat(n) : void 0 })
}
const i1 = new le()
class At {
  constructor(e, t, i = [], r = '') {
    ;(this.data = e),
      (this.name = r),
      he.prototype.hasOwnProperty('tree') ||
        Object.defineProperty(he.prototype, 'tree', {
          get() {
            return Ie(this)
          },
        }),
  ...
  isActiveAt(e, t, i = -1) {
    return Ku(e, t, i).type.prop(Hi) == this.data
  }
  findRegions(e) {
    let t = e.facet(ki)
    ...
    let i = [],
      r = (s, o) => {
        ...
        for (let a = 0; a < s.children.length; a++) {
          let u = s.children[a]
          u instanceof $e && r(u, s.positions[a] + o)
        }
      }
    return r(Ie(e), 0), i
  }
...
At.setState = ie.define()
function Ku(n, e, t) {
  let i = n.facet(ki),
    r = Ie(n).topNode
  if (!i || i.allowsNesting)
    for (let s = r; s; s = s.enter(e, t, Fe.ExcludeBuffers))
      s.type.isTop && (r = s)
  return r
}
class us extends At {
...
class hs {
  ...
  static create(e, t, i) {
    return new hs(e, t, [], $e.empty, 0, i, [], null)
  }
  startParse() {
    return this.parser.startParse(new n1(this.state.doc), this.fragments)
  }
  work(e, t) {
    return (
      t != null && t >= this.state.doc.length && (t = void 0),
      this.tree != $e.empty && this.isDone(t ?? this.state.doc.length)
        ? (this.takeTree(), !0)
        : this.withContext(() => {
            var i
            if (typeof e == 'number') {
              ...
              if (r)
                if (
                  ((this.fragments = this.withoutTempSkipped(
                    Fi.addTree(r, this.fragments, this.parse.stoppedAt != null),
                  )),
                  (this.treeLen =
  ...
  takeTree() {
    ...
    this.parse &&
      ...
      (this.tree = t),
      (this.fragments = this.withoutTempSkipped(
        Fi.addTree(this.tree, this.fragments, !0),
      )),
      (this.parse = null))
  }
  withContext(e) {
  ...
  changes(e, t) {
    ...
    if ((this.takeTree(), !e.empty)) {
      let a = []
      if (
        (e.iterChangedRanges((u, h, c, f) =>
          a.push({ fromA: u, toA: h, fromB: c, toB: f }),
        ),
        (i = Fi.applyChanges(i, a)),
        (r = $e.empty),
        (s = 0),
    ...
    return new hs(this.parser, t, i, r, s, o, l, this.scheduleOn)
  }
  updateViewport(e) {
    ...
    for (let i = 0; i < this.skipped.length; i++) {
      ...
      r < e.to &&
        s > e.from &&
        ((this.fragments = Ju(this.fragments, r, s)),
      ...
      createParse(t, i, r) {
        ...
        return {
          ...
          advance() {
            ...
            return (this.parsedPos = o), new $e(st.none, [], [], o - s)
          },
          stoppedAt: null,
          stopAt() {},
        }
...
function Ju(n, e, t) {
  return Fi.applyChanges(n, [{ fromA: e, toA: t, fromB: e, toB: t }])
}
class cn {
  constructor(e) {
  ...
  apply(e) {
    ...
    return t.work(20, i) || t.takeTree(), new cn(t)
  }
  static init(e) {
    let t = Math.min(3e3, e.doc.length),
      i = hs.create(e.facet(ki).parser, e, { from: 0, to: t })
    return i.work(20, t) || i.takeTree(), new cn(i)
  }
}
At.state = Ve.define({
  create: cn.init,
  update(n, e) {
    for (let t of e.effects) if (t.is(At.setState)) return t.value
    return e.startState.facet(ki) != e.state.facet(ki)
      ? cn.init(e.state)
      : n.apply(e)
  },
})
...
const yo =
    typeof navigator < 'u' &&
    !((go = navigator.scheduling) === null || go === void 0) &&
    go.isInputPending
      ...
      work(e) {
        ...
        let o =
            ...
            Math.min(
              this.chunkBudget,
              100,
              e && !yo ? Math.max(25, e.timeRemaining() - 5) : 1e9,
            ),
        ...
        ;(this.chunkBudget -= Date.now() - t),
          (a || this.chunkBudget <= 0) &&
            (s.context.takeTree(),
            this.view.dispatch({ effects: At.setState.of(new cn(s.context)) })),
...
function ca(n, e) {
  n instanceof he && (n = new Ms(n))
  for (let i of n.state.facet(s1)) {
    let r = i(n, e)
...
function a1(n) {
  ...
  let t = n.firstChild,
    i
  if (t && (i = t.type.prop(le.closedBy))) {
    let r = n.lastChild,
      s = r && i.indexOf(r.name) > -1
    return (o) => td(o, !0, 1, void 0, s && !l1(o) ? r.from : void 0)
  }
  return n.parent == null ? u1 : null
}
function u1() {
  return 0
}
...
function f1({ closing: n, align: e = !0, units: t = 1 }) {
  return (i) => td(i, e, t, n)
}
...
const d1 = (n) => n.baseIndent
function xo({ except: n, units: e = 1 } = {}) {
  return (t) => {
...
const p1 = 200
function id() {
  return he.transactionFilter.of((n) => {
    if (
      !n.docChanged ||
...
function g1(n, e, t) {
  ...
  for (let o = r; o; o = o.next) {
    ...
    if (a && (l.to < i.length - 50 || i.length == n.doc.length || !y1(l))) {
      let u = a(l, n)
...
const Vi = Ve.define({
  ...
  update(n, e) {
    ...
    for (let t of e.effects)
      if (t.is(Zs) && !x1(n, t.value.from, t.value.to)) {
        let { preparePlaceholder: i } = e.state.facet(ad),
          r = i ? U.replace({ widget: new w1(i(e.state, t.value)) }) : eh
...
function od(n, e) {
  return n.field(Vi, !1) ? e : e.concat(ie.appendConfig.of(ud()))
}
const b1 = (n) => {
    for (let e of sd(n)) {
      let t = fs(n.state, e.from, e.to)
      if (t)
        return n.dispatch({ effects: od(n.state, [Zs.of(t), ld(n, t)]) }), !0
    }
    return !1
  },
  S1 = (n) => {
    if (!n.state.field(Vi, !1)) return !1
    let e = []
    for (let t of sd(n)) {
      let i = ds(n.state, t.from, t.to)
      i && e.push(ar.of(i), ld(n, i, !1))
    }
...
const D1 = (n) => {
    ...
    for (let i = 0; i < e.doc.length; ) {
      let r = n.lineBlockAt(i),
        s = fs(e, r.from, r.to)
      s && t.push(Zs.of(s)), (i = (s ? n.lineBlockAt(s.to) : r).to + 1)
    }
    return t.length && n.dispatch({ effects: od(n.state, t) }), !!t.length
  },
  v1 = (n) => {
    let e = n.state.field(Vi, !1)
  ...
  Q1 = [
    { key: 'Ctrl-Shift-[', mac: 'Cmd-Alt-[', run: b1 },
    { key: 'Ctrl-Shift-]', mac: 'Cmd-Alt-]', run: S1 },
    { key: 'Ctrl-Alt-[', run: D1 },
    { key: 'Ctrl-Alt-]', run: v1 },
  ],
  k1 = { placeholderDOM: null, preparePlaceholder: null, placeholderText: '…' },
  ad = z.define({
    combine(n) {
      return Wt(n, k1)
    },
    ...
    r = we.fromClass(
      class {
        ...
        update(o) {
          ;(o.docChanged ||
            o.viewportChanged ||
            o.startState.facet(ki) != o.state.facet(ki) ||
            o.startState.field(Vi, !1) != o.state.field(Vi, !1) ||
            Ie(o.startState) != Ie(o.state) ||
            e.foldingChanged(o)) &&
        ...
        buildMarkers(o) {
          ...
          for (let a of o.viewportLineBlocks) {
            let u = ds(o.state, a.from, a.to)
              ? i
              : fs(o.state, a.from, a.to)
                ? t
                : null
    ...
    E0({
      ...
      domEventHandlers: {
        ...
        click: (o, l, a) => {
          ...
          let u = ds(o.state, l.from, l.to)
          if (u) return o.dispatch({ effects: ar.of(u) }), !0
          let h = fs(o.state, l.from, l.to)
          return h ? (o.dispatch({ effects: Zs.of(h) }), !0) : !1
        },
      },
    }),
    ud(),
...
function Bs(n, e) {
  ...
  return (
    n instanceof On &&
      (n.module && t.push(_.styleModule.of(n.module)), (i = n.themeType)),
    e != null && e.fallback
      ? t.push(cd.of(n))
      : i
        ? t.push(
            Cl.computeN([_.darkTheme], (r) =>
              r.facet(_.darkTheme) == (i == 'dark') ? [n] : [],
            ),
          )
        : t.push(Cl.of(n)),
    t
...
class $1 {
  constructor(e) {
    ;(this.markCache = Object.create(null)),
      (this.tree = Ie(e.state)),
      (this.decorations = this.buildDeco(e, So(e.state))),
...
const E1 = zi.high(we.fromClass($1, { decorations: (n) => n.decorations })),
  fd = On.define([
  ...
  R1 = U.mark({ class: 'cm-matchingBracket' }),
  M1 = U.mark({ class: 'cm-nonmatchingBracket' })
function Z1(n) {
  let e = [],
    t = n.matched ? R1 : M1
  return (
...
const B1 = Ve.define({
    ...
    update(n, e) {
      ...
      for (let r of e.state.selection.ranges) {
        if (!r.empty) continue
        let s =
          qt(e.state, r.head, -1, i) ||
          (r.head > 0 && qt(e.state, r.head - 1, 1, i)) ||
          (i.afterCursor &&
            (qt(e.state, r.head, 1, i) ||
              (r.head < e.state.doc.length && qt(e.state, r.head + 1, -1, i))))
...
const X1 = new le()
function Pl(n, e, t) {
  let i = n.prop(e < 0 ? le.openedBy : le.closedBy)
  if (i) return i
  if (n.name.length == 1) {
...
function Al(n) {
  let e = n.type.prop(X1)
  return e ? e(n.node) : n
}
function qt(n, e, t, i = {}) {
  let r = i.maxScanDistance || dd,
    s = i.brackets || pd,
    o = Ie(n),
  ...
  for (let a = l; a; a = a.parent) {
    ...
    if (u && a.from < a.to) {
      ...
      if (h && (t > 0 ? e >= h.from && e < h.to : e > h.from && e <= h.to))
        return _1(n, e, t, a, h, u, s)
    }
  }
  return j1(n, e, t, o, l.type, r, s)
}
function _1(n, e, t, i, r, s, o) {
  let l = i.parent,
  ...
  if (h && (t < 0 ? h.childBefore(i.from) : h.childAfter(i.to)))
    do
      if (t < 0 ? h.to <= i.from : h.from >= i.to) {
        ...
        } else if (Pl(h.type, t, o)) u++
        else if (Pl(h.type, -t, o)) {
          if (u == 0) {
            let c = Al(h)
            return {
              start: a,
...
function j1(n, e, t, i, r, s, o) {
  ...
  for (let f = 0; !h.next().done && f <= s; ) {
    ...
    let O = e + f * t
    for (
      let p = t > 0 ? 0 : d.length - 1, g = t > 0 ? d.length : -1;
      p != g;
      p += t
    ) {
      let m = o.indexOf(d[p])
...
for (let [n, e] of [
  ...
  q1[n] = V1(L1, e)
function Do(n, e) {
  ih.indexOf(n) > -1 || (ih.push(n), console.warn(e))
}
function V1(n, e) {
  let t = []
    ...
    for (let u of l.split('.')) {
      ...
      h
        ? typeof h == 'function'
          ? a.length
            ? (a = a.map(h))
            : Do(u, `Modifier ${u} used at start of tag`)
          : a.length
            ? Do(u, `Tag ${u} used as modifier`)
            : (a = Array.isArray(h) ? h : [h])
        : Do(u, `Unknown highlighting tag ${u}`)
    }
  ...
  let i = e.replace(/ /g, '_'),
    ...
    s = nh[r]
  if (s) return s.id
  let o = (nh[r] = st.define({
    id: th.length,
    name: i,
    props: [Gf({ [i]: t })],
  }))
  return th.push(o), o.id
}
De.RTL, De.LTR
const z1 = (n) => {
  let { state: e } = n,
    ...
    i = pa(n.state, t.from)
  return i.line ? Y1(n) : i.block ? N1(n) : !1
}
function da(n, e) {
...
const Y1 = da(U1, 0),
  I1 = da(gd, 0),
  N1 = da((n, e) => gd(n, e, G1(e)), 0)
function pa(n, e) {
  let t = n.languageDataAt('commentTokens', e, 1)
  return t.length ? t[0] : {}
}
const kn = 50
function W1(n, { open: e, close: t }, i, r) {
  let s = n.sliceDoc(i - kn, i),
    o = n.sliceDoc(r, r + kn),
    l = /\s*$/.exec(s)[0].length,
    a = /^\s*/.exec(o)[0].length,
    u = s.length - l
  ...
  r - i <= 2 * kn
    ? (h = c = n.sliceDoc(i, r))
    : ((h = n.sliceDoc(i, i + kn)), (c = n.sliceDoc(r - kn, r)))
  let f = /^\s*/.exec(h)[0].length,
    d = /\s*$/.exec(c)[0].length,
    O = c.length - d - t.length
  return h.slice(f, f + e.length) == e && c.slice(O, O + t.length) == t
    ? {
        open: {
          pos: i + f + e.length,
...
function gd(n, e, t = e.selection.ranges) {
  let i = t.map((s) => pa(e, s.from).block)
  if (!i.every((s) => s)) return null
  let r = t.map((s, o) => W1(e, i[o], s.from, s.to))
  if (n != 2 && !r.every((s) => s))
    return {
      changes: e.changes(
        t.map((s, o) =>
...
function U1(n, e, t = e.selection.ranges) {
  let i = [],
    r = -1
      ...
      for (let h = s; h <= o; ) {
        ...
        if (c.from > r && (s == o || o > c.from)) {
          ...
          let f = /^\s*/.exec(c.text)[0].length,
            d = f == c.length,
            O = c.text.slice(f, f + u.length) == u ? f : -1
...
const $l = Nt.define(),
  ...
  xd = Ve.define({
    ...
    update(n, e) {
      let t = e.state.facet(yd),
        i = e.annotation($l)
      if (i) {
        let a = rt.fromTransaction(e, i.selection),
          u = i.side,
          h = u == 0 ? n.undone : n.done
        return (
          a
            ? (h = ps(h, h.length, t.minDepth, a))
            : (h = vd(h, e.startState.selection)),
          new Vt(u == 0 ? i.rest : h, u == 0 ? h : i.rest)
        )
      }
      let r = e.annotation(H1)
      if (
        ((r == 'full' || r == 'before') && (n = n.isolate()),
        e.annotation(Ze.addToHistory) === !1)
      )
        return e.changes.empty ? n : n.addMapping(e.changes.desc)
      let s = rt.fromTransaction(e),
        o = e.annotation(Ze.time),
        l = e.annotation(Ze.userEvent)
      return (
        s
    ...
    fromJSON(n) {
      return new Vt(n.done.map(rt.fromJSON), n.undone.map(rt.fromJSON))
    },
  })
function bd(n = {}) {
  return [
...
class rt {
  ...
  static fromTransaction(e, t) {
    let i = gt
    for (let r of e.startState.facet(K1)) {
      let s = r(e)
  ...
  static selection(e) {
    return new rt(void 0, gt, void 0, void 0, e)
  }
}
function ps(n, e, t, i) {
...
function vd(n, e) {
  if (n.length) {
    let t = n[n.length - 1],
      i = t.selectionsAfter.slice(Math.max(0, t.selectionsAfter.length - ny))
    return i.length && i[i.length - 1].eq(e)
      ? n
      : (i.push(e), ps(n, n.length - 1, 1e9, t.setSelAfter(i)))
  } else return [rt.selection([e])]
}
function ry(n) {
  let e = n[n.length - 1],
    t = n.slice()
...
function vo(n, e) {
  ...
  return i.length ? [rt.selection(i)] : gt
}
function sy(n, e, t) {
  let i = Dd(
    n.selectionsAfter.length ? n.selectionsAfter.map((l) => l.map(e)) : gt,
    t,
  )
  ...
  return new rt(r, ie.mapEffects(n.effects, e), o, n.startSelection.map(s), i)
}
const oy = /^(input\.type|delete)($|\.)/
class Vt {
  ...
  addChanges(e, t, i, r, s) {
    ...
    return (
      ...
      ((!l.selectionsAfter.length &&
        ...
        r.joinToEvent(s, ty(l.changes, e.changes))) ||
        ...
        ? (o = ps(
            ...
            new rt(
              ...
              Dd(ie.mapEffects(e.effects, l.changes), l.effects),
              l.mapped,
              l.startSelection,
              gt,
            ),
          ))
        : (o = ps(o, o.length, r.minDepth, e)),
      new Vt(o, gt, t, i)
    )
  }
  addSelection(e, t, i, r) {
    ...
    return s.length > 0 &&
      ...
      iy(s[s.length - 1], e)
      ? this
      : new Vt(vd(this.done, e), this.undone, t, i)
  }
  addMapping(e) {
    return new Vt(
      vo(this.done, e),
  ...
  pop(e, t, i) {
    ...
    if (i && s.selectionsAfter.length)
      return t.update({
        ...
        annotations: $l.of({ side: e, rest: ry(r), selection: o }),
        userEvent: e == 0 ? 'select.undo' : 'select.redo',
        scrollIntoView: !0,
      })
    if (s.changes) {
      let l = r.length == 1 ? gt : r.slice(0, r.length - 1)
      return (
        s.mapped && (l = vo(l, s.mapped)),
        t.update({
          changes: s.changes,
          selection: s.startSelection,
          effects: s.effects,
          annotations: $l.of({ side: e, rest: l, selection: o }),
          filter: !1,
...
Vt.empty = new Vt(gt, gt)
const Qd = [
  { key: 'Mod-z', run: Sd, preventDefault: !0 },
  { key: 'Mod-y', mac: 'Mod-Shift-z', run: El, preventDefault: !0 },
  { linux: 'Ctrl-Shift-z', run: El, preventDefault: !0 },
  { key: 'Mod-u', run: J1, preventDefault: !0 },
...
function Rt({ state: n, dispatch: e }, t) {
  let i = mn(n.selection, t)
  return i.eq(n.selection, !0) ? !1 : (e(Gt(n, i)), !0)
}
function Xs(n, e) {
  return T.cursor(e ? n.to : n.from)
}
function kd(n, e) {
  return Rt(n, (t) => (t.empty ? n.moveByChar(t, e) : Xs(t, e)))
}
function Ne(n) {
  return n.textDirectionAt(n.state.selection.main.head) == De.LTR
}
const wd = (n) => kd(n, !Ne(n)),
  Cd = (n) => kd(n, Ne(n))
function Pd(n, e) {
  return Rt(n, (t) => (t.empty ? n.moveByGroup(t, e) : Xs(t, e)))
}
const ly = (n) => Pd(n, !Ne(n)),
  ay = (n) => Pd(n, Ne(n))
function uy(n, e, t) {
...
function _s(n, e, t) {
  let i = Ie(n).resolveInner(e.head),
    r = t ? le.closedBy : le.openedBy
  for (let a = e.head; ; ) {
    let u = t ? i.childAfter(a) : i.childBefore(a)
    if (!u) break
    uy(n, u, r) ? (i = u) : (a = t ? u.to : u.from)
  }
  let s = i.type.prop(r),
    o,
    l
...
const hy = (n) => Rt(n, (e) => _s(n.state, e, !Ne(n))),
  cy = (n) => Rt(n, (e) => _s(n.state, e, Ne(n)))
function Ad(n, e) {
  return Rt(n, (t) => {
...
function Rd(n, e) {
  let t = Td(n),
    { state: i } = n,
    r = mn(i.selection, (o) =>
      o.empty ? n.moveVertically(o, e, t.height) : Xs(o, e),
    )
  ...
  if (t.selfScroll) {
    ...
    o &&
      o.top > a &&
      o.bottom < u &&
      (s = _.scrollIntoView(r.main.head, { y: 'start', yMargin: o.top - a }))
  }
  return n.dispatch(Gt(i, r), { effects: s }), !0
}
const rh = (n) => Rd(n, !1),
  Tl = (n) => Rd(n, !0)
function Ci(n, e, t) {
...
const fy = (n) => Rt(n, (e) => Ci(n, e, !0)),
  dy = (n) => Rt(n, (e) => Ci(n, e, !1)),
  py = (n) => Rt(n, (e) => Ci(n, e, !Ne(n))),
  Oy = (n) => Rt(n, (e) => Ci(n, e, Ne(n))),
  my = (n) => Rt(n, (e) => T.cursor(n.lineBlockAt(e.head).from, 1)),
  gy = (n) => Rt(n, (e) => T.cursor(n.lineBlockAt(e.head).to, -1))
function yy(n, e, t) {
  let i = !1,
    r = mn(n.selection, (s) => {
      let o =
  ...
  return i ? (e(Gt(n, r)), !0) : !1
}
const xy = ({ state: n, dispatch: e }) => yy(n, e)
function Dt(n, e) {
  let t = mn(n.state.selection, (i) => {
    let r = e(i)
    return T.range(i.anchor, r.head, r.goalColumn, r.bidiLevel || void 0)
  })
  return t.eq(n.state.selection) ? !1 : (n.dispatch(Gt(n.state, t)), !0)
}
function Md(n, e) {
  return Dt(n, (t) => n.moveByChar(t, e))
}
const Zd = (n) => Md(n, !Ne(n)),
  Bd = (n) => Md(n, Ne(n))
function Fd(n, e) {
  return Dt(n, (t) => n.moveByGroup(t, e))
}
const by = (n) => Fd(n, !Ne(n)),
  Sy = (n) => Fd(n, Ne(n)),
  Dy = (n) => Dt(n, (e) => _s(n.state, e, !Ne(n))),
  vy = (n) => Dt(n, (e) => _s(n.state, e, Ne(n)))
function Xd(n, e) {
...
const _d = (n) => Xd(n, !1),
  jd = (n) => Xd(n, !0)
function Ld(n, e) {
  return Dt(n, (t) => n.moveVertically(t, e, Td(n).height))
}
const sh = (n) => Ld(n, !1),
  oh = (n) => Ld(n, !0),
  Qy = (n) => Dt(n, (e) => Ci(n, e, !0)),
  ky = (n) => Dt(n, (e) => Ci(n, e, !1)),
  wy = (n) => Dt(n, (e) => Ci(n, e, !Ne(n))),
  Cy = (n) => Dt(n, (e) => Ci(n, e, Ne(n))),
  Py = (n) => Dt(n, (e) => T.cursor(n.lineBlockAt(e.head).from)),
  Ay = (n) => Dt(n, (e) => T.cursor(n.lineBlockAt(e.head).to)),
  lh = ({ state: n, dispatch: e }) => (e(Gt(n, { anchor: 0 })), !0),
  ah = ({ state: n, dispatch: e }) => (e(Gt(n, { anchor: n.doc.length })), !0),
  uh = ({ state: n, dispatch: e }) => (
    e(Gt(n, { anchor: n.selection.main.anchor, head: 0 })), !0
  ),
  hh = ({ state: n, dispatch: e }) => (
    e(Gt(n, { anchor: n.selection.main.anchor, head: n.doc.length })), !0
  ),
  ...
  Ty = ({ state: n, dispatch: e }) => {
    ...
    return t.eq(n.selection) ? !1 : (e(Gt(n, t)), !0)
  },
  ...
  let t = 'delete.selection',
    ...
    r = i.changeByRange((s) => {
      ...
      if (o == l) {
        let a = e(s)
        a < o
          ? ((t = 'delete.backward'), (a = $r(n, a, !1)))
          : a > o && ((t = 'delete.forward'), (a = $r(n, a, !0))),
          (o = Math.min(o, a)),
          (l = Math.max(l, a))
      } else (o = $r(n, o, !1)), (l = $r(n, l, !0))
      return o == l
        ? { range: s }
        : {
            changes: { from: o, to: l },
  ...
  return r.changes.empty
    ...
    : (n.dispatch(
        i.update(r, {
          ...
          effects:
            t == 'delete.selection'
              ? _.announce.of(i.phrase('Selection deleted'))
              : void 0,
        }),
      ),
      !0)
...
const qd = (n, e, t) =>
  ...
  zd = (n, e) =>
    ur(n, (t) => {
      ...
      for (let l = null; ; ) {
        ...
        let a = qe(s.text, i - s.from, e) + s.from,
  ...
  _y = ({ state: n, dispatch: e }) => {
    ...
    let t = n.changeByRange((i) => {
      ...
      let r = i.from,
        s = n.doc.lineAt(r),
        o = r == s.from ? r - 1 : qe(s.text, r - s.from, !1) + s.from,
        l = r == s.to ? r + 1 : qe(s.text, r - s.from, !0) + s.from
      return {
        changes: {
          from: o,
          to: l,
...
const jy = ({ state: n, dispatch: e }) => Id(n, e, !1),
  Ly = ({ state: n, dispatch: e }) => Id(n, e, !0)
function Nd(n, e, t) {
  if (n.readOnly) return !1
  let i = []
  for (let r of js(n))
...
const qy = ({ state: n, dispatch: e }) => Nd(n, e, !1),
  Vy = ({ state: n, dispatch: e }) => Nd(n, e, !0),
  zy = (n) => {
    if (n.state.readOnly) return !1
    let { state: e } = n,
      t = e.changes(
...
function Wd(n) {
  return ({ state: e, dispatch: t }) => {
    ...
    let i = e.changeByRange((r) => {
      ...
      let u = new Ms(e, { simulateBreak: s, simulateDoubleBreak: !!a }),
        h = ca(u, s)
      for (
        h == null && (h = pn(/^\s*/.exec(e.doc.lineAt(s).text)[0], e.tabSize));
      ...
      let c = ['', Hn(e, h)]
      return (
        a && c.push(Hn(e, u.lineIndent(l.from, -1))),
        {
          changes: { from: s, to: o, insert: pe.of(c) },
          range: T.cursor(s + 1 + c[1].length),
        }
      )
    })
...
const Ny = ({ state: n, dispatch: e }) => {
    ...
    let t = Object.create(null),
      ...
      r = Oa(n, (s, o, l) => {
        ...
        ;(u != h || l.from < s.from + u.length) &&
          ((t[s.from] = a),
          o.push({ from: s.from, to: s.from + u.length, insert: h }))
      })
  ...
  Gd = ({ state: n, dispatch: e }) =>
    n.readOnly
      ...
      : (e(
          n.update(
            Oa(n, (t, i) => {
              i.push({ from: t.from, insert: n.facet(Rs) })
            }),
      ...
      : (e(
          n.update(
            Oa(n, (t, i) => {
              ...
              if (!r) return
              let s = pn(r, n.tabSize),
                o = 0,
                l = Hn(n, Math.max(0, s - cs(n)))
              for (
                ;
                o < r.length &&
                o < l.length &&
        ...
        !0),
  Wy = (n) => (n.setTabFocusMode(), !0),
  Gy = [
    { key: 'Ctrl-b', run: wd, shift: Zd, preventDefault: !0 },
    { key: 'Ctrl-f', run: Cd, shift: Bd },
    { key: 'Ctrl-p', run: $d, shift: _d },
    { key: 'Ctrl-n', run: Ed, shift: jd },
    { key: 'Ctrl-a', run: my, shift: Py },
    { key: 'Ctrl-e', run: gy, shift: Ay },
    { key: 'Ctrl-d', run: Vd },
    { key: 'Ctrl-h', run: Rl },
    { key: 'Ctrl-k', run: Zy },
  ...
  Uy = [
    { key: 'ArrowLeft', run: wd, shift: Zd, preventDefault: !0 },
    {
      key: 'Mod-ArrowLeft',
      mac: 'Alt-ArrowLeft',
      run: ly,
    ...
    { mac: 'Cmd-ArrowLeft', run: py, shift: wy, preventDefault: !0 },
    { key: 'ArrowRight', run: Cd, shift: Bd, preventDefault: !0 },
    {
      key: 'Mod-ArrowRight',
      mac: 'Alt-ArrowRight',
      run: ay,
    ...
    { mac: 'Cmd-ArrowRight', run: Oy, shift: Cy, preventDefault: !0 },
    { key: 'ArrowUp', run: $d, shift: _d, preventDefault: !0 },
    { mac: 'Cmd-ArrowUp', run: lh, shift: uh },
    { mac: 'Ctrl-ArrowUp', run: rh, shift: sh },
    { key: 'ArrowDown', run: Ed, shift: jd, preventDefault: !0 },
    { mac: 'Cmd-ArrowDown', run: ah, shift: hh },
    { mac: 'Ctrl-ArrowDown', run: Tl, shift: oh },
    { key: 'PageUp', run: rh, shift: sh },
    { key: 'PageDown', run: Tl, shift: oh },
    { key: 'Home', run: dy, shift: ky, preventDefault: !0 },
    { key: 'Mod-Home', run: lh, shift: uh },
    { key: 'End', run: fy, shift: Qy, preventDefault: !0 },
    { key: 'Mod-End', run: ah, shift: hh },
    { key: 'Enter', run: ch, shift: ch },
    { key: 'Mod-a', run: $y },
    { key: 'Backspace', run: Rl, shift: Rl },
    { key: 'Delete', run: Vd },
    { key: 'Mod-Backspace', mac: 'Alt-Backspace', run: Yd },
    { key: 'Mod-Delete', mac: 'Alt-Delete', run: My },
    { mac: 'Mod-Backspace', run: By },
    { mac: 'Mod-Delete', run: Fy },
  ].concat(Gy.map((n) => ({ mac: n.key, run: n.run, shift: n.shift }))),
  Hd = [
    { key: 'Alt-ArrowLeft', mac: 'Ctrl-ArrowLeft', run: hy, shift: Dy },
    { key: 'Alt-ArrowRight', mac: 'Ctrl-ArrowRight', run: cy, shift: vy },
    { key: 'Alt-ArrowUp', run: jy },
    { key: 'Shift-Alt-ArrowUp', run: qy },
    { key: 'Alt-ArrowDown', run: Ly },
    { key: 'Shift-Alt-ArrowDown', run: Vy },
    { key: 'Escape', run: Ry },
    { key: 'Mod-Enter', run: Iy },
    { key: 'Alt-l', mac: 'Ctrl-l', run: Ey },
    { key: 'Mod-i', run: Ty, preventDefault: !0 },
    { key: 'Mod-[', run: Ud },
    { key: 'Mod-]', run: Gd },
    { key: 'Mod-Alt-\\', run: Ny },
    { key: 'Shift-Mod-k', run: zy },
    { key: 'Shift-Mod-\\', run: xy },
    { key: 'Mod-/', run: z1 },
    { key: 'Alt-A', run: I1 },
    { key: 'Ctrl-m', mac: 'Shift-Alt-m', run: Wy },
  ].concat(Uy),
  Hy = { key: 'Tab', run: Gd, shift: Ud },
  fh =
...
const Kd = { from: -1, to: -1, match: /.*/.exec('') },
  ma = 'gm' + (/x/.unicode == null ? '' : 'u')
class Jd {
  constructor(e, t, i, r = 0, s = e.length) {
    if (
      ...
      return new ep(e, t, i, r, s)
    ;(this.re = new RegExp(t, ma + (i != null && i.ignoreCase ? 'i' : ''))),
      (this.test = i == null ? void 0 : i.test),
      (this.iter = e.iter())
    let o = e.lineAt(r)
    ;(this.curLineStart = o.from),
      (this.matchPos = Os(e, r)),
    ...
    for (let e = this.matchPos - this.curLineStart; ; ) {
      ...
      if (t) {
        let i = this.curLineStart + t.index,
          r = i + t[0].length
        if (
          ((this.matchPos = Os(this.text, r + (i == r ? 1 : 0))),
...
class nn {
  ...
  static get(e, t, i) {
    ...
    if (!r || r.from >= i || r.to <= t) {
      let l = new nn(t, e.sliceString(t, i))
      return Qo.set(e, l), l
    }
...
class ep {
  constructor(e, t, i, r, s) {
    ;(this.text = e),
      ...
      (this.re = new RegExp(t, ma + (i != null && i.ignoreCase ? 'i' : ''))),
      (this.test = i == null ? void 0 : i.test),
      (this.flat = nn.get(e, r, this.chunkEnd(r + 5e3)))
  }
  chunkEnd(e) {
...
typeof Symbol < 'u' &&
  (Jd.prototype[Symbol.iterator] = ep.prototype[Symbol.iterator] =
    function () {
      return this
    })
function Ky(n) {
  try {
    return new RegExp(n, ma), !0
  } catch {
    return !1
  }
}
...
function Ml(n) {
  let e = String(n.state.doc.lineAt(n.state.selection.main.head).number),
    t = Oe('input', { class: 'cm-textfield', name: 'line', value: e }),
    i = Oe(
      'form',
      {
        class: 'cm-gotoLine',
      ...
      Oe('label', n.state.phrase('Go to line'), ': ', t),
      ' ',
      Oe(
        'button',
      ...
      Oe(
        'button',
        {
          name: 'close',
          onclick: () => {
            n.dispatch({ effects: Xn.of(!1) }), n.focus()
          },
  ...
  function r() {
    ...
    let O = o.doc.line(Math.max(1, Math.min(o.doc.lines, d))),
      p = T.cursor(O.from + Math.max(0, Math.min(f, O.length)))
    n.dispatch({
      effects: [Xn.of(!1), _.scrollIntoView(p.from, { y: 'center' })],
      selection: p,
    }),
      n.focus()
  }
...
const Xn = ie.define(),
  dh = Ve.define({
    ...
    update(n, e) {
      for (let t of e.effects) t.is(Xn) && (n = t.value)
      return n
    },
    provide: (n) => Gn.from(n, (e) => (e ? Ml : null)),
  }),
  Jy = (n) => {
    let e = Wn(n, Ml)
    if (!e) {
      let t = [Xn.of(!0)]
      n.state.field(dh, !1) == null && t.push(ie.appendConfig.of([dh, ex])),
        n.dispatch({ effects: t }),
        (e = Wn(n, Ml))
    }
...
const nx = U.mark({ class: 'cm-selectionMatch' }),
  rx = U.mark({ class: 'cm-selectionMatch cm-selectionMatch-main' })
function ph(n, e, t, i) {
  return (
    ...
    class {
      ...
      getDeco(n) {
        ...
        if (r.empty) {
          ...
          if (e.wholeWords) {
            if (
              ...
              !(ph(o, t, r.from, r.to) && sx(o, t, r.from, r.to)))
            )
              return U.none
        ...
        for (let a of n.visibleRanges) {
          let u = new fn(t.doc, s, a.from, a.to)
          for (; !u.next().done; ) {
            ...
            if (
              ...
              (r.empty && h <= r.from && c >= r.to
                ? l.push(rx.range(h, c))
                : (h >= r.to || c <= r.from) && l.push(nx.range(h, c)),
...
function ux(n, e) {
  ...
  for (let o = !1, l = new fn(n.doc, e, i[i.length - 1].to); ; )
    if ((l.next(), l.done)) {
      if (o) return null
      ;(l = new fn(n.doc, e, 0, Math.max(0, i[i.length - 1].from - 1))),
        (o = !0)
    } else {
...
const hx = ({ state: n, dispatch: e }) => {
    let { ranges: t } = n.selection
    if (t.some((s) => s.from === s.to)) return ax({ state: n, dispatch: e })
...
class ip {
  constructor(e) {
    ;(this.search = e.search),
      ...
      (this.valid = !!this.search && (!this.regexp || Ky(this.search))),
...
`
  ...
  create() {
    return this.regexp ? new px(this) : new fx(this)
  }
  getCursor(e, t = 0, i) {
    let r = e.doc ? e : he.create({ doc: e })
    return (
      i == null && (i = r.doc.length),
      this.regexp ? Wi(this, r, t, i) : Ni(this, r, t, i)
    )
  }
}
class np {
...
function Ni(n, e, t, i) {
  return new fn(
    ...
    n.wholeWord ? cx(e.doc, e.charCategorizer(e.selection.main.head)) : void 0,
  )
}
function cx(n, e) {
  return (t, i, r, s) => (
    ...
    (e(ms(r, t - s)) != ve.Word || e(gs(r, t - s)) != ve.Word) &&
      (e(gs(r, i - s)) != ve.Word || e(ms(r, i - s)) != ve.Word)
  )
}
class fx extends np {
  constructor(e) {
  ...
  nextMatch(e, t, i) {
    let r = Ni(this.spec, e, i, e.doc.length).nextOverlapping()
    if (r.done) {
      let s = Math.min(e.doc.length, t + this.spec.unquoted.length)
      r = Ni(this.spec, e, 0, s).nextOverlapping()
    }
  ...
  matchAll(e, t) {
    let i = Ni(this.spec, e, 0, e.doc.length),
      r = []
    for (; !i.next().done; ) {
...
function Wi(n, e, t, i) {
  return new Jd(
    ...
    n.search,
    {
      ...
      test: n.wholeWord ? dx(e.charCategorizer(e.selection.main.head)) : void 0,
    },
    t,
    i,
  )
...
function ms(n, e) {
  return n.slice(qe(n, e, !1), e)
}
function gs(n, e) {
  return n.slice(e, qe(n, e))
}
function dx(n) {
  return (e, t, i) =>
    !i[0].length ||
    ((n(ms(i.input, i.index)) != ve.Word ||
      n(gs(i.input, i.index)) != ve.Word) &&
      (n(gs(i.input, i.index + i[0].length)) != ve.Word ||
        n(ms(i.input, i.index + i[0].length)) != ve.Word))
}
class px extends np {
  nextMatch(e, t, i) {
    let r = Wi(this.spec, e, i, e.doc.length).next()
    return (
      r.done && (r = Wi(this.spec, e, 0, t).next()), r.done ? null : r.value
    )
  }
  prevMatchInRange(e, t, i) {
    for (let r = 1; ; r++) {
      let s = Math.max(t, i - r * 1e4),
        o = Wi(this.spec, e, s, i),
        l = null
  ...
  matchAll(e, t) {
    let i = Wi(this.spec, e, 0, e.doc.length),
      r = []
    for (; !i.next().done; ) {
      if (r.length >= t) return null
      r.push(i.value)
...
const Kn = ie.define(),
  ...
  bi = Ve.define({
    create(n) {
      return new ko(Zl(n).create(), null)
    },
    update(n, e) {
      for (let t of e.effects)
        t.is(Kn)
          ? (n = new ko(t.value.create(), n.panel))
          : t.is(ga) && (n = new ko(n.query, t.value ? ya : null))
      return n
    },
    provide: (n) => Gn.from(n, (e) => e.panel),
  })
class ko {
  constructor(e, t) {
...
const Ox = U.mark({ class: 'cm-searchMatch' }),
  mx = U.mark({ class: 'cm-searchMatch cm-searchMatch-selected' }),
  gx = we.fromClass(
    class {
      constructor(n) {
        ;(this.view = n), (this.decorations = this.highlight(n.state.field(bi)))
      }
      update(n) {
        let e = n.state.field(bi)
        ;(e != n.startState.field(bi) ||
          n.docChanged ||
          n.selectionSet ||
          n.viewportChanged) &&
      ...
      highlight({ query: n, panel: e }) {
        ...
        for (let r = 0, s = t.visibleRanges, o = s.length; r < o; r++) {
          ...
          n.highlight(t.state, l, a, (u, h) => {
            let c = t.state.selection.ranges.some(
              (f) => f.from == u && f.to == h,
            )
            i.add(u, h, c ? mx : Ox)
          })
...
function hr(n) {
  return (e) => {
    let t = e.state.field(bi, !1)
    return t && t.query.spec.valid ? n(e, t) : op(e)
  }
}
const ys = hr((n, { query: e }) => {
    ...
    return (
      n.dispatch({
        selection: r,
        effects: [xa(n, i), s.scrollToMatch(r.main, n)],
  ...
  xs = hr((n, { query: e }) => {
    ...
    return (
      n.dispatch({
        selection: s,
        effects: [xa(n, r), o.scrollToMatch(s.main, n)],
        userEvent: 'select.search',
      }),
      sp(n),
      !0
  ...
  xx = ({ state: n, dispatch: e }) => {
    ...
    let { from: i, to: r } = t.main,
      s = [],
      o = 0
    for (let l = new fn(n.doc, n.sliceDoc(i, r)); !l.next().done; ) {
  ...
  Oh = hr((n, { query: e }) => {
    ...
    return (
      o &&
        ((a = T.single(o.from, o.to).map(c)),
        h.push(xa(n, o)),
        h.push(t.facet(gn).scrollToMatch(a.main, n))),
      n.dispatch({
        changes: c,
        selection: a,
        effects: h,
...
const op = (n) => {
    let e = n.state.field(bi, !1)
    if (e && e.panel) {
      let t = rp(n)
      if (t && t != n.root.activeElement) {
        let i = Zl(n.state, e.query.spec)
      ...
      n.dispatch({
        effects: [
          ga.of(!0),
          e ? Kn.of(Zl(n.state, e.query.spec)) : ie.appendConfig.of(Qx),
        ],
      })
    return !0
  },
  lp = (n) => {
    ...
    return (
      ...
      n.dispatch({ effects: ga.of(!1) }),
      !0
    )
  },
  Sx = [
    { key: 'Mod-f', run: op, scope: 'editor search-panel' },
    {
      key: 'F3',
      run: ys,
      shift: xs,
    ...
    { key: 'Escape', run: lp, scope: 'editor search-panel' },
    { key: 'Mod-Shift-l', run: xx },
    { key: 'Mod-Alt-g', run: Jy },
    { key: 'Mod-d', run: hx, preventDefault: !0 },
  ]
class Dx {
  constructor(e) {
    this.view = e
    let t = (this.query = e.state.field(bi).query.spec)
    ;(this.commit = this.commit.bind(this)),
      (this.searchField = Oe('input', {
        value: t.search,
    ...
    this.dom = Oe(
      ...
      [
        this.searchField,
        i('next', () => ys(e), [at(e, 'next')]),
        i('prev', () => xs(e), [at(e, 'previous')]),
        i('select', () => yx(e), [at(e, 'all')]),
        Oe('label', null, [this.caseField, at(e, 'match case')]),
        Oe('label', null, [this.reField, at(e, 'regexp')]),
        Oe('label', null, [this.wordField, at(e, 'by word')]),
        ...(e.state.readOnly
          ? []
          : [
              Oe('br'),
              this.replaceField,
              i('replace', () => Oh(e), [at(e, 'replace')]),
              i('replaceAll', () => bx(e), [at(e, 'replace all')]),
            ]),
        Oe(
          'button',
          {
  ...
  commit() {
    ...
    e.eq(this.query) ||
      ((this.query = e), this.view.dispatch({ effects: Kn.of(e) }))
  }
  keydown(e) {
    qg(this.view, e, 'search-panel')
      ? e.preventDefault()
      : e.keyCode == 13 && e.target == this.searchField
        ? (e.preventDefault(), (e.shiftKey ? xs : ys)(this.view))
        : e.keyCode == 13 &&
          e.target == this.replaceField &&
          (e.preventDefault(), Oh(this.view))
  }
  update(e) {
    for (let t of e.transactions)
      for (let i of t.effects)
...
const Er = 30,
  Tr = /[\s\.,:;?!]/
function xa(n, { from: e, to: t }) {
  let i = n.state.doc.lineAt(e),
    r = n.state.doc.lineAt(t).to,
    s = Math.max(i.from, e - Er),
    o = Math.min(r, t + Er),
    l = n.state.sliceDoc(s, o)
  if (s != i.from) {
    for (let a = 0; a < Er; a++)
      if (!Tr.test(l[a + 1]) && Tr.test(l[a])) {
        l = l.slice(a)
        break
      }
  }
...
function wx(n) {
  let e = n.map((r) => (typeof r == 'string' ? { label: r } : r)),
    [t, i] = e.every((r) => /^\w+$/.test(r.label)) ? [/\w*$/, /\w+$/] : kx(e)
  return (r) => {
...
class Ax {
  constructor(e) {
    ...
    for (let t = 0; t < e.length; ) {
      ...
      let s = e.slice(t, t + r),
        o = s.toUpperCase()
      this.folded.push(et(o == s ? s.toLowerCase() : o, 0)), (t += r)
    }
  ...
  match(e) {
    ...
    let a = t.length,
      u = 0
    if (l < 0) {
      for (let x = 0, k = Math.min(e.length, 200); x < k && u < a; ) {
        let Q = et(e, x)
        ;(Q == t[u] || Q == i[u]) && (r[u++] = x), (x += jt(Q))
      }
      if (u < a) return null
    }
    let h = 0,
      ...
      g = /[a-z]/.test(e),
      m = !0
    for (let x = 0, k = Math.min(e.length, 200), Q = 0; x < k && c < a; ) {
      let S = et(e, x)
      l < 0 &&
        (h < a && S == t[h] && (s[h++] = x),
        d < a &&
  ...
  result(e, t, i) {
    let r = [],
      s = 0
    for (let o of t) {
      let l = o + (this.astral ? jt(et(i, o)) : 1)
...
function Ex(n, e, t, i, r, s) {
  let o = n.textDirection == De.RTL,
    ...
    p = i.bottom - i.top
  if (
    (l && f < Math.min(O, d) ? (l = !1) : !l && d < Math.min(O, f) && (l = !0),
    O <= (l ? f : d))
  )
    (h = Math.max(r.top, Math.min(t.top, r.bottom - p)) - e.top),
      (c = Math.min(400, l ? f : d))
  else {
    ;(a = !0), (c = Math.min(400, (o ? e.right : r.right - e.left) - 30))
    let x = r.bottom - e.bottom
    x >= p || x > e.top
      ? (h = t.bottom - e.top)
      : ((u = 'bottom'), (h = e.bottom - t.top))
  }
  let g = (e.bottom - e.top) / s.offsetHeight,
    m = (e.right - e.left) / s.offsetWidth
  return {
    style: `${u}: ${h / g}px; max-width: ${c / m}px`,
    class:
      'cm-completionInfo-' +
...
class Rx {
  constructor(e, t, i) {
    ...
    let r = e.state.field(t),
      ...
      l = e.state.facet(Xe)
    ;(this.optionContent = Tx(l)),
      (this.optionClass = l.optionClass),
      (this.tooltipClass = l.tooltipClass),
      (this.range = wo(s.length, o, l.maxRenderedOptions)),
      (this.dom = document.createElement('div')),
      ...
      this.dom.addEventListener('focusout', (a) => {
        ...
        u &&
          u.tooltip &&
          e.state.facet(Xe).closeOnBlur &&
          a.relatedTarget != e.contentDOM &&
          e.dispatch({ effects: Jn.of(null) })
      }),
  ...
  update(e) {
    ...
    if ((this.updateTooltipClass(e.state), i != r)) {
      ...
      ;(!r.open || r.open.options != s) &&
        ((this.range = wo(s.length, o, e.state.facet(Xe).maxRenderedOptions)),
    ...
    if (
      (((t.selected > -1 && t.selected < this.range.from) ||
        ...
        ((this.range = wo(
          t.options.length,
          t.selected,
          this.view.state.facet(Xe).maxRenderedOptions,
        )),
      ...
      'then' in s
        ? s
            ...
            .catch((o) => nt(this.view.state, o, 'completion info'))
  ...
  measureInfo() {
    ...
    return r.top > Math.min(s.bottom, t.bottom) - 10 ||
      ...
      ? null
      : this.view.state.facet(Xe).positionInfo(this.view, t, r, i, s, this.dom)
  }
  placeInfo(e) {
    this.info &&
      (e
...
function Bx(n, e) {
    ...
    if (u.hasResult()) {
      ...
      if (u.result.filter === !1)
        for (let c of u.result.options)
          r(new gh(c, u.source, h ? h(c) : [], 1e9 - t.length))
      else {
        let c = e.sliceDoc(u.from, u.to),
          f,
          d = s.filterStrict ? new $x(c) : new Ax(c)
        for (let O of u.result.options)
          if ((f = d.match(O.label))) {
            let p = O.displayLabel ? (h ? h(O, f.matched) : []) : f.matched
            r(new gh(O, u.source, p, f.score + (O.boost || 0)))
          }
      }
    }
  if (i) {
    let u = Object.create(null),
      ...
      c = (f, d) => {
        var O, p
        return (
          ((O = f.rank) !== null && O !== void 0 ? O : 1e9) -
            ((p = d.rank) !== null && p !== void 0 ? p : 1e9) ||
          (f.name < d.name ? -1 : 1)
        )
      }
  ...
  for (let u of t.sort(
    (h, c) => c.score - h.score || a(h.completion, c.completion),
  )) {
    let h = u.completion
    !l ||
    l.label != h.label ||
    ...
    l.boost != h.boost
      ? o.push(u)
      : bh(u.completion) > bh(l) && (o[o.length - 1] = u),
      (l = u.completion)
  }
  return o
}
class Ki {
  ...
  static build(e, t, i, r, s, o) {
    ...
    let a = t.facet(Xe).selectOnOpen ? 0 : -1
...
class Ss {
  ...
  update(e) {
    let { state: t } = e,
      i = t.facet(Xe),
      s = (i.override || t.languageDataAt('autocomplete', Xi(t)).map(Px)).map(
        (a) =>
          (
            this.active.find((h) => h.source == a) ||
            new yt(a, this.active.some((h) => h.state != 0) ? 1 : 0)
          ).update(e, i),
      )
  ...
  get attrs() {
    return this.open ? this.open.attrs : this.active.length ? Xx : _x
  }
}
function Fx(n, e) {
  if (n == e) return !0
...
const Xx = { 'aria-autocomplete': 'list' },
  _x = {}
function Sh(n, e) {
  let t = {
...
class yt {
  ...
  update(e, t) {
    let i = cp(e, t),
      r = this
    ;(i & 8 || (i & 16 && this.touches(e))) && (r = new yt(r.source, 0)),
      i & 4 && r.state == 0 && (r = new yt(this.source, 1)),
      (r = r.updateFor(e, i))
    for (let s of e.effects)
      if (s.is(bs)) r = new yt(r.source, 1, s.value)
      else if (s.is(Jn)) r = new yt(r.source, 0)
      else if (s.is(ba)) for (let o of s.value) o.source == r.source && (r = o)
    return r
  }
  updateFor(e, t) {
  ...
  touches(e) {
    return e.changes.touchesRange(Xi(e.state))
  }
}
class rn extends yt {
  constructor(e, t, i, r, s, o) {
  ...
  updateFor(e, t) {
    ...
    if (
      l > o ||
      !r ||
      (t & 2 && (Xi(e.startState) == this.from || l < this.limit))
    )
      return new yt(this.source, t & 4 ? 1 : 0)
    let a = e.changes.mapPos(this.limit)
    return Lx(r.validFor, e.state, s, o)
      ? new rn(this.source, this.explicit, a, r, s, o)
      : r.update && (r = r.update(r, s, o, new ap(e.state, l, !1)))
        ? new rn(
            this.source,
            this.explicit,
            a,
            r,
            r.from,
            (i = r.to) !== null && i !== void 0 ? i : Xi(e.state),
          )
        : new yt(this.source, 1, this.explicit)
  }
  map(e) {
    return e.empty
      ? this
...
function Lx(n, e, t, i) {
  ...
  return typeof n == 'function' ? n(r, t, i, e) : up(n, !0).test(r)
}
const ba = ie.define({
    map(n, e) {
...
function Sa(n, e) {
  ...
  return i instanceof rn
    ? (typeof t == 'string'
        ? n.dispatch(
            Object.assign(Object.assign({}, Cx(n.state, t, i.from, i.to)), {
              annotations: hp.of(e.completion),
            }),
          )
...
function Rr(n, e = 'option') {
  return (t) => {
    ...
    if (
      ...
      !i.open ||
      i.open.disabled ||
      Date.now() - i.open.timestamp < t.state.facet(Xe).interactionDelay
    )
      return !1
    let r = 1,
      s
    e == 'page' &&
      (s = Xf(t, i.open.tooltip)) &&
      (r = Math.max(
        2,
        Math.floor(
...
const Vx = (n) => {
    ...
    return n.state.readOnly ||
      ...
      e.open.selected < 0 ||
      e.open.disabled ||
      Date.now() - e.open.timestamp < n.state.facet(Xe).interactionDelay
      ? !1
      : Sa(n, e.open.options[e.open.selected])
  },
  Dh = (n) =>
    n.state.field(it, !1) ? (n.dispatch({ effects: bs.of(!0) }), !0) : !1,
  zx = (n) => {
    let e = n.state.field(it, !1)
    return !e || !e.active.some((t) => t.state != 0)
      ? !1
      : (n.dispatch({ effects: Jn.of(null) }), !0)
  }
class Yx {
  constructor(e, t) {
    ;(this.active = e),
...
const Ix = 50,
      ...
      update(n) {
        ...
        for (let s = 0; s < this.running.length; s++) {
          ...
          if (
            ...
            (o.updates.length + n.transactions.length > Ix &&
              Date.now() - o.time > Nx)
          ) {
        ...
        this.debounceUpdate > -1 && clearTimeout(this.debounceUpdate),
          n.transactions.some((s) => s.effects.some((o) => o.is(bs))) &&
            (this.pendingStart = !0)
      ...
      startUpdate() {
        ...
        this.running.length &&
          ...
          (this.debounceAccept = setTimeout(
            () => this.accept(),
            this.view.state.facet(Xe).updateSyncTime,
          ))
      }
      startQuery(n) {
        let { state: e } = this.view,
          t = Xi(e),
          i = new ap(e, t, n.explicit, this.view),
          r = new Yx(n, i)
        this.running.push(r),
          Promise.resolve(n.source(i)).then(
            ...
            (s) => {
              this.view.dispatch({ effects: Jn.of(null) }),
                nt(this.view.state, s)
            },
          )
      }
      scheduleAccept() {
      ...
      accept() {
        ...
        for (let r = 0; r < this.running.length; r++) {
          ...
          if ((this.running.splice(r--, 1), s.done)) {
            ...
            for (let h of s.updates) u = u.update(h, t)
            if (u.hasResult()) {
              e.push(u)
              continue
            }
    ...
    },
    {
      eventHandlers: {
        blur(n) {
          ...
          if (e && e.tooltip && this.view.state.facet(Xe).closeOnBlur) {
            let t = e.open && Xf(this.view, e.open.tooltip)
            ;(!t || !t.dom.contains(n.relatedTarget)) &&
              setTimeout(() => this.view.dispatch({ effects: Jn.of(null) }), 10)
          }
        },
        compositionstart() {
          this.composing = 1
        ...
        compositionend() {
          this.composing == 3 &&
            setTimeout(() => this.view.dispatch({ effects: bs.of(!1) }), 20),
            (this.composing = 0)
        },
      },
    },
  ),
  Gx = typeof navigator == 'object' && /Win/.test(navigator.platform),
  Ux = zi.highest(
    _.domEventHandlers({
      keydown(n, e) {
        ...
        return s && s.indexOf(n.key) > -1 && Sa(e, i), !1
      },
    }),
  ),
  Hx = _.baseTheme({
  ...
  Bi = ie.define({
    map(n, e) {
      let t = e.mapPos(n, -1, Ge.TrackAfter)
      return t ?? void 0
    },
  }),
  Da = new (class extends _i {})()
Da.startSide = 1
Da.endSide = -1
const dp = Ve.define({
  create() {
  ...
  update(n, e) {
    ...
    for (let t of e.effects)
      t.is(Bi) && (n = n.update({ add: [Da.range(t.value, t.value + 1)] }))
    return n
  },
})
function pp() {
...
const Co = '()[]{}<>«»»«［］｛｝'
function Op(n) {
  for (let e = 0; e < Co.length; e += 2)
    if (Co.charCodeAt(e) == n) return Co.charAt(e + 1)
  return Yl(n < 128 ? n : n + 1)
}
function mp(n, e) {
...
const Kx =
  ...
  Jx = _.inputHandler.of((n, e, t, i) => {
    if ((Kx ? n.composing : n.compositionStarted) || n.state.readOnly) return !1
    let r = n.state.selection.main
    if (
      i.length > 2 ||
      (i.length == 2 && jt(et(i, 0)) == 1) ||
      e != r.from ||
      t != r.to
    )
      return !1
  ...
  eb = ({ state: n, dispatch: e }) => {
    if (n.readOnly) return !1
    let i = mp(n, n.selection.main.head).brackets || er.brackets,
      r = null,
      s = n.changeByRange((o) => {
        if (o.empty) {
          let l = nb(n.doc, o.head)
          for (let a of i)
            if (a == l && Ls(n.doc, o.head) == Op(et(a, 0)))
              return {
  ...
  tb = [{ key: 'Backspace', run: eb }]
function ib(n, e) {
  let t = mp(n, n.selection.main.head),
    i = t.brackets || er.brackets
  for (let r of i) {
    let s = Op(et(r, 0))
    if (e == r)
      return s == r
        ? ob(n, r, i.indexOf(r + r + r) > -1, t)
        : rb(n, r, s, t.before || er.before)
    if (e == s && gp(n, n.selection.main.from)) return sb(n, r, s)
  }
  return null
}
function gp(n, e) {
  let t = !1
  return (
    n.field(dp).between(0, n.doc.length, (i) => {
      i == e && (t = !0)
    }),
    t
  )
...
function Ls(n, e) {
  ...
  return t.slice(0, jt(et(t, 0)))
}
function nb(n, e) {
  let t = n.sliceString(e - 2, e)
  return jt(et(t, 0)) == t.length ? t : t.slice(1)
}
function rb(n, e, t, i) {
  let r = null,
    s = n.changeByRange((o) => {
...
function ob(n, e, t, i) {
  let r = i.stringPrefixes || er.stringPrefixes,
    s = null,
    o = n.changeByRange((l) => {
      if (!l.empty)
        return {
...
function vh(n, e) {
  let t = Ie(n).resolveInner(e + 1)
  return t.parent && t.from == e
}
function lb(n, e, t, i) {
  let r = Ie(n).resolveInner(e, -1),
...
function ab(n = {}) {
  return [Ux, it, Xe.of(n), Wx, ub, Hx]
}
const yp = [
    { key: 'Ctrl-Space', run: Dh },
    { mac: 'Alt-`', run: Dh },
    { key: 'Escape', run: zx },
    { key: 'ArrowDown', run: Rr(!0) },
    { key: 'ArrowUp', run: Rr(!1) },
    { key: 'PageDown', run: Rr(!0, 'page') },
    { key: 'PageUp', run: Rr(!1, 'page') },
    { key: 'Enter', run: Vx },
  ],
  ub = zi.highest(
    or.computeN([Xe], (n) => (n.facet(Xe).defaultKeymap ? [yp] : [])),
  )
class kh {
  constructor(e, t, i) {
...
class Mi {
  ...
  static init(e, t, i) {
    ...
    r && (e = r(e, i))
    let s = e.slice().sort((h, c) => h.from - c.from || h.to - c.to),
      o = new si(),
      l = [],
      a = 0
    for (let h = 0; ; ) {
      ...
      for (
        l.length
          ? ((f = a),
            (d = l.reduce(
              (p, g) => Math.min(p, g.to),
              c && c.from > f ? c.from : 1e8,
            )))
          : ((f = c.from), (d = c.to), l.push(c), h++);
        h < s.length;

      ) {
        let p = s[h]
        if (p.from == f && (p.to > p.from || p.to == f))
      ...
      if (
        l.some(
          (p) =>
            p.from == p.to ||
            (p.from == p.to - 1 && i.doc.lineAt(p.from).to == p.from),
        )
      )
        o.add(f, f, U.widget({ widget: new yb(O), diagnostics: l.slice() }))
      else {
        let p = l.reduce(
          (g, m) => (m.markClass ? g + ' ' + m.markClass : g),
          '',
        )
        o.add(
          f,
      ...
      a = d
      for (let p = 0; p < l.length; p++) l[p].to <= a && l.splice(p--, 1)
    }
    let u = o.finish()
    return new Mi(u, t, dn(u))
  }
}
function dn(n, e = null, t = 0) {
  let i = null
  return (
    n.between(t, 1e9, (r, s, { spec: o }) => {
      if (!(e && o.diagnostics.indexOf(e) < 0))
        if (!i) i = new kh(r, s, e || o.diagnostics[0])
        else {
          if (o.diagnostics.indexOf(i.diagnostic) < 0) return !1
          i = new kh(i.from, s, i.diagnostic)
        }
    }),
    i
  )
...
function hb(n, e) {
  let t = e.pos,
    i = e.end || t,
    r = n.state.facet(tr).hideOn(n, t, i)
  if (r != null) return r
  let s = n.startState.doc.lineAt(e.pos)
  return !!(
    n.effects.some((o) => o.is(xp)) ||
    n.changes.touchesRange(s.from, Math.max(s.to, i))
  )
}
function cb(n, e) {
  return n.field(pt, !1) ? e : e.concat(ie.appendConfig.of(vb))
}
const xp = ie.define(),
  va = ie.define(),
  bp = ie.define(),
  pt = Ve.define({
    create() {
      return new Mi(U.none, null, null)
    },
    update(n, e) {
      if (e.docChanged && n.diagnostics.size) {
        ...
        if (n.selected) {
          ...
          i = dn(t, n.selected.diagnostic, s) || dn(t, null, s)
        }
        !t.size && r && e.state.facet(tr).autoPanel && (r = null),
          (n = new Mi(t, r, i))
      }
      for (let t of e.effects)
        if (t.is(xp)) {
          let i = e.state.facet(tr).autoPanel
            ? t.value.length
              ? ir.open
              : null
            : n.panel
          n = Mi.init(t.value, i, e.state)
        } else
          t.is(va)
            ? (n = new Mi(n.diagnostics, t.value ? ir.open : null, n.selected))
            : t.is(bp) && (n = new Mi(n.diagnostics, n.panel, t.value))
      return n
    },
    provide: (n) => [
      Gn.from(n, (e) => e.panel),
  ...
  fb = U.mark({ class: 'cm-lintRange cm-lintRange-active' })
function db(n, e, t) {
  ...
  i.between(e - (t < 0 ? 1 : 0), e + (t > 0 ? 1 : 0), (a, u, { spec: h }) => {
    if (e >= a && e <= u && (a == u || ((e > a || t > 0) && (e < u || t < 0))))
      return (r = h.diagnostics), (s = a), (o = u), !1
  })
...
const Ob = (n) => {
    ...
    ;(!e || !e.panel) && n.dispatch({ effects: cb(n.state, [va.of(!0)]) })
    let t = Wn(n, ir.open)
    return t && t.dom.querySelector('.cm-panel-lint ul').focus(), !0
  },
  wh = (n) => {
    let e = n.state.field(pt, !1)
    return !e || !e.panel ? !1 : (n.dispatch({ effects: va.of(!1) }), !0)
  },
  mb = (n) => {
    let e = n.state.field(pt, !1)
    if (!e) return !1
  ...
  gb = [
    { key: 'Mod-Shift-m', run: Ob, preventDefault: !0 },
    { key: 'F8', run: mb },
  ],
  tr = z.define({
    combine(n) {
      ...
      : i.map((s, o) => {
          let l = !1,
            a = (f) => {
              ...
              l = !0
              let d = dn(n.state.field(pt).diagnostics, e)
            ...
            c =
              h < 0
                ? u
                : [u.slice(0, h), Oe('u', u.slice(h, h + 1)), u.slice(h + 1)]
          return Oe(
            'button',
            {
              type: 'button',
...
class ir {
  constructor(e) {
    ...
    let t = (r) => {
        if (r.keyCode == 27) wh(this.view), this.view.focus()
          ...
          for (let l = 0; l < o.length; l++)
            if (o[l].toUpperCase().charCodeAt(0) == r.keyCode) {
              let a = dn(this.view.state.field(pt).diagnostics, s)
    ...
    for (
      e.between(0, this.view.state.doc.length, (l, a, { spec: u }) => {
        for (let h of u.diagnostics) {
          ...
          c < 0
            ? ((f = new Ch(this.view, h)), this.items.splice(i, 0, f), (r = !0))
            : ((f = this.items[c]),
  ...
  moveSelection(e) {
    ...
    let t = this.view.state.field(pt),
      i = dn(t.diagnostics, this.items[e].diagnostic)
    i &&
      this.view.dispatch({
        selection: { anchor: i.from, head: i.to },
        scrollIntoView: !0,
...
const bb = _.baseTheme({
  ...
  '.cm-lintRange-error': { backgroundImage: Mr('#d11') },
  '.cm-lintRange-warning': { backgroundImage: Mr('orange') },
  '.cm-lintRange-info': { backgroundImage: Mr('#999') },
  '.cm-lintRange-hint': { backgroundImage: Mr('#66d') },
...
const vb = [
  pt,
  _.decorations.compute([pt], (n) => {
    let { selected: e, panel: t } = n.field(pt)
    return !e || !t || e.from == e.to ? U.none : U.set([fb.range(e.from, e.to)])
  }),
  C0(db, { hideOn: hb }),
  bb,
]
var Ph = function (e) {
  ...
  var { crosshairCursor: t = !1 } = e,
    i = []
  e.closeBracketsKeymap !== !1 && (i = i.concat(tb)),
    e.defaultKeymap !== !1 && (i = i.concat(Hd)),
    e.searchKeymap !== !1 && (i = i.concat(Sx)),
    e.historyKeymap !== !1 && (i = i.concat(Qd)),
    e.foldKeymap !== !1 && (i = i.concat(Q1)),
    e.completionKeymap !== !1 && (i = i.concat(yp)),
    e.lintKeymap !== !1 && (i = i.concat(gb))
  var r = []
  return (
    e.lineNumbers !== !1 && r.push(qf()),
    e.highlightActiveLineGutter !== !1 && r.push(Vf()),
    e.highlightSpecialChars !== !1 && r.push(Zf()),
    e.history !== !1 && r.push(bd()),
    e.foldGutter !== !1 && r.push(P1()),
    e.drawSelection !== !1 && r.push(Tf()),
    e.dropCursor !== !1 && r.push(Kg()),
    e.allowMultipleSelections !== !1 &&
      r.push(he.allowMultipleSelections.of(!0)),
    e.indentOnInput !== !1 && r.push(id()),
    e.syntaxHighlighting !== !1 && r.push(Bs(fd, { fallback: !0 })),
    e.bracketMatching !== !1 && r.push(md()),
    e.closeBrackets !== !1 && r.push(pp()),
    e.autocompletion !== !1 && r.push(ab()),
    e.rectangularSelection !== !1 && r.push(m0()),
    t !== !1 && r.push(x0()),
    e.highlightActiveLine !== !1 && r.push(Bf()),
    e.highlightSelectionMatches !== !1 && r.push(tp()),
    e.tabSize &&
      typeof e.tabSize == 'number' &&
      r.push(Rs.of(' '.repeat(e.tabSize))),
    r.concat([or.of(i.flat())]).filter(Boolean)
  )
}
const Qb = '#e5c07b',
  Ah = '#e06c75',
  ...
  Tb = _.theme(
    {
      '&': { color: Wr, backgroundColor: Th },
      '.cm-content': { caretColor: Rh },
      '.cm-cursor, .cm-dropCursor': { borderLeftColor: Rh },
      '&.cm-focused > .cm-scroller > .cm-selectionLayer .cm-selectionBackground, .cm-selectionBackground, .cm-content ::selection':
        { backgroundColor: Eb },
      '.cm-panels': { backgroundColor: $b, color: Wr },
      ...
      '.cm-gutters': { backgroundColor: Th, color: Bl, border: 'none' },
      '.cm-activeLineGutter': { backgroundColor: Eh },
      '.cm-foldPlaceholder': {
      ...
      '.cm-tooltip-autocomplete': {
        '& > ul > li[aria-selected]': { backgroundColor: Eh, color: Wr },
      },
    },
    { dark: !0 },
  ),
  Rb = On.define([
    { tag: y.keyword, color: Ab },
    {
      tag: [y.name, y.deleted, y.character, y.propertyName, y.macroName],
      color: Ah,
    },
    { tag: [y.function(y.variableName), y.labelName], color: Cb },
    { tag: [y.color, y.constant(y.name), y.standard(y.name)], color: $h },
    { tag: [y.definition(y.name), y.separator], color: Wr },
    {
      tag: [
        y.typeName,
        y.className,
    ...
    { tag: [y.meta, y.comment], color: Bl },
    { tag: y.strong, fontWeight: 'bold' },
    { tag: y.emphasis, fontStyle: 'italic' },
    { tag: y.strikethrough, textDecoration: 'line-through' },
    { tag: y.link, color: Bl, textDecoration: 'underline' },
    { tag: y.heading, fontWeight: 'bold', color: Ah },
    { tag: [y.atom, y.bool, y.special(y.variableName)], color: $h },
    { tag: [y.processingInstruction, y.string, y.inserted], color: Pb },
    { tag: y.invalid, color: wb },
  ]),
  Mb = [Tb, Bs(Rb)]
var Zb = _.theme({ '&': { backgroundColor: '#fff' } }, { dark: !1 }),
  Bb = function (e) {
    e === void 0 && (e = {})
    var {
        indentWithTab: t = !0,
      ...
      a = []
    switch (
      (t && a.unshift(or.of([Hy])),
      l && (typeof l == 'boolean' ? a.unshift(Ph()) : a.unshift(Ph(l))),
      o && a.unshift(f0(o)),
      s)
    ) {
      case 'light':
    ...
    return (
      i === !1 && a.push(_.editable.of(!1)),
      r && a.push(he.readOnly.of(!0)),
      [...a]
    )
  },
  Fb = (n) => ({
...
function _b(n) {
  var {
    ...
    Z = _.updateListener.of((I) => {
      if (
        I.docChanged &&
        typeof i == 'function' &&
        !I.transactions.some((ne) => ne.annotation(Mh))
      ) {
        var N = I.state.doc,
          F = N.toString()
        i(F, I)
    ...
    V = [Z, w, ...j]
  return (
    o && typeof o == 'function' && V.push(_.updateListener.of(o)),
    (V = V.concat(l)),
    M.useLayoutEffect(() => {
      if (E && !$) {
        var I = { doc: e, selection: t, extensions: V },
          N = C ? he.fromJSON(C.json, I, C.fields) : he.create(I)
        if ((A(N), !v)) {
          var F = new _({ state: N, parent: E, root: S })
          D(F), s && s(F, N)
        }
      }
      return () => {
    ...
    M.useEffect(() => {
      v && v.dispatch({ effects: ie.reconfigure.of(V) })
    }, [u, l, h, c, f, d, O, p, g, m, x, k, Q, i, o]),
    M.useEffect(() => {
      if (e !== void 0) {
        var I = v ? v.state.doc.toString() : ''
        v &&
          e !== I &&
          v.dispatch({
            changes: { from: 0, to: I.length, insert: e || '' },
            annotations: [Mh.of(!0)],
          })
      }
    }, [e, v]),
...
var jb = [
  ...
  vp = M.forwardRef((n, e) => {
    ...
    M.useImperativeHandle(e, () => ({ editor: D.current, state: $, view: A }), [
      D,
      w,
      $,
      A,
    ...
    var V = typeof c == 'string' ? 'cm-theme-' + c : 'cm-theme'
    return b.jsx(
      'div',
      Up({ ref: j, className: '' + V + (t ? ' ' + t : '') }, v),
    )
  })
vp.displayName = 'CodeMirror'
var Zh = {}
class Ds {
  ...
  updateContext(e) {
    if (e != this.curContext.context) {
      let t = new Bh(this.curContext.tracker, e)
...
class vs {
  ...
  static create(e, t = e.bufferBase + e.buffer.length) {
    return new vs(e, t, t - e.bufferBase)
  }
  maybeNext() {
...
class sn {
  ...
  token(e, t) {
    let { parser: i } = t.p
    Qp(this.data, e, t, this.id, i.data, i.tokenPrecTable)
  }
}
...
class Fl {
  constructor(e, t, i) {
    ;(this.precTable = t),
      (this.elseToken = i),
      (this.data = typeof e == 'string' ? En(e) : e)
  }
  token(e, t) {
    let i = e.pos,
      r = 0
    for (;;) {
      ...
      if (
        (Qp(this.data, e, t, 0, this.data, this.precTable), e.token.value > -1)
      )
        break
...
Fl.prototype.contextual = sn.prototype.fallback = sn.prototype.extend = !1
class cr {
  constructor(e, t = {}) {
    ;(this.token = e),
...
const ut = typeof process < 'u' && Zh && /\bparse\b/.test(Zh.LOG)
let Ao = null
function _h(n, e, t) {
  let i = n.cursor(Fe.IncludeAnonymous)
  for (i.moveTo(e); ; )
...
class Yb {
  constructor(e, t) {
    ;(this.stream = t),
      ...
      (this.mainToken = null),
      (this.actions = []),
      (this.tokens = e.tokenizers.map((i) => new Gr()))
  }
  getActions(e) {
    let t = 0,
      i = null,
  ...
  addActions(e, t, i, r) {
    ...
    for (let a = 0; a < 2; a++)
      for (let u = o.stateSlot(s, a ? 2 : 1); ; u += 3) {
        if (l[u] == 65535)
          if (l[u + 1] == 1) u = Jt(l, u + 2)
          else {
            r == 0 &&
              l[u + 1] == 2 &&
              (r = this.putAction(Jt(l, u + 2), t, i, r))
            break
          }
        l[u] == t && (r = this.putAction(Jt(l, u + 1), t, i, r))
      }
    return r
  }
}
class Ib {
  constructor(e, t, i, r) {
    ;(this.parser = e),
      ...
      (this.stream = new qb(t, r)),
      (this.tokens = new Yb(e, this.stream)),
      (this.topTerm = e.top[1])
    let { from: s } = r[0]
    ;(this.stacks = [Ds.start(this, e.top[0], s)]),
      (this.fragments =
  ...
  advanceStack(e, t, i) {
    ...
    if (this.fragments) {
      ...
      for (let c = this.fragments.nodeAt(r); c; ) {
        let f =
          this.parser.nodeSet.types[c.type.id] == c.type
            ? s.getGoto(e.state, c.type.id)
            : -1
        if (f > -1 && c.length && (!u || (c.prop(le.contextHash) || 0) == h))
          return (
            e.useNode(c, f),
            ut &&
              console.log(
                o + this.stackID(e) + ` (via reuse of ${s.getName(c.type.id)})`,
              ),
            !0
          )
        if (!(c instanceof $e) || c.children.length == 0 || c.positions[0] > 0)
          break
        let d = c.children[0]
        if (d instanceof $e && c.positions[0] == 0) c = d
        else break
      }
    }
    ...
    for (let u = 0; u < a.length; ) {
      ...
      if (
        (O.apply(h, c, p ? p.start : O.pos, f),
        ut &&
          console.log(
            o +
              this.stackID(O) +
              ` (via ${(h & 65536) == 0 ? 'shift' : `reduce of ${s.getName(h & 65535)}`} for ${s.getName(c)} @ ${r}${O == e ? '' : ', split'})`,
          ),
        d)
      )
        return !0
    ...
    for (let o = 0; o < e.length; o++) {
      ...
      if (
        ...
        (s ||
          ((s = !0),
          l.restart(),
          ut && console.log(h + this.stackID(l) + ' (restarted)'),
      ...
      for (
        ...
        c.forceReduce() &&
        d < 10 &&
        (ut && console.log(f + this.stackID(c) + ' (via force-reduce)'),
        !this.advanceFully(c, i));
        d++
      )
        ut && (f = this.stackID(c) + ' -> ')
      for (let d of l.recoverByInsert(a))
        ut && console.log(h + this.stackID(d) + ' (via recover-insert)'),
...
class Wb {
  constructor(e) {
    ;(this.start = e.start),
      (this.shift = e.shift || $o),
      (this.reduce = e.reduce || $o),
      (this.reuse = e.reuse || $o),
      (this.hash = e.hash || (() => 0)),
...
class Qs extends Wf {
  constructor(e) {
    ...
    ;(this.specializers = this.specializerSpecs.map(Lh)),
      (this.states = En(e.states, Uint32Array)),
      (this.data = En(e.stateData)),
      (this.goto = En(e.goto)),
      (this.maxTerm = e.maxTerm),
      (this.tokenizers = e.tokenizers.map((l) =>
        typeof l == 'number' ? new sn(o, l) : l,
      )),
  ...
  hasAction(e, t) {
    ...
    for (let r = 0; r < 2; r++)
      for (let s = this.stateSlot(e, r ? 2 : 1), o; ; s += 3) {
        if ((o = i[s]) == 65535)
          if (i[s + 1] == 1) o = i[(s = Jt(i, s + 2))]
          else {
            if (i[s + 1] == 2) return Jt(i, s + 2)
            break
          }
        if (o == t || o == 0) return Jt(i, s + 1)
      }
    return 0
  }
  stateSlot(e, t) {
  ...
  allActions(e, t) {
    ...
    for (let s = this.stateSlot(e, 1); r == null; s += 3) {
      if (this.data[s] == 65535)
        if (this.data[s + 1] == 1) s = Jt(this.data, s + 2)
        else break
      r = t(Jt(this.data, s + 1))
    }
    return r
  }
  nextStates(e) {
    ...
    for (let i = this.stateSlot(e, 1); ; i += 3) {
      if (this.data[i] == 65535)
        if (this.data[i + 1] == 1) i = Jt(this.data, i + 2)
        else break
  ...
  configure(e) {
    let t = Object.assign(Object.create(Qs.prototype), this)
    ...
    return (
      ...
      e.specializers &&
        ...
        (t.specializerSpecs = this.specializerSpecs.map((i, r) => {
          ...
          return (t.specializers[r] = Lh(o)), o
        }))),
...
const Ub = 315,
  ...
  gS = new cr(
    (n, e) => {
      let { next: t } = n
      ;(t == kp || t == -1 || e.context) && n.acceptToken(tS)
    },
  ...
  yS = new cr(
    (n, e) => {
      let { next: t } = n,
        i
      Xl.indexOf(t) > -1 ||
        (t == _l && ((i = n.peek(1)) == _l || i == aS)) ||
        (t != kp && t != lS && t != -1 && !e.context && n.acceptToken(Ub))
    },
    { contextual: !0 },
  ),
  xS = new cr(
    (n, e) => {
      n.next == OS && !e.context && n.acceptToken(Hb)
    },
    { contextual: !0 },
  ),
  bS = new cr(
    (n, e) => {
      ...
      if (t == uS || t == hS) {
        if ((n.advance(), t == n.next)) {
          n.advance()
          let i = !e.context && e.canShift(qh)
          n.acceptToken(i ? qh : Kb)
        }
      } else
        t == dS &&
          n.peek(1) == pS &&
          (n.advance(),
          n.advance(),
          (n.next < 48 || n.next > 57) && n.acceptToken(Jb))
    },
    { contextual: !0 },
  )
function Eo(n, e) {
...
const SS = new cr((n, e) => {
    if (n.next != cS || !e.dialectEnabled(oS) || (n.advance(), n.next == _l))
      return
    let t = 0
    for (; Xl.indexOf(n.next) > -1; ) n.advance(), t++
    if (Eo(n.next, !0)) {
      for (n.advance(), t++; Eo(n.next, !1); ) n.advance(), t++
      for (; Xl.indexOf(n.next) > -1; ) n.advance(), t++
      if (n.next == fS) return
      for (let i = 0; ; i++) {
        if (i == 7) {
  ...
  wS = Qs.deserialize({
    ...
    tokenizers: [
      ...
      new Fl('j~RQYZXz{^~^O(P~~aP!P!Qd~iO(Q~~', 25, 322),
    ],
    topRules: {
      Script: [0, 7],
    ...
    specialized: [
      { term: 326, get: (n) => vS[n] || -1 },
      { term: 342, get: (n) => QS[n] || -1 },
      { term: 95, get: (n) => kS[n] || -1 },
    ],
    tokenPrec: 15124,
  }),
  CS = us.define({
    ...
    parser: wS.configure({
      props: [
        Jf.add({
          IfStatement: xo({ except: /^\s*({|else\b)/ }),
          TryStatement: xo({ except: /^\s*({|catch\b|finally\b)/ }),
          LabeledStatement: d1,
          SwitchBody: (n) => {
            let e = n.textAfter,
              t = /^\s*\}/.test(e),
          ...
          'Statement Property': xo({ except: /^\s*{/ }),
          JSXElement(n) {
...
var PS = /[\u1680\u2000-\u200A\u202F\u205F\u3000]/,
  ...
  To = { Space_Separator: PS, ID_Start: AS, ID_Continue: $S },
  Qe = {
    isSpaceSeparator(n) {
...
var ES = function (e, t) {
  ...
  do (Be = TS()), ZS[Ue]()
  while (Be.type !== 'eof')
  return typeof t == 'function' ? Ll({ '': _n }, '', t) : _n
}
function Ll(n, e, t) {
  const i = n[e]
...
function ri() {
  if (jl[ks]) return String.fromCodePoint(jl.codePointAt(ks))
}
function R() {
  const n = ri()
  return (
...
`:
  ...
  comment() {
    switch (ae) {
      case '*':
        R(), (re = 'multiLineComment')
        return
      case '/':
        R(), (re = 'singleLineComment')
        return
    }
    throw be(R())
  },
...
`:
  ...
  value() {
    switch (ae) {
      case '{':
      case '[':
        return xe('punctuator', R())
      case 'n':
        return R(), Ai('ull'), xe('null', null)
      case 't':
        return R(), Ai('rue'), xe('boolean', !0)
      case 'f':
        return R(), Ai('alse'), xe('boolean', !1)
      case '-':
      case '+':
        R() === '-' && (Kt = -1), (re = 'sign')
        return
      case '.':
        ;(te = R()), (re = 'decimalPointLeading')
        return
      case '0':
        ;(te = R()), (re = 'zero')
        return
      ...
      case '8':
      case '9':
        ;(te = R()), (re = 'decimalInteger')
        return
      case 'I':
        return R(), Ai('nfinity'), xe('numeric', 1 / 0)
      case 'N':
        return R(), Ai('aN'), xe('numeric', NaN)
      case '"':
      case "'":
        ;(Tn = R() === '"'), (te = ''), (re = 'string')
        return
  ...
  identifierNameStartEscape() {
    ...
    switch (n) {
      ...
      case '_':
        break
      default:
        if (!Qe.isIdStartChar(n)) throw Vh()
        break
    }
    ;(te += n), (re = 'identifierName')
  },
  identifierName() {
    switch (ae) {
      case '$':
      ...
      case '‍':
        ...
        return
      case '\\':
        R(), (re = 'identifierNameEscape')
        return
    }
    if (Qe.isIdContinueChar(ae)) {
      te += R()
      return
    }
    return xe('identifier', te)
  },
  identifierNameEscape() {
    ...
    switch (n) {
      ...
      case '‍':
        break
      default:
        if (!Qe.isIdContinueChar(n)) throw Vh()
        break
    }
    ;(te += n), (re = 'identifierName')
  },
  sign() {
    switch (ae) {
      ...
      case '9':
        ...
        return
      case 'I':
        return R(), Ai('nfinity'), xe('numeric', Kt * (1 / 0))
      case 'N':
        return R(), Ai('aN'), xe('numeric', NaN)
    }
    throw be(R())
  ...
  zero() {
    switch (ae) {
      case '.':
        ;(te += R()), (re = 'decimalPoint')
        return
      case 'e':
      case 'E':
        ;(te += R()), (re = 'decimalExponent')
        return
      case 'x':
      case 'X':
        ;(te += R()), (re = 'hexadecimal')
  ...
  decimalInteger() {
    ...
    return xe('numeric', Kt * Number(te))
  },
  decimalPointLeading() {
    if (Qe.isDigit(ae)) {
      ;(te += R()), (re = 'decimalFraction')
      return
    }
    throw be(R())
  },
  ...
  decimalExponent() {
    switch (ae) {
      case '+':
      case '-':
        ;(te += R()), (re = 'decimalExponentSign')
        return
    }
    if (Qe.isDigit(ae)) {
      ;(te += R()), (re = 'decimalExponentInteger')
      return
    }
    throw be(R())
  },
...
`:
  ...
  beforePropertyName() {
    switch (ae) {
      case '$':
      case '_':
        ;(te = R()), (re = 'identifierName')
        return
      case '\\':
        R(), (re = 'identifierNameStartEscape')
        return
      case '}':
        return xe('punctuator', R())
      case '"':
...
function xe(n, e) {
  return { type: n, value: e, line: wi, column: $t }
}
function Ai(n) {
  for (const e of n) {
    if (ri() !== e) throw be(R())
...
function MS() {
  let n = '',
    e = ri()
  if (!Qe.isHexDigit(e) || ((n += R()), (e = ri()), !Qe.isHexDigit(e)))
    throw be(R())
...
const ZS = {
  ...
  beforePropertyName() {
    switch (Be.type) {
      case 'identifier':
      case 'string':
        ;(Qa = Be.value), (Ue = 'afterPropertyName')
        return
      case 'punctuator':
        Zr()
        return
...
function Ro() {
  ...
  if (n !== null && typeof n == 'object')
    ti.push(n),
      Array.isArray(n) ? (Ue = 'beforeArrayValue') : (Ue = 'beforePropertyName')
  else {
    const e = ti[ti.length - 1]
    e == null
      ? (Ue = 'end')
      : Array.isArray(e)
        ? (Ue = 'afterArrayValue')
        : (Ue = 'afterPropertyValue')
  }
}
function Zr() {
  ti.pop()
  const n = ti[ti.length - 1]
  n == null
    ? (Ue = 'end')
    : Array.isArray(n)
      ? (Ue = 'afterArrayValue')
...
function be(n) {
  return ws(
    n === void 0
      ? `JSON5: invalid end of input at ${wi}:${$t}`
      : `JSON5: invalid character '${Cp(n)}' at ${wi}:${$t}`,
  )
}
function $i() {
  return ws(`JSON5: invalid end of input at ${wi}:${$t}`)
}
function Vh() {
  return ($t -= 5), ws(`JSON5: invalid identifier character at ${wi}:${$t}`)
}
function BS(n) {
  console.warn(
    `JSON5: '${Cp(n)}' in strings is not valid ECMAScript; consider escaping`,
  )
}
function Cp(n) {
  const e = {
...
function ws(n) {
  ...
  return (e.lineNumber = wi), (e.columnNumber = $t), e
}
var FS = function (e, t, i) {
  ...
  function h(p, g) {
    ...
    switch (
      (m != null &&
        (typeof m.toJSON5 == 'function'
          ? (m = m.toJSON5(p))
          : typeof m.toJSON == 'function' && (m = m.toJSON(p))),
      l && (m = l.call(g, p, m)),
      m instanceof Number
        ? (m = Number(m))
        : m instanceof String
          ? (m = String(m))
          : m instanceof Boolean && (m = m.valueOf()),
      m)
    ) {
      case null:
        return 'null'
    ...
    if (typeof m == 'string') return c(m)
    if (typeof m == 'number') return String(m)
    if (typeof m == 'object') return Array.isArray(m) ? O(m) : f(m)
  }
  function c(p) {
    const g = { "'": 0.1, '"': 0.2 },
      m = {
    ...
    for (let Q = 0; Q < p.length; Q++) {
      ...
      if (S < ' ') {
        ...
        x += '\\x' + ('00' + C).substring(C.length)
        continue
      }
      x += S
    }
    const k = u || Object.keys(g).reduce((Q, S) => (g[Q] < g[S] ? Q : S))
    return (x = x.replace(new RegExp(k, 'g'), m[k])), k + x + k
  }
  function f(p) {
    if (r.indexOf(p) >= 0)
...
` +
  ...
  function d(p) {
    ...
    if (!Qe.isIdStartChar(g)) return c(p)
    for (let m = g.length; m < p.length; m++)
      if (!Qe.isIdContinueChar(String.fromCodePoint(p.codePointAt(m))))
        return c(p)
    return p
  }
  function O(p) {
    ...
    for (let k = 0; k < p.length; k++) {
      const Q = h(String(k), p)
      m.push(Q !== void 0 ? Q : 'null')
    }
    let x
    if (m.length === 0) x = '[]'
    else if (a === '') x = '[' + m.join(',') + ']'
...
const XS = { parse: ES, stringify: FS }
var _S = XS,
  Ei = {},
  Qt = {},
  zh
...
function ka() {
  ...
  ;(Yh = 1),
    ...
    (Ti.setPath = Ti.evaluatePath = void 0)
  function n(s, o) {
    if (!s) return null
    ...
    if (l >= 0 && typeof s == 'object' && !(o in s)) {
      const { key: f } = i(u),
        d = parseInt(f)
      return Array.isArray(c) && isNaN(d) ? c.map((O) => n(O, u)) : n(c, u)
  ...
  function t(s, o, l) {
    ...
    if (a >= 0) {
      ...
      const c = parseInt(u)
      return o === u && a === -1 && !isNaN(c)
        ? ((s[u] = l), s)
        : (s.forEach((f) => t(f, h, l)), s)
    } else s[u] = l
    return s
  }
  function i(s) {
...
function jS() {
  ...
  ;(Ih = 1),
    ...
    (Ht.isDocumentToRecurOn = Ht.flatten = Ht.unique = void 0)
  function n(i) {
    return [...new Set(i)]
  }
  Ht.unique = n
  ...
  return (Ht.isDocumentToRecurOn = t), Ht
}
var Mo = {},
  Nh
function LS() {
  return (
    Nh || ((Nh = 1), Object.defineProperty(Mo, '__esModule', { value: !0 })), Mo
  )
}
var Wh
function qS() {
  return (
    Wh ||
      ...
      (function (n) {
        ...
        function o(d, O) {
          const p = f(O)
          return typeof d == 'object' && d !== null ? a('', d, p) : []
        }
        n.deepKeys = o
        function l(d, O) {
          const p = f(O)
          return d.map((g) =>
            typeof g == 'object' && g !== null ? o(g, p) : [],
          )
        }
        n.deepKeysFromList = l
        function a(d, O, p) {
          const g = Object.keys(O).map((m) => {
            const x = c(d, h(m, p))
            return (p.expandNestedObjects && s.isDocumentToRecurOn(O[m])) ||
              (p.arrayIndexesAsKeys && Array.isArray(O[m]) && O[m].length)
              ? a(x, O[m], p)
              : p.expandArrayObjects && Array.isArray(O[m])
                ? u(O[m], x, p)
                : p.ignoreEmptyArrays && Array.isArray(O[m]) && !O[m].length
                  ? []
                  : x
          })
          return s.flatten(g)
        ...
        function u(d, O, p) {
          ...
          return d.length
            ...
            : p.ignoreEmptyArraysWhenExpanding
              ? []
              : [O]
        }
        function h(d, O) {
          return O.escapeNestedDots ? d.replace(/\./g, '\\.') : d
        }
        function c(d, O) {
          return d ? d + '.' + O : O
        }
...
function wa() {
  ...
  ;(Gh = 1),
    ...
    (J.isInvalid =
      ...
      J.removeEmptyFields =
      J.isEmptyField =
      J.computeSchemaDifferences =
      J.isDateRepresentation =
      J.isStringRepresentation =
      J.deepCopy =
      J.validate =
      J.buildC2JOptions =
      J.buildJ2COptions =
  ...
  function r(D) {
    ...
    return {
      ...
      delimiter: {
        field:
          (($ = D == null ? void 0 : D.delimiter) == null ? void 0 : $.field) ??
          e.defaultJson2CsvOptions.delimiter.field,
        wrap:
          ((A = D == null ? void 0 : D.delimiter) == null ? void 0 : A.wrap) ||
          e.defaultJson2CsvOptions.delimiter.wrap,
        eol:
          ((w = D == null ? void 0 : D.delimiter) == null ? void 0 : w.eol) ||
  ...
  J.buildC2JOptions = s
  function o(D, $, A) {
    if (!D) throw new Error(`${A.cannotCallOn} ${D}.`)
    if (!$(D)) throw new Error(A.dataCheckFailure)
    return !0
  }
  J.validate = o
  function l(D) {
  ...
  function a(D, $) {
    const A = D[0],
      w = D.length - 1,
      Z = D[w]
    return A === $.delimiter.wrap && Z === $.delimiter.wrap
  }
  J.isStringRepresentation = a
  function u(D) {
    return t.test(D)
  }
  J.isDateRepresentation = u
  function h(D, $) {
    return C(D, $).concat(C($, D))
  }
  J.computeSchemaDifferences = h
  function c(D) {
    return Q(D) || k(D) || D === ''
  }
  J.isEmptyField = c
  ...
  J.removeEmptyFields = f
  function d(D, $, A) {
    return D.substring($, $ + A)
  }
  J.getNCharacters = d
  function O(D, $, A) {
    const w = (0, n.evaluatePath)($, A)
    let Z = l($)
    Array.isArray(w) && w.length
      ? w.forEach((j) => {
          ;(Z = l($)), D.push((0, n.setPath)(Z, A, j))
        })
      : (Array.isArray(w) && w.length === 0 && (0, n.setPath)(Z, A, ''),
        D.push(Z))
  }
  function p(D, $) {
    const A = []
  ...
  function B(D) {
    ...
    if (D.length > i) {
      let $ = []
      for (let A = 0; A < D.length; A += i) $ = $.concat(...D.slice(A, A + i))
      return $
    }
    return D.reduce(($, A) => $.concat(A), [])
  }
  J.flatten = B
  function v(D) {
    return D === 1 / 0 || D === -1 / 0
  }
  return (J.isInvalid = v), J
}
var Uh
function VS() {
  if (Uh) return kt
  ...
  Object.defineProperty(kt, '__esModule', { value: !0 }), (kt.Json2Csv = void 0)
  const i = ka(),
    r = qS(),
    s = qs(),
    o = t(wa()),
    l = function (a) {
      ...
      function O(P) {
        return (0, r.deepKeysFromList)(P, d)
      }
      function p(P) {
        return P.length === 0
          ? []
          : a.checkSchemaDifferences
            ? g(P)
            : o.unique(o.flatten(P))
      }
      function g(P) {
        const q = P[0],
          W = P.slice(1)
        if (m(q, W)) throw new Error(s.errors.json2csv.notSameSchema)
        return q
      }
      function m(P, q) {
        return q.reduce(
          (W, K) => (o.computeSchemaDifferences(P, K).length > 0 ? W + 1 : W),
          0,
        )
      }
      function x(P) {
        return a.excludeKeys
          ? P.filter((q) => {
              for (const W of a.excludeKeys) {
                const K = W instanceof RegExp ? W : new RegExp(`^${W}`)
                if (W === q || q.match(K)) return !1
              }
              return !0
            })
          : P
      ...
      function Q(P) {
        return (
          a.trimHeaderFields &&
            (P.headerFields = P.headerFields.map((q) =>
              q
                .split('.')
                .map((W) => W.trim())
                .join('.'),
      ...
      function S(P) {
        return (
          a.prependHeader &&
            (P.headerFields = P.headerFields.map(function (q) {
              return N(q)
            })),
          P
        )
      ...
      function C(P) {
        const q = Object.keys(a.fieldTitleMap)
        return (
          (P.header = P.headerFields
            .map(function (W) {
              let K = W
              return (
                q.includes(W)
                  ? (K = a.fieldTitleMap[W])
                  : a.escapeHeaderNestedDots || (K = K.replace(/\\\./g, '.')),
                K
              )
            })
      ...
      function E() {
        return a.keys
          ? a.keys.map((P) =>
              typeof P == 'object' && 'field' in P
                ? ((a.fieldTitleMap[P.field] = P.title ?? P.field), P.field)
                : P,
            )
          : []
      }
      ...
      function v(P) {
        ...
        if (a.keys) {
          a.keys = W
          const ee = W.flatMap((ue) => {
            if (!q.includes(ue)) return ue
            const Ce = [],
              _e = new RegExp(`^${ue}`)
            for (const We of H) (ue === We || We.match(_e)) && Ce.push(We)
            return Ce
          })
          if (!a.unwindArrays) {
            const ue = x(ee)
      ...
      function D(P) {
        for (const q of P.records)
          for (const W of P.headerFields) {
            const K = (0, i.evaluatePath)(q, W)
      ...
      function $(P, q = !1) {
        if (a.unwindArrays) {
          if (
            (P.headerFields.forEach((W) => {
              P.records = o.unwind(P.records, W)
            }),
            (P.headerFields = v(P.records)),
            D(P))
          )
            return $(P, q)
          if (!q) return $(P, !0)
      ...
      function A(P) {
        return (
          (P.recordString = P.records
            .map((q) => {
              const W = Z(q, P.headerFields),
                K = W.map((H) => {
                  ;(H = V(H)), (H = I(H))
                  let se = c ? c(H, j) : j(H)
                  return (se = N(se)), se
      ...
      function Z(P, q) {
        ...
        return (
          q.forEach((K) => {
            let H = (0, i.evaluatePath)(P, K)
            !o.isUndefined(a.emptyFieldValue) && o.isEmptyField(H)
              ? (H = a.emptyFieldValue)
              : a.expandArrayObjects && Array.isArray(H) && (H = w(H)),
              W.push(H)
          }),
          W
        )
      ...
      function j(P) {
        const q = P instanceof Date
        return P === null || Array.isArray(P) || (typeof P == 'object' && !q)
          ? JSON.stringify(P)
          : typeof P > 'u'
            ? 'undefined'
            : q && a.useDateIso8601Format
              ? P.toISOString()
              : a.useLocaleFormat
                ? P.toLocaleString()
                : P.toString()
      ...
      function I(P) {
        return a.preventCsvInjection
          ? Array.isArray(P)
            ? P.map(I)
            : typeof P == 'string' && !o.isNumber(P)
              ? P.replace(/^[=+\-@\t\r]+/g, '')
              : P
          : P
      }
      function N(P) {
        const q = a.delimiter.wrap
        return (
          P.includes(a.delimiter.wrap) && (P = P.replace(u, q + q)),
          (P.includes(a.delimiter.field) ||
            P.includes(a.delimiter.wrap) ||
            P.match(h) ||
            (a.wrapBooleans && (P === 'true' || P === 'false'))) &&
            (P = q + P + q),
          P
        )
      }
      function F(P) {
        return P.join(a.delimiter.field)
      }
      function ne(P) {
        const q = P.header,
          W = P.recordString
        return (
          ...
          (a.prependHeader ? q + a.delimiter.eol : '') +
          W
        )
      }
      function ce(P) {
...
function zS() {
  ...
  Object.defineProperty(Ct, '__esModule', { value: !0 }), (Ct.Csv2Json = void 0)
  const i = ka(),
    r = qs(),
    s = t(wa()),
    o = function (l) {
      ...
      function f(v) {
        let D = []
        if (l.headerFields)
          D = l.headerFields.map(($, A) => ({ value: c($), index: A }))
        else if (
          ((D = v[0].map((A, w) => ({ value: c(A), index: w }))), l.keys)
        ) {
          const A = l.keys
          D = D.filter((w) => A.includes(w.value))
        }
      ...
      function O(v) {
        ...
        for (; F < v.length; ) {
          if (
            ...
            (V = F ? v[F - 1] : ''),
            (I = F < $ ? v[F + 1] : ''),
            (N = s.getNCharacters(v, F, A)),
            ((N === l.delimiter.eol && !w.insideWrapDelimiter) || F === $) &&
              V === l.delimiter.field)
          )
            (N === l.delimiter.eol && w.startIndex === F) ||
            j === l.delimiter.field
              ? Z.push('')
              : Z.push(v.substring(w.startIndex)),
              Z.push(''),
              D.push(Z),
              (Z = []),
              (w.startIndex = F + A),
              (w.parsingValue = !0),
              (w.insideWrapDelimiter = I === l.delimiter.wrap)
          else if (F === $ && j === l.delimiter.field) {
            const ne = v.substring(w.startIndex, F)
            Z.push(ne), Z.push(''), D.push(Z)
          } else if (
            F === $ ||
            (N === l.delimiter.eol &&
              (!w.insideWrapDelimiter ||
                (w.insideWrapDelimiter &&
                  V === l.delimiter.wrap &&
                  !w.justParsedDoubleQuote)))
          ) {
            const ne = F !== $ || V === l.delimiter.wrap ? F : void 0
            Z.push(v.substring(w.startIndex, ne)),
              D.push(Z),
              (Z = []),
              (w.startIndex = F + A),
              (w.parsingValue = !0),
            ...
            (w.startIndex = F),
              (w.insideWrapDelimiter = !0),
              (w.parsingValue = !0),
              s.getNCharacters(v, F + 1, A) === l.delimiter.eol &&
                (F += l.delimiter.eol.length + 1)
          else if (
            V === l.delimiter.field &&
            j === l.delimiter.wrap &&
            I === l.delimiter.eol
          )
            Z.push(v.substring(w.startIndex, F - 1)),
              (w.startIndex = F),
              (w.parsingValue = !0),
              (w.insideWrapDelimiter = !0),
              (w.justParsedDoubleQuote = !0),
              (F += 1)
          else if (
            (V !== l.delimiter.wrap ||
              (w.justParsedDoubleQuote && V === l.delimiter.wrap)) &&
            j === l.delimiter.wrap &&
            s.getNCharacters(v, F + 1, A) === l.delimiter.eol
          )
            (w.insideWrapDelimiter = !1), (w.parsingValue = !1)
          else if (
            j === l.delimiter.wrap &&
            (F === 0 ||
              (s.getNCharacters(v, F - A, A) === l.delimiter.eol &&
                !w.insideWrapDelimiter))
          )
            (w.insideWrapDelimiter = !0),
              (w.parsingValue = !0),
            ...
            !w.insideWrapDelimiter &&
            w.parsingValue
              ? (Z.push(v.substring(w.startIndex, F)), (w.startIndex = F + 1))
              : j === l.delimiter.field &&
                V === l.delimiter.wrap &&
                I !== l.delimiter.wrap &&
                !w.parsingValue &&
      ...
      function Q(v) {
        const D = v[0],
          $ = v.length - 1,
          A = v[$]
        return D === l.delimiter.wrap && A === l.delimiter.wrap
          ? v.length <= 2
            ? ''
            : v.substring(1, $)
          : v
      ...
      function C(v) {
        return v.recordLines.reduce((D, $) => {
          $ = $.map((w) => ((w = Q(w)), (w = S(w)), (w = x(w)), w))
          const A = k(v.headerFields, $)
          return D.concat(A)
        }, [])
      }
      function E(v) {
        try {
          if (s.isStringRepresentation(v, l) && !s.isDateRepresentation(v))
            return v
          const D = h(v)
          return Array.isArray(D) ? D.map(x) : D
        } catch (D) {
          return D
        }
      }
...
function YS() {
  ...
  ;(Kh = 1),
    ...
    (Ei.csv2json = Ei.json2csv = void 0)
  const n = qs(),
    e = VS(),
    t = zS(),
    i = wa()
...
function Ap(n) {
  ...
  return (
    e[3] !== t
      ? ((o = t ? b.jsx(Jp, { muted: !0, size: 4 }) : null),
        (e[3] = t),
        (e[4] = o))
      : (o = e[4]),
    o
...
const NS = [
  ...
  Tf(),
  Bs(fd, { fallback: !0 }),
  or.of([{ key: 'Mod-Enter', run: () => !0 }, Hd, Qd].flat().filter(Boolean)),
]
function WS(n) {
  const e = Ee.c(7)
  let t, i
  e[0] !== n ? ((i = GS(n)), (e[0] = n), (e[1] = i)) : (i = e[1]), (t = i)
  const r = t
  let s, o
  e[2] !== n ? ((o = Bs(US(n))), (e[2] = n), (e[3] = o)) : (o = e[3]), (s = o)
  const l = s
  let a
  return (
    e[4] !== l || e[5] !== r
      ? ((a = [r, l]), (e[4] = l), (e[5] = r), (e[6] = a))
      : (a = e[6]),
    a
  )
}
function GS(n) {
  const { color: e, fonts: t } = n.sanity,
    i = e.card.enabled,
    r = Za.blue[e.dark ? 400 : 500].hex,
    s = Za.gray[n.sanity.color.dark ? 900 : 100].hex
  return _.theme(
    {
...
`,
  Ca = M.forwardRef((n, e) => {
    ...
    t[0] === Symbol.for('react.memo_cache_sentinel')
      ? ((l = (f) => {
          var p
          const d = (p = o.current) == null ? void 0 : p.view
          if (!d) return
          const O = d.state.doc.toString()
          f !== O &&
            d.dispatch({
              changes: { from: 0, to: O.length, insert: f },
...
Ca.displayName = 'VisionCodeMirror'
const $p = ['pinnedRelease', 'raw', 'published', 'drafts'],
  KS = ['pinnedRelease']
function Zo(n) {
  return $p.includes(n)
}
function Jh(n) {
  return typeof n == 'string' && KS.includes(n)
}
function ec({ selectedPerspectiveName: n }) {
  return typeof n < 'u'
}
function Bo({ visionPerspective: n, perspectiveStack: e }) {
...
function eD() {
  if (Ep)
    for (let n = 0; n < localStorage.length; n++) {
      ...
      e != null && e.startsWith(Tp) && localStorage.removeItem(e)
    }
}
function tD(n) {
  const e = `${Tp}${n}`
...
function bD(n) {
  ...
  let l
  e[0] !== n.value || e[1] !== o
    ? ((l = Cs(n.value, o)), (e[0] = n.value), (e[1] = o), (e[2] = l))
    : (l = e[2])
  ...
  e[8] !== a
    ? ((g = () => {
        O || (t({ parsed: h, raw: a, valid: f, error: u }), p(!0))
      }),
      (m = [u, O, f, t, h, a]),
      (e[3] = u),
      (e[4] = O),
  ...
  const k = x
  let Q, S
  e[14] !== k ? ((S = oO(k, 333)), (e[14] = k), (e[15] = S)) : (S = e[15]),
    (Q = S)
  const C = Q,
    E = r ? 'default' : 'critical'
  let B
  e[16] !== o
    ? ((B = o('params.label')), (e[16] = o), (e[17] = B))
    : (B = e[17])
  let v
  e[18] !== B
    ? ((v = b.jsx(ii, { muted: !0, children: B })), (e[18] = B), (e[19] = v))
    : (v = e[19])
  let D
  e[20] !== i
    ? ((D =
        ...
        b.jsx(Ln, {
          ...
          children: b.jsx(fe, {
            padding: 1,
            marginX: 2,
            children: b.jsx(dt, { children: b.jsx(SO, {}) }),
          }),
        })),
      (e[20] = i),
      (e[21] = D))
  ...
  let $
  e[22] !== v || e[23] !== D
    ? (($ = b.jsx(Zp, { children: b.jsxs(ft, { children: [v, D] }) })),
      (e[22] = v),
      (e[23] = D),
      (e[24] = $))
    : ($ = e[24])
  const A = n.value || xD
  let w
  e[25] !== s || e[26] !== C || e[27] !== A
    ? ((w = b.jsx(Ca, { ref: s, initialValue: A, onChange: C })),
      (e[25] = s),
      (e[26] = C),
      (e[27] = A),
      (e[28] = w))
...
const SD = 'studio.vision-tool.saved-queries',
  _o = { queries: [] },
  Br = SD
function DD() {
  const n = OO(),
  ...
  const O = M.useCallback(
      (m) => {
        r(!0), a(void 0)
        try {
          const x = [{ ...m, _key: yO() }, ...e.queries]
          t({ queries: x }), n.setKey(Br, { queries: x })
        } catch (x) {
          a(x)
        } finally {
          r(!1)
    ...
    g = M.useCallback(
      (m) => {
        o((x) => [...x, m]), h(void 0)
        try {
          const x = e.queries.filter((k) => k._key !== m)
          t({ queries: x }), n.setKey(Br, { queries: x })
        } catch (x) {
          h(x)
        } finally {
...
function kD(n) {
  ...
  e[11] !== a
    ? ((w = async () => {
        ...
        if (
          ...
          c.some((se) => {
            const ee = i(se.url)
            return ee && ee.query === s && xn(ee.params, o)
          })
        ) {
          const se =
            c == null
              ...
              : c.find((ee) => {
                  const ue = i(ee.url)
                  return ue && ue.query === s && xn(ue.params, o)
                })
          a.push({
            closable: !0,
            status: 'warning',
            title: p('save-query.already-saved'),
            description: `${se == null ? void 0 : se.title} - ${m.format(new Date((se == null ? void 0 : se.savedAt) || ''))}`,
          })
          return
        }
        H &&
          ...
          O
            ? a.push({
                closable: !0,
                status: 'error',
                title: p('save-query.error'),
                description: O.message,
              })
            : a.push({
                closable: !0,
                status: 'success',
                title: p('save-query.success'),
              })
      }),
      (e[2] = o),
      (e[3] = s),
  ...
  const Z = w
  let j
  e[13] !== p || e[14] !== a || e[15] !== h
    ? ((j = async (H, se) => {
        k(null), B((ee) => ({ ...ee, [H._key]: se }))
        try {
          await h({ ...H, title: se }),
            B((ee) => {
              const ue = { ...ee }
              return delete ue[H._key], ue
            })
        } catch (ee) {
          const ue = ee
          B((Ce) => {
            const _e = { ...Ce }
            return delete _e[H._key], _e
          }),
            a.push({
              closable: !0,
              status: 'error',
              title: p('save-query.error'),
              description: ue.message,
            })
        }
      }),
      (e[13] = p),
        ...
        if (
          ...
          const ee =
            c == null
              ? void 0
              : c.find((ue) => {
                  if (ue._key === H._key) return !1
                  const Ce = i(ue.url)
                  return Ce && Ce.query === s && xn(Ce.params, o)
                })
          a.push({
            closable: !0,
            status: 'warning',
            title: p('save-query.already-saved'),
            description: `${ee == null ? void 0 : ee.title} - ${m.format(new Date((ee == null ? void 0 : ee.savedAt) || ''))}`,
          })
          return
        }
        try {
          await h({ ...H, url: se, savedAt: new Date().toISOString() }),
            A(se),
            a.push({
              closable: !0,
              status: 'success',
  ...
  if (
    ...
    const H =
      c == null
        ...
        : c.filter((oe) => {
            var ot
            return (ot = oe == null ? void 0 : oe.title) == null
              ? void 0
              : ot.toLowerCase().includes(v.toLowerCase())
          })
    ne = QD
    let se
    e[49] === Symbol.for('react.memo_cache_sentinel')
      ? ((se = { textTransform: 'capitalize' }), (e[49] = se))
      : (se = e[49])
    let ee
    e[50] !== p
      ? ((ee = p('label.saved-queries')), (e[50] = p), (e[51] = ee))
      : (ee = e[51])
    let ue
    e[52] !== ee
      ? ((ue = b.jsx(dt, {
    ...
    let Ce
    e[54] !== p
      ? ((Ce = p('action.save-query')), (e[54] = p), (e[55] = Ce))
      : (Ce = e[55])
    let _e
    e[56] !== Z || e[57] !== d || e[58] !== Ce
      ? ((_e = b.jsx(Yt, {
          label: Ce,
          icon: DO,
          disabled: d,
    ...
    let vt
    e[63] !== p
      ? ((vt = p('label.search-queries')), (e[63] = p), (e[64] = vt))
      : (vt = e[64])
    let ci
    e[65] === Symbol.for('react.memo_cache_sentinel')
      ? ((ci = (oe) => D(oe.currentTarget.value)), (e[65] = ci))
      : (ci = e[65])
    let fi
    e[66] !== v || e[67] !== vt
      ? ((fi = b.jsx(fe, {
      ...
      : (fi = e[68]),
      e[69] !== We || e[70] !== fi
        ? ((q = b.jsxs(vD, { space: 3, children: [We, fi] })),
          (e[69] = We),
          (e[70] = fi),
          (e[71] = q))
        : (q = e[71]),
      ...
      (P =
        H == null
          ...
          : H.map((oe) => {
              const ot = i(oe.url),
                yn = $ === oe.url,
                Mt = ot && s === ot.query && xn(o, ot.params),
                Ut = yn && !Mt
              return b.jsx(
                Ae,
                {
                  ...
                  children: b.jsxs(ct, {
                    ...
                    children: [
                          ...
                          b.jsxs(ft, {
                            ...
                            children: [
                              x === oe._key
                                ? b.jsx(Ur, {
                                    value: Q,
                                    onChange: (Te) => S(Te.currentTarget.value),
                                    onKeyDown: (Te) => {
                                      Te.key === 'Enter'
                                        ? V(oe, Q)
                                        : Te.key === 'Escape' && k(null)
                                    },
                                    onBlur: () => V(oe, Q),
                                    autoFocus: !0,
                                    style: {
                          ...
                          b.jsx(aO, {
                            ...
                            menu: b.jsx(uO, {
                              children: b.jsx(hO, {
                                ...
                                padding: 3,
                                icon: cO,
                                text: p('action.delete'),
                                onClick: (Te) => {
                                  Te.stopPropagation(), f(oe._key)
                                },
                              }),
                            }),
                            popover: {
                      ...
                      b.jsx(Ps, {
                        muted: !0,
                        children: ot == null ? void 0 : ot.query.split('{')[0],
                      }),
                      b.jsx(ft, {
                        align: 'center',
                        gap: 1,
                        children: b.jsx(dt, {
                          size: 1,
                          muted: !0,
                          children: m.format(new Date(oe.savedAt || '')),
                        }),
                      }),
                      Ut &&
                        b.jsx(Yt, {
                          ...
                          text: p('action.update'),
                          onClick: (Te) => {
                            Te.stopPropagation(), N(oe)
                          },
                        }),
                    ],
                  }),
      ...
      (e[47] = P),
      (e[48] = q)
  } else (F = e[44]), (ne = e[45]), (ce = e[46]), (P = e[47]), (q = e[48])
  let W
  e[72] !== F || e[73] !== ce || e[74] !== P
    ? ((W = b.jsx(F, { paddingY: ce, children: P })),
      (e[72] = F),
      (e[73] = ce),
      (e[74] = P),
      (e[75] = W))
  ...
  let K
  return (
    e[76] !== ne || e[77] !== q || e[78] !== W
      ? ((K = b.jsxs(ne, { children: [q, W] })),
        (e[76] = ne),
        (e[77] = q),
        (e[78] = W),
        (e[79] = K))
...
function AD(n) {
  ...
  e[4] === Symbol.for('react.memo_cache_sentinel')
    ? ((h = b.jsx(Ae, {
        radius: 4,
        children: b.jsx(QO, { keys: ['Ctrl', 'Enter'] }),
      })),
      (e[4] = h))
    : (h = e[4])
  const c = r ? Ra : Ma,
  ...
  let O
  e[5] !== r || e[6] !== l
    ? ((O = l(r ? 'action.query-cancel' : 'action.query-execute')),
      (e[5] = r),
      (e[6] = l),
      (e[7] = O))
    : (O = e[7])
  let p
  e[8] !== s || e[9] !== c || e[10] !== f || e[11] !== d || e[12] !== O
    ? ((p = b.jsx(fe, {
        flex: 1,
        children: b.jsx(Ln, {
          content: h,
  ...
  let m
  e[14] !== i || e[15] !== l
    ? ((m = l(i ? 'action.listen-cancel' : 'action.listen-execute')),
      (e[14] = i),
      (e[15] = l),
      (e[16] = m))
    : (m = e[16])
  const x = !t,
    k = i ? 'positive' : 'default'
  let Q
  e[17] !== o || e[18] !== m || e[19] !== x || e[20] !== k || e[21] !== g
    ? ((Q = b.jsx(fe, {
        flex: 1,
        marginLeft: 3,
        children: b.jsx(Yt, {
  ...
  let S
  e[23] !== Q || e[24] !== p
    ? ((S = b.jsxs(ft, { justify: 'space-evenly', children: [p, Q] })),
      (e[23] = Q),
      (e[24] = p),
      (e[25] = S))
    : (S = e[25])
...
function RD() {
  ...
  let h
  n[3] !== l
    ? ((h = l('settings.perspectives.title')), (n[3] = l), (n[4] = h))
    : (h = n[4])
  let c
  n[5] !== h
    ? ((c = b.jsx(lc, {
        space: 2,
        children: b.jsx(dt, { weight: 'medium', children: h }),
      })),
      (n[5] = h),
      (n[6] = c))
    : (c = n[6])
  ...
  let d
  n[9] !== f
    ? ((d = b.jsx(Ae, { children: b.jsx(dt, { muted: !0, children: f }) })),
      (n[9] = f),
      (n[10] = d))
    : (d = n[10])
  let O
  n[11] !== l ? ((O = l('label.new')), (n[11] = l), (n[12] = O)) : (O = n[12])
  let p
  n[13] !== O
    ? ((p = b.jsx(fe, {
        children: b.jsx(AO, { tone: 'primary', children: O }),
      })),
      (n[13] = O),
      (n[14] = p))
    : (p = n[14])
  ...
  n[17] !== p || n[18] !== g
    ? ((m = b.jsx(Ae, {
        children: b.jsxs(ct, { space: 2, children: [p, g] }),
      })),
      (n[17] = p),
      (n[18] = g),
      (n[19] = m))
    : (m = n[19])
  let x
  n[20] !== l ? ((x = null), (n[20] = l), (n[21] = x)) : (x = n[21])
  let k
  n[22] !== l
    ? ((k = l('settings.perspectives.action.docs-link')),
      (n[22] = l),
      (n[23] = k))
    : (k = n[23])
  let Q
  n[24] !== k
    ...
    : (Q = n[25])
  let S
  n[26] !== m || n[27] !== x || n[28] !== Q || n[29] !== c || n[30] !== d
    ? ((S = b.jsx($D, {
        children: b.jsxs(ct, { space: 4, children: [c, d, m, x, Q] }),
      })),
      (n[26] = m),
      (n[27] = x),
      (n[28] = Q),
  ...
  n[32] === Symbol.for('react.memo_cache_sentinel')
    ? ((C = b.jsx(TD, { $tone: 'primary' })), (n[32] = C))
    : (C = n[32])
  let E
  n[33] !== e
    ? ((E = b.jsx(Yt, {
...
const ZD = (n) => {
  ...
  let l, a
  e[3] !== o || e[4] !== r
    ? ((a = [r, o].filter(_D)), (e[3] = o), (e[4] = r), (e[5] = a))
    : (a = e[5]),
    (l = a.join(' '))
  const u = l,
    h = !ec(t)
...
function BD(n) {
  ...
  let Q
  e[2] !== p
    ? ((Q = p('settings.dataset-label')), (e[2] = p), (e[3] = Q))
    : (Q = e[3])
  let S
  e[4] !== Q
    ? ((S = b.jsx(Ae, {
        paddingTop: 2,
        paddingBottom: 3,
        children: b.jsx(ii, { children: Q }),
      })),
      (e[4] = Q),
      (e[5] = S))
    : (S = e[5])
  let C
  e[6] !== l ? ((C = l.map(XD)), (e[6] = l), (e[7] = C)) : (C = e[7])
  let E
  e[8] !== i || e[9] !== t || e[10] !== C
    ? ((E = b.jsx(Ks, { value: i, onChange: t, children: C })),
      (e[8] = i),
      (e[9] = t),
      (e[10] = C),
      (e[11] = E))
  ...
  e[12] !== S || e[13] !== E
    ? ((B = b.jsx(fe, {
        padding: 1,
        column: 2,
        children: b.jsxs(ct, { children: [S, E] }),
      })),
      (e[12] = S),
      (e[13] = E),
      (e[14] = B))
  ...
  let v
  e[15] !== p
    ? ((v = p('settings.api-version-label')), (e[15] = p), (e[16] = v))
    : (v = e[16])
  let D
  e[17] !== v
    ? ((D = b.jsx(Ae, {
  ...
  let w
  e[20] !== p
    ? ((w = p('settings.other-api-version-label')), (e[20] = p), (e[21] = w))
    : (w = e[21])
  let Z
  e[22] !== w
    ? ((Z = b.jsx('option', { value: 'other', children: w }, 'other')),
      (e[22] = w),
      (e[23] = Z))
    : (Z = e[23])
  let j
  ...
  e[28] !== j || e[29] !== D
    ? ((V = b.jsx(fe, {
        padding: 1,
        column: 2,
        children: b.jsxs(ct, { children: [D, j] }),
      })),
      (e[28] = j),
      (e[29] = D),
      (e[30] = V))
    : (V = e[30])
  let I
  e[31] !== r || e[32] !== a || e[33] !== h || e[34] !== u || e[35] !== p
    ? ((I =
        r !== !1 &&
        b.jsx(fe, {
          padding: 1,
          ...
          children: b.jsxs(ct, {
            children: [
              b.jsx(Ae, {
                ...
                children: b.jsx(ii, {
                  textOverflow: 'ellipsis',
                  children: p('settings.custom-api-version-label'),
                }),
              }),
              b.jsx(Ur, {
                ref: a,
                ...
                customValidity: h
                  ? void 0
                  : p('settings.error.invalid-api-version'),
                maxLength: 11,
              }),
            ],
          }),
  ...
  let N
  e[37] !== p
    ? ((N = p('settings.perspective-label')), (e[37] = p), (e[38] = N))
    : (N = e[38])
  let F
  e[39] !== N
    ? ((F = b.jsx(fe, { children: b.jsx(ii, { children: N }) })),
      (e[39] = N),
      (e[40] = F))
    : (F = e[40])
  let ne
  e[41] === Symbol.for('react.memo_cache_sentinel')
    ? ((ne = b.jsx(fe, { children: b.jsx(RD, {}) })), (e[41] = ne))
    : (ne = e[41])
  let ce
  e[42] !== F
    ? ((ce = b.jsx(Ae, {
        paddingBottom: 1,
        children: b.jsxs(lc, { space: 1, children: [F, ne] }),
      })),
      (e[42] = F),
      (e[43] = ce))
    : (ce = e[43])
  ...
  e[44] !== O || e[45] !== p
    ? ((q = $p.map((ee) =>
        ee === 'pinnedRelease'
          ? b.jsxs(
              ...
              {
                children: [
                  b.jsx(ZD, { pinnedPerspective: O, t: p }),
                  b.jsx(
                    'option',
                    {
                      value: 'default',
                      children: p('settings.perspectives.default'),
                    },
                    'default',
                  ),
                  b.jsx('hr', {}),
    ...
    : (q = e[46])
  let W
  e[47] !== c || e[48] !== P || e[49] !== q
    ? ((W = b.jsx(Ks, { value: P, onChange: c, children: q })),
      (e[47] = c),
      (e[48] = P),
      (e[49] = q),
      (e[50] = W))
  ...
  e[51] !== ce || e[52] !== W
    ? ((K = b.jsx(fe, {
        padding: 1,
        column: 2,
        children: b.jsxs(ct, { children: [ce, W] }),
      })),
      (e[51] = ce),
      (e[52] = W),
      (e[53] = K))
                ...
                children: [
                    ...
                    children: b.jsxs(ii, {
                      children: [
                        ...
                        b.jsxs(aD, {
                          ...
                          children: [
                            '[',
                            p('action.copy-url-to-clipboard'),
                            ']',
                          ],
                        }),
                      ],
                  ...
                  b.jsxs(ft, {
                    ...
                    children: [
                      ...
                      b.jsx(Ln, {
                        content: p('action.copy-url-to-clipboard'),
                        children: b.jsx(Yt, {
                          'aria-label': p('action.copy-url-to-clipboard'),
                          type: 'button',
                          mode: 'ghost',
                          icon: nO,
                          onClick: x,
  ...
  let se
  return (
    e[58] !== V || e[59] !== I || e[60] !== K || e[61] !== H || e[62] !== B
      ? ((se = b.jsx(oD, {
          paddingX: 3,
          paddingY: 2,
          children: b.jsxs(rO, { columns: k, children: [B, V, I, K, H] }),
        })),
        (e[58] = V),
        (e[59] = I),
        (e[60] = K),
  ...
  return (() => {
    ...
    return (r) => {
      ...
      if (!(typeof s != 'string' || s === ''))
        return (
          s === i || ((i = s), t && URL.revokeObjectURL(t), (t = jD(s, n))), t
        )
    }
  })()
}
const LD = Fp('application/json', (n) => JSON.stringify(n, null, 2)),
  qD = Fp('text/csv', (n) => IS.json2csv(Array.isArray(n) ? n : [n]).trim()),
  Vl = ye(Ps)`
...
function VD(n) {
  ...
  const r = { ...t.details, ...zD(t.details) }
  if (!r.line) return null
  const s = `${r.line}
${YD(r.column, r.columnEnd)}`
  let o
  e[0] !== s
    ? ((o = b.jsx(Vl, { size: 1, children: s })), (e[0] = s), (e[1] = o))
    : (o = e[1])
...
${i('query.error.column')}: ${r.column}`
  ...
  e[2] !== l
    ? ((a = b.jsx(fe, {
        marginTop: 4,
        children: b.jsx(Vl, { size: 1, children: l }),
      })),
      (e[2] = l),
      (e[3] = a))
    : (a = e[3])
...
function ID(n) {
  ...
  let t
  e[0] !== n.error.message
    ? ((t = b.jsx(Vl, { size: 1, children: n.error.message })),
      (e[0] = n.error.message),
      (e[1] = t))
    : (t = e[1])
  let i
  e[2] !== n.error
    ? ((i = b.jsx(VD, { error: n.error })), (e[2] = n.error), (e[3] = i))
    : (i = e[3])
  let r
  return (
    e[4] !== t || e[5] !== i
      ? ((r = b.jsxs(ct, { space: 5, marginTop: 2, children: [t, i] })),
        (e[4] = t),
        (e[5] = i),
        (e[6] = r))
      : (r = e[6]),
...
const ND = ye.div(({ theme: n }) => {
  ...
  zl = new bO({ maxSize: 5e4 })
function ic(n) {
  const e = Ee.c(7),
    { data: t, datasetName: i } = n,
    r = dO()
  if (Xp(t) || Array.isArray(t)) {
    const l = r === i ? WD : void 0
    let a
    return (
      e[0] !== t || e[1] !== l
        ? ((a = b.jsx(ND, {
  ...
  return (
    e[5] !== s
      ? ((o = b.jsx(Ps, { language: 'json', children: s })),
        (e[5] = s),
        (e[6] = o))
      : (o = e[6]),
    o
...
function WD(n) {
  ...
  return (
    e[3] !== t
      ? ((r = b.jsx(xO, { intent: 'edit', params: t, children: i })),
        (e[3] = t),
        (e[4] = r))
      : (r = e[4]),
    r
...
const HD = /^\d+$/
function KD(n, e = 10) {
  return HD.test(n) && parseInt(n, 10) > e
}
function JD(n) {
...
function iv(n) {
  ...
  let f
  e[0] !== c || e[1] !== r
    ? ((f = c ? LD(r) : ''), (e[0] = c), (e[1] = r), (e[2] = f))
    : (f = e[2])
  const d = f
  let O
  e[3] !== c || e[4] !== r
    ? ((O = c ? qD(r) : ''), (e[3] = c), (e[4] = r), (e[5] = O))
    : (O = e[5])
  const p = O,
    g = t ? 'critical' : 'default',
    m = !!t
  let x
  e[6] !== h ? ((x = h('result.label')), (e[6] = h), (e[7] = x)) : (x = e[7])
  let k
  e[8] !== x
    ? ((k = b.jsx(Mp, {
        children: b.jsx(fe, {
          marginLeft: 3,
          children: b.jsx(ii, { muted: !0, children: x }),
        }),
      })),
      (e[8] = x),
      (e[9] = k))
  ...
  e[10] !== s || e[11] !== o || e[12] !== i
    ? ((Q =
        (i || (s && o.length === 0)) &&
        b.jsx(fe, { marginTop: 3, children: b.jsx(Ap, {}) })),
      (e[10] = s),
      (e[11] = o),
      (e[12] = i),
      (e[13] = Q))
  ...
  let S
  e[14] !== t
    ? ((S = t && b.jsx(ID, { error: t })), (e[14] = t), (e[15] = S))
    : (S = e[15])
  let C
  e[16] !== l || e[17] !== c || e[18] !== r
    ? ((C = c && b.jsx(ic, { data: r, datasetName: l })),
      (e[16] = l),
      (e[17] = c),
      (e[18] = r),
      (e[19] = C))
  ...
  e[20] !== l || e[21] !== s || e[22] !== o
    ? ((E = s && o.length > 0 && b.jsx(ic, { data: o, datasetName: l })),
      (e[20] = l),
      (e[21] = s),
      (e[22] = o),
      (e[23] = E))
    : (E = e[23])
  let B
  e[24] !== E || e[25] !== Q || e[26] !== S || e[27] !== C
    ? ((B = b.jsxs(fe, { padding: 3, paddingTop: 5, children: [Q, S, C, E] })),
      (e[24] = E),
      (e[25] = Q),
      (e[26] = S),
      (e[27] = C),
  ...
  let v
  e[29] !== B || e[30] !== k
    ? ((v = b.jsxs(fD, { overflow: 'auto', children: [k, B] })),
      (e[29] = B),
      (e[30] = k),
      (e[31] = v))
    : (v = e[31])
  let D
  e[32] !== v || e[33] !== g || e[34] !== m
    ? ((D = b.jsx(hD, {
        flex: 1,
        children: b.jsx(cD, {
          flex: 1,
  ...
  e[36] === Symbol.for('react.memo_cache_sentinel')
    ? (($ = ['column', 'column', 'row']), (e[36] = $))
    : ($ = e[36])
  let A
  e[37] !== h
    ? ((A = h('result.execution-time-label')), (e[37] = h), (e[38] = A))
    : (A = e[38])
  let w
  e[39] !== a || e[40] !== h
    ? ((w =
        typeof a == 'number' ? `${a}ms` : h('result.timing-not-applicable')),
      (e[39] = a),
      (e[40] = h),
      (e[41] = w))
    : (w = e[41])
  ...
  e[42] !== A || e[43] !== w
    ? ((Z = b.jsx(fe, {
        children: b.jsxs(dt, { muted: !0, children: [A, ':', ' ', w] }),
      })),
      (e[42] = A),
      (e[43] = w),
      (e[44] = Z))
  ...
  let j
  e[45] !== h
    ? ((j = h('result.end-to-end-time-label')), (e[45] = h), (e[46] = j))
    : (j = e[46])
  let V
  e[47] !== u || e[48] !== h
    ? ((V =
        typeof u == 'number' ? `${u}ms` : h('result.timing-not-applicable')),
      (e[47] = u),
      (e[48] = h),
      (e[49] = V))
    : (V = e[49])
  ...
  e[50] !== j || e[51] !== V
    ? ((I = b.jsx(fe, {
        marginLeft: 4,
        children: b.jsxs(dt, { muted: !0, children: [j, ':', ' ', V] }),
      })),
      (e[50] = j),
      (e[51] = V),
      (e[52] = I))
  ...
  e[53] !== Z || e[54] !== I
    ? ((N = b.jsx(pD, {
        ...
        paddingY: 3,
        sizing: 'border',
        children: b.jsxs(OD, { align: 'center', children: [Z, I] }),
      })),
      (e[53] = Z),
      (e[54] = I),
      (e[55] = N))
...
const rv =
  ...
  sv = (n) => Ta('ctrl+enter', n) || Ta('mod+enter', n)
function ov(n) {
  const { datasets: e, config: t, projectId: i, defaultDataset: r } = n,
    s = rc(),
    { t: o } = ai(ui),
    { perspectiveStack: l } = sc(),
    a = rD(`${t.defaultApiVersion}`),
    u = M.useRef(null),
    h = M.useRef(null),
    c = M.useRef(null),
    f = M.useRef(null),
    ...
    [p] = M.useState(() => tD(i || 'default')),
    {
      ...
      () => ({
        storedDataset: p.get('dataset', r),
        storedApiVersion: p.get('apiVersion', a),
        storedQuery: p.get('query', ''),
        storedParams: p.get(
          'params',
          `{
        ...
        storedPerspective: p.get('perspective', void 0),
      }),
      [r, a, p],
    ),
    [S, C] = M.useState(() => (e.includes(g) ? g : e.includes(r) ? r : e[0])),
    [E, B] = M.useState(() => (jn.includes(m) ? m : Pp)),
    [v, D] = M.useState(() => (jn.includes(m) ? !1 : m)),
    [$, A] = M.useState(Q || 'raw'),
    w = v ? Xo(v) : !0,
    [Z, j] = M.useState(void 0),
    [V, I] = M.useState(() => (typeof x == 'string' ? x : '')),
    [N, F] = M.useState(() => Cs(k, o)),
    [ne, ce] = M.useState(void 0),
    [P, q] = M.useState([]),
    [W, K] = M.useState(void 0),
    [H, se] = M.useState(void 0),
    [ee, ue] = M.useState(void 0),
    [Ce, _e] = M.useState(!1),
    [We, vt] = M.useState(!1),
    [ci, fi] = M.useState(!1),
    { paneSizeOptions: oe, isNarrowBreakpoint: ot } = wD({ visionRootRef: c }),
    yn = nc({ apiVersion: w && v ? v : E }),
    Mt = M.useMemo(
      () =>
        yn.withConfig({
          apiVersion: w && v ? v : E,
          perspective: Bo({ visionPerspective: $, perspectiveStack: l }),
          dataset: S,
          allowReconfigure: !0,
        }),
      [l, $, v, E, S, yn, w],
    ...
    Te = M.useCallback(() => {
      O.current && (O.current.unsubscribe(), (O.current = void 0))
    }, []),
    lt = M.useCallback(
      (L) => {
        if (Ce) {
        ...
        const G = {
          query: (L == null ? void 0 : L.query) || V,
          dataset: (L == null ? void 0 : L.dataset) || S,
          params: Cs(
            JSON.stringify(
              (L == null ? void 0 : L.params) || N.parsed,
              null,
              2,
            ),
            o,
          ...
          perspective: Bo({
            visionPerspective: (L == null ? void 0 : L.perspective) || $,
            perspectiveStack: l,
          }),
          apiVersion: (L == null ? void 0 : L.apiVersion) || (v && w ? v : E),
        }
        if (
          (p.set('query', G.query),
          p.set('params', G.params.raw),
          Te(),
          _e(!G.params.error && !!G.query),
          vt(!1),
          q([]),
          K(G.params.error ? new Error(G.params.error) : void 0),
          ce(void 0),
          se(void 0),
          ue(void 0),
          G.params.error)
          ...
          return
        const Re = { perspective: G.perspective ?? [] },
          Yi = Mt.withConfig({
          ...
          Ws = Yi.getUrl(
            Yi.getDataUrl('query', Fo(G.query, G.params.parsed, Re)),
          )
        j(Ws)
        const Gs = Date.now()
        d.current = Yi.observable
          ...
          .subscribe({
            next: (Je) => {
              se(Je.ms), ue(Date.now() - Gs), ce(Je.result), _e(!1), K(void 0)
            },
            error: (Je) => {
              K(Je), _e(!1)
            },
      ...
      [Ce, V, S, N.parsed, o, $, l, v, w, E, p, Te, Mt, Ut],
    ),
    Vs = M.useCallback(
      (L) => {
        ;(L !== void 0 && !Zo(L)) ||
          (A(L), p.set('perspective', L), lt({ perspective: L }))
      },
      [p, lt],
    ),
    _p = M.useCallback(
      (L) => {
        ...
        p.set('dataset', G), C(G), lt({ dataset: G })
      },
      [p, lt],
    ),
    jp = M.useCallback(
      (L) => {
        ...
        if ((G == null ? void 0 : G.toLowerCase()) === 'other') {
          D('v'), (Re = f.current) == null || Re.focus()
          return
        }
        B(G), D(!1), p.set('apiVersion', G), lt({ apiVersion: G })
      },
      [p, lt],
    ),
    Lp = M.useCallback(
      (L) => {
        const G = L.target.value || ''
        D(G || 'v'),
          Xo(G) && (B(G), p.set('apiVersion', G), lt({ apiVersion: G }))
      },
      [p, lt],
    ),
    qp = M.useCallback(
      (L) => {
        const G = L.target.value
        Vs(G === 'default' ? void 0 : G)
      },
      [Vs],
    ),
    Aa = M.useCallback((L) => {
      L.type === 'mutation' &&
        q((G) => (G.length === 50 ? [L, ...G.slice(0, 49)] : [L, ...G]))
    }, []),
    Vp = M.useCallback(() => {
      if (We) {
        Te(), vt(!1)
      ...
      const L = Mt.getDataUrl('listen', Fo(V, N.parsed, {})),
        G = !N.error && V.trim().length > 0
      p.set('query', V),
        p.set('params', N.raw),
        Ut(),
        j(L),
        ...
        ce(void 0),
        vt(G),
        K(N.error ? new Error(N.error) : void 0),
        se(void 0),
        ue(void 0),
        G &&
          (O.current = Mt.listen(V, N.parsed, {
    ...
    }, [We, N, V, p, Ut, Aa, Te, Mt]),
    zp = M.useCallback(
      (L) => {
        F(L), p.set('params', L.raw)
      },
      [p],
    ),
    zs = M.useCallback(
      (L) => {
        ...
        if (!G) return null
        const [, Re, Yi, Ws] = G,
          Gs = new URLSearchParams(Ws),
          Je = nD(Gs)
        if (!Je) return null
        let $a, Us
        Xo(Re) && (jn.includes(Re) ? (($a = Re), (Us = !1)) : (Us = Re))
        const Ea =
          Zo(Je.options.perspective) && !Jh(Je.options.perspective)
            ? Je.options.perspective
            : void 0
        return (
          Ea &&
            (!Zo(Je.options.perspective) || Jh(Je.options.perspective)) &&
            ...
            }),
          {
            query: Je.query,
            params: Je.params,
            rawParams: JSON.stringify(Je.params, null, 2),
            dataset: e.includes(Yi) ? Yi : S,
            apiVersion: $a || E,
            customApiVersion: Us,
            perspective: Ea || $,
            url: L,
    ...
    Ys = M.useCallback(
      (L) => {
        ...
        C(L.dataset),
          I(L.query),
          F({ parsed: L.params, raw: L.rawParams, valid: !0, error: void 0 }),
          B(L.apiVersion),
          L.customApiVersion && D(L.customApiVersion),
          A(L.perspective),
          j(L.url),
          (G = u.current) == null || G.resetEditorContent(L.query),
          (Re = h.current) == null || Re.resetEditorContent(L.rawParams),
          p.merge({
            query: L.query,
            params: L.rawParams,
            dataset: L.dataset,
            apiVersion: L.customApiVersion || L.apiVersion,
    ...
    Is = M.useCallback(
      (L) => {
        ...
        const G = L.clipboardData.getData('text/plain')
        L.preventDefault()
        const Re = zs(G)
        Re &&
          (Ys(Re),
    ...
    Ns = M.useCallback(
      (L) => {
        const G = c.current && nv(c.current, L.target)
        sv(L) && G && N.valid && (lt(), L.preventDefault(), L.stopPropagation())
      },
      [N.valid, lt],
    )
  M.useEffect(
    () => (
      window.document.addEventListener('paste', Is),
      window.document.addEventListener('keydown', Ns),
      () => {
        window.document.removeEventListener('paste', Is),
          window.document.removeEventListener('keydown', Ns)
      }
    ),
    [Ns, Is],
  ),
  ...
  const Yp = eO((L) => {
    L.length > 0 && Vs('pinnedRelease')
  })
  M.useEffect(() => {
    Yp(l)
  }, [l])
  const Ip = M.useCallback(
    (L, G) => {
      const Re = {
        perspective: Bo({ visionPerspective: $, perspectiveStack: l }) ?? [],
      }
      return Mt.getUrl(Mt.getDataUrl('query', Fo(L, G, Re)))
    },
    [Mt, $, l],
  )
  return b.jsxs(Rp, {
    ...
    children: [
      b.jsx(BD, {
        ...
        datasets: e,
        onChangeDataset: _p,
        onChangeApiVersion: jp,
        customApiVersionElementRef: f,
        onCustomApiVersionChange: Lp,
        isValidApiVersion: w,
      ...
      b.jsx(lD, {
        ...
        children: b.jsxs(eo, {
          ...
          size: ci ? window.innerWidth : window.innerWidth - 275,
          maxSize: -225,
          primary: 'first',
          children: [
            b.jsx(fe, {
                ...
                children: [
                  b.jsx(fe, {
                    ...
                    children: b.jsxs(eo, {
                      className: 'sidebarPanes',
                      split: 'horizontal',
                      defaultSize: ot ? oe.defaultSize : oe.minSize,
                      size: oe.size,
                      allowResize: oe.allowResize,
                      minSize: ot ? oe.minSize : 100,
                      maxSize: oe.maxSize,
                      primary: 'first',
                      children: [
                        b.jsx(tc, {
              ...
              children: [
                b.jsx(Yt, {
                  ...
                  children: b.jsx('div', {
                    ...
                    children: ci ? b.jsx(tO, {}) : b.jsx(iO, {}),
                  }),
                }),
                b.jsx(kD, {
                  url: Z,
                  getStateFromUrl: zs,
                  setStateFromParsedUrl: Ys,
                  currentQuery: V,
                  currentParams: N.parsed || {},
                  generateUrl: Ip,
                }),
              ],
            }),
  ...
  e[2] !== n.observable.datasets
    ? ((o = () => {
        const a = n.observable.datasets
          .list()
          .subscribe({ next: (u) => s(u.map(av)), error: (u) => s(u) })
...
function uv(n) {
  ...
  e[1] !== t || e[2] !== n.client
    ? ((i =
        t instanceof Error ? [n.client.config().dataset || 'production'] : t),
      (e[1] = t),
      (e[2] = n.client),
      (e[3] = i))
    : (i = e[3])
  ...
  let s
  e[4] !== n.client
    ? ((s = n.client.config()), (e[4] = n.client), (e[5] = s))
    : (s = e[5])
  const o = s.projectId
  let l
...
class hv extends M.Component {
  constructor(t) {
    super(t)
    Hs(this, 'handleRetryRender', () =>
      this.setState((t) => ({ error: null, numRetries: t.numRetries + 1 })),
    )
    Hs(this, 'handleRetryWithCacheClear', () => {
      eD(), this.handleRetryRender()
    })
      ...
      children: b.jsx(Hp, {
        ...
        children: b.jsxs(ct, {
          ...
          children: [
            ...
            b.jsx(Kp, { children: 'An error occurred' }),
            b.jsx(Ae, {
              border: !0,
              radius: 2,
              overflow: 'auto',
              ...
              children: b.jsx(ct, {
                ...
                children:
                  ...
                  b.jsx(Ps, {
                    size: 1,
                    children: b.jsxs('strong', { children: ['Error: ', t] }),
                  }),
              }),
            }),
          ],
...
function Ov(n) {
  ...
  let r
  e[1] !== n.tool.options
    ? ((r = { defaultApiVersion: Pp, ...n.tool.options }),
      (e[1] = n.tool.options),
      (e[2] = r))
    : (r = e[2])
  const s = r
  ...
  return (
    e[3] !== i || e[4] !== s
      ? ((o = b.jsx(hv, { children: b.jsx(uv, { client: i, config: s }) })),
        (e[3] = i),
        (e[4] = s),
        (e[5] = o))
      : (o = e[5]),
